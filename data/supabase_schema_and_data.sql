...
INSERT INTO galleries (id, judul, kategori, image, caption, alt, sumber, status, created_at) VALUES ('gal-3', 'Aktivitas Kebun Masyarakat', 'Perkebunan', '/assets/ekang-agrowisata.jpg', 'Masyarakat desa mengolah lahan perkebunan ubi dan pisang secara berkelanjutan.', 'Aktivitas Perkebunan Masyarakat Desa Ekang Anculai', '', 'published', '2026-08-22 17:03:46') ON CONFLICT DO NOTHING;
...
INSERT INTO galleries (id, judul, kategori, image, caption, alt, sumber, status, created_at) VALUES ('gal-5', 'Kuliner Tradisional & Masakan Khas Desa', 'Gastronomi', '/assets/ekang-kuliner.png', 'Sajian kuliner rumahan masyarakat khas desa dan hidangan tradisional autentik Ekang Anculai.', 'Kuliner Gastronomi Masyarakat Ekang Anculai', '', 'published', '2026-08-22 17:04:00') ON CONFLICT DO NOTHING;
...
INSERT INTO cbt_experiences (id, step, title, "desc", image, status, created_at) VALUES ('cbt-1', 1, 'CREATIVE EXPERIENCE', 'Belajar membatik bersama pengrajin lokal.', '/assets/ekang-batik.png', 'published', '2026-08-21 17:26:19') ON CONFLICT DO NOTHING;
INSERT INTO cbt_experiences (id, step, title, "desc", image, status, created_at) VALUES ('cbt-2', 2, 'VILLAGE FARMING', 'Beraktivitas di kebun bersama masyarakat.', '/assets/ekang-agrowisata.jpg', 'published', '2026-08-21 17:26:19') ON CONFLICT DO NOTHING;
INSERT INTO cbt_experiences (id, step, title, "desc", image, status, created_at) VALUES ('cbt-3', 3, 'LOCAL GASTRONOMY', 'Mengenal pangan dan kuliner lokal.', '/assets/ekang-kuliner.png', 'published', '2026-08-21 17:26:19') ON CONFLICT DO NOTHING;
INSERT INTO cbt_experiences (id, step, title, "desc", image, status, created_at) VALUES ('cbt-4', 4, 'LOCAL CRAFT', 'Mengenal kreativitas & produk kerajinan desa.', '/assets/village-ekang-anculai.jpg', 'published', '2026-08-21 17:26:19') ON CONFLICT DO NOTHING;
INSERT INTO cbt_experiences (id, step, title, "desc", image, status, created_at) VALUES ('cbt-5', 5, 'NATURE EXPERIENCE', 'Mengenal ekosistem mangrove dan lingkungan pesisir.', '/assets/ekang-mangrove.png', 'published', '2026-08-21 17:26:19') ON CONFLICT DO NOTHING;
INSERT INTO cbt_experiences (id, step, title, "desc", image, status, created_at) VALUES ('cbt-6', 6, 'CULTURAL EXPERIENCE', 'Mengenal seni, tradisi, cerita rakyat, dan budaya Melayu.', '/assets/ekang-reog.png', 'published', '2026-08-21 17:26:19') ON CONFLICT DO NOTHING;
INSERT INTO cbt_experiences (id, step, title, "desc", image, status, created_at) VALUES ('cbt-7', 7, 'VILLAGE HOMESTAY', 'Merasakan pengalaman tinggal dan berinteraksi dengan keluarga masyarakat.', '/assets/village-ekang-anculai.jpg', 'published', '2026-08-21 17:26:19') ON CONFLICT DO NOTHING;
INSERT INTO cbt_experiences (id, step, title, "desc", image, status, created_at) VALUES ('cbt-8', 8, 'LOCAL PRODUCT', 'Mengenal dan membeli produk masyarakat.', '/assets/village-ekang-anculai.jpg', 'published', '2026-08-21 17:26:19') ON CONFLICT DO NOTHING;
