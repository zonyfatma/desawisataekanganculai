  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "absolute top-3 left-3 right-3 z-[1000] max-w-2xl mx-auto flex flex-col gap-2 pointer-events-none",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "relative pointer-events-auto w-full shadow-lg rounded-2xl bg-white/95 backdrop-blur-md border border-neutral-200",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                    ...
                    className:
                      "w-full bg-transparent text-xs font-semibold text-neutral-900 placeholder:text-neutral-500 outline-none",
                  }),
                  searchQuery &&
              ...
              isSearchOpen &&
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "border-t border-neutral-100 bg-white/95 backdrop-blur-md rounded-b-2xl overflow-hidden shadow-xl max-h-60 overflow-y-auto",
                  children: searchSuggestions.map((lm) =>
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "button",
                      {
                        ...
                        className:
                          "w-full px-4 py-2.5 text-left text-xs hover:bg-emerald-50 transition-colors flex items-center justify-between gap-2 border-b border-neutral-100 last:border-0",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className: "min-w-0",
                            children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            className:
                              "shrink-0 text-[10px] font-bold text-emerald-700 bg-emerald-100/70 px-2 py-0.5 rounded-full",
                            children: "Lihat",
                          }),
                        ],
                      },
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className:
              "pointer-events-auto flex items-center gap-1.5 overflow-x-auto pb-1 no-scrollbar",
            children: ["Semua", "Wisata", "Budaya", "UMKM", "Kuliner", "Fasilitas"].map((cat) => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "rounded-2xl bg-white/95 backdrop-blur-md p-2.5 shadow-lg border border-neutral-200 text-xs",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
              type: "button",
              onClick: () => setIsLegendOpen(!isLegendOpen),
              className:
                "flex items-center justify-between gap-2 font-bold text-neutral-800 text-[11px] w-full text-left",
              children: [
            ...
            isLegendOpen &&
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "mt-2 pt-2 border-t border-neutral-100 grid grid-cols-2 gap-x-3 gap-y-1.5 text-[10px] font-medium text-neutral-700",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                    className: "flex items-center gap-1.5",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className: "size-2.5 rounded-full bg-[#064E3B]",
                      }),
                      " Pusat Desa",
                    ],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className: "size-2.5 rounded-full bg-[#16A34A]",
                      }),
                      " Wisata Alam",
                    ],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className: "size-2.5 rounded-full bg-[#C2410C]",
                      }),
                      " Budaya",
                    ],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className: "size-2.5 rounded-full bg-[#D97706]",
                      }),
                      " Kuliner",
                    ],
                  }),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className: "size-2.5 rounded-full bg-[#2563EB]",
                      }),
                      " Fasilitas",
                    ],
                  }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "absolute bottom-4 right-3 z-[1000] flex flex-col items-end gap-2 pointer-events-none",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "pointer-events-auto flex items-center gap-1 rounded-xl bg-white/95 backdrop-blur-md p-1 shadow-lg border border-neutral-200",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                type: "button",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Satelit" }),
                ],
              }),
            ],
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                ...
                disabled: geoLoading,
                className:
                  "grid size-10 place-items-center rounded-xl bg-white text-neutral-800 shadow-lg border border-neutral-200 hover:bg-neutral-50 active:scale-95 transition-all disabled:opacity-50",
                title: "◎ Lokasi Saya",
                "aria-label": "Lokasi Saya",
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LocateFixed, {
                  className: `size-5 text-blue-600 ${geoLoading ? "animate-spin" : ""}`,
                }),
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                type: "button",
                ...
                className:
                  "grid size-10 place-items-center rounded-xl bg-white text-neutral-800 shadow-lg border border-neutral-200 hover:bg-neutral-50 active:scale-95 transition-all",
                title: "🎯 Pusatkan ke Desa Wisata Ekang Anculai",
                "aria-label": "Pusatkan Peta",
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigation, {
                  className: "size-4 text-[#064E3B]",
                }),
              }),
            ],
          }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(MapContainer, {
        ...
        children: [
          activeLayer === "standard"
            ...
            : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TileLayer, {
                attribution:
                  '© <a href="https://www.esri.com/" target="_blank" rel="noopener noreferrer">Esri World Imagery</a>',
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              Marker,
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Popup, {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "overflow-hidden rounded-2xl bg-white shadow-xl max-w-[270px] font-sans text-neutral-800 border border-neutral-100",
                    children: [
                      village.image &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                              className:
                                "absolute bottom-2 left-2 inline-flex items-center rounded-md bg-emerald-950/90 backdrop-blur-sm px-2 py-0.5 text-[10px] font-bold text-white",
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                            className:
                              "mt-1 text-[11px] text-neutral-600 line-clamp-2 leading-relaxed",
                            children: villageAddress,
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className:
                              "mt-3 pt-2.5 border-t border-neutral-100 flex items-center justify-between gap-1.5",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                                ...
                                className:
                                  "flex-1 inline-flex items-center justify-center gap-1 rounded-full bg-[#064E3B] hover:bg-emerald-900 py-1.5 px-3 text-[11px] font-extrabold text-white shadow-sm transition-colors",
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigation, {
                                    className: "size-3",
                                  }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                    children: "Mulai Navigasi",
                                  }),
                                ],
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                                ...
                                className:
                                  "inline-flex items-center justify-center rounded-full border border-neutral-300 bg-white hover:bg-neutral-50 px-3 py-1.5 text-[11px] font-bold text-neutral-700 transition-colors",
                                children: "Detail",
                              }),
                            ],
                          }),
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              Marker,
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Popup, {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "overflow-hidden rounded-2xl bg-white shadow-xl max-w-[260px] font-sans text-neutral-800 border border-neutral-100",
                    children: [
                      lm.image &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          className: "relative h-28 w-full overflow-hidden bg-neutral-100",
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                              className:
                                "absolute bottom-2 left-2 inline-flex items-center rounded-md bg-emerald-950/80 backdrop-blur-sm px-2 py-0.5 text-[10px] font-bold text-white",
                              children: lm.kategori,
                            }),
                          ],
                        }),
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                                ...
                                rel: "noopener noreferrer",
                                className:
                                  "flex-1 inline-flex items-center justify-center gap-1 rounded-full bg-[#064E3B] hover:bg-emerald-900 py-1.5 px-2.5 text-[11px] font-extrabold text-white shadow-sm transition-colors",
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigation, {
                                    className: "size-3",
                                  }),
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                                ...
                                className:
                                  "grid size-7 place-items-center rounded-full border border-neutral-200 hover:bg-neutral-100 text-neutral-600 transition-colors",
