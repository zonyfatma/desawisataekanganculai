...
import { At as Building2, Dt as Camera, Et as Car, Nt as ArrowRight, Pt as ArrowLeft, Q as Heart, St as ChevronLeft, U as MapPin, V as Maximize2, Y as Instagram, Z as House, _ as Sparkles, _t as Clock, et as Handshake, f as Toilet, gt as Coffee, ht as Compass, j as Phone, jt as Bookmark, kt as Building, n as Wifi, o as Users, p as Sun, tt as Globe, u as Trees, v as ShoppingBag, x as Share2, xt as ChevronRight } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { G as cn, W as useSiteData, a as getBreadcrumbJsonLd, i as JsonLdScript, l as SourceLink, m as DialogContent, n as Route, o as getDestinationJsonLd, p as Dialog } from "./router-HcJQJ-TI.mjs";
...
function DesaDetail() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(JsonLdScript, { data: [destinationSchema, breadcrumbSchema] }),
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { className: "size-4" }), "Kembali ke Beranda"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								"aria-pressed": saved,
								className: "inline-flex items-center gap-2 rounded-full bg-background/20 px-4 py-2 text-xs font-bold text-background backdrop-blur transition-colors hover:bg-background/35",
								children: [saved ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: "size-4 fill-gold text-gold" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bookmark, { className: "size-4" }), "Simpan"]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								onClick: () => void share(),
								className: "inline-flex items-center gap-2 rounded-full bg-background/20 px-4 py-2 text-xs font-bold text-background backdrop-blur transition-colors hover:bg-background/35",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Share2, { className: "size-4" }), "Bagikan"]
							})]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Compass, { className: "size-4 text-gold shrink-0" }), village.adwi]
						})] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Phone, { className: "size-4" }), "Hubungi Pengelola via WA"]
						})
					]
				})
			}),
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsList, {
							...
							].map(([v, label]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsTrigger, {
								value: v,
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "mt-2",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceLink, { source: {
												name: "Website Resmi Desa Ekang Anculai",
												url: "https://desaekanganculai.bintankab.go.id/profil/sejarah"
											} })
										}),
										village.perbatasan ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
												className: "mt-7 text-lg font-extrabold text-foreground",
										...
										village.kesenian?.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "mt-8 text-lg font-extrabold text-foreground",
											children: "Sanggar & Kesenian Budaya"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "mt-3.5 space-y-3",
											children: village.kesenian.map((k) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										village.panduanKunjungan?.etikaKunjungan?.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "mt-8 text-lg font-extrabold text-foreground",
											children: "Etika & Panduan Kunjungan Wisatawan"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
											className: "mt-3.5 space-y-2.5",
											children: village.panduanKunjungan.etikaKunjungan.map((etika) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceLink, { source: village.source })
										})
									]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
									className: "space-y-6",
									children: [village.kelembagaan ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "grid size-9 shrink-0 place-items-center rounded-xl bg-primary/10 text-primary",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Handshake, { className: "size-4.5" })
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "text-xs",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "block font-extrabold text-foreground",
									...
									}) : null, village.alamat ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "rounded-3xl border border-border bg-card p-6 shadow-card",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "text-xs font-extrabold tracking-wider text-muted-foreground uppercase",
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														...
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "size-4.5" })
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												village.luasDesa ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex items-center gap-3 rounded-2xl border border-border/70 bg-surface p-3.5",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "grid size-9 shrink-0 place-items-center rounded-xl bg-primary/10 text-primary",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Maximize2, { className: "size-4.5" })
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "text-xs",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "block font-extrabold text-foreground",
												...
												village.luasKawasanWisata ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex items-center gap-3 rounded-2xl border border-border/70 bg-surface p-3.5",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "grid size-9 shrink-0 place-items-center rounded-xl bg-primary/10 text-primary",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trees, { className: "size-4.5" })
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "text-xs",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "block font-extrabold text-foreground",
												...
												village.jamOperasional ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex items-center gap-3 rounded-2xl border border-border/70 bg-surface p-3.5",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "grid size-9 shrink-0 place-items-center rounded-xl bg-primary/10 text-primary",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "size-4.5" })
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "text-xs",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "block font-extrabold text-foreground",
												...
												village.waktuTerbaik ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex items-center gap-3 rounded-2xl border border-border/70 bg-surface p-3.5",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "grid size-9 shrink-0 place-items-center rounded-xl bg-amber-500/10 text-amber-600",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sun, { className: "size-4.5" })
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "text-xs",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "block font-extrabold text-foreground",
												...
												village.instagram ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex items-center gap-3 rounded-2xl border border-border/70 bg-surface p-3.5",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "grid size-9 shrink-0 place-items-center rounded-xl bg-primary/10 text-primary",
												...
												village.website ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex items-center gap-3 rounded-2xl border border-border/70 bg-surface p-3.5",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "grid size-9 shrink-0 place-items-center rounded-xl bg-primary/10 text-primary",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Globe, { className: "size-4.5" })
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "text-xs truncate",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "block font-extrabold text-foreground",
												...
												village.pemdesWebsite ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex items-center gap-3 rounded-2xl border border-border/70 bg-surface p-3.5",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "grid size-9 shrink-0 place-items-center rounded-xl bg-primary/10 text-primary",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Building, { className: "size-4.5" })
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "text-xs truncate",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "block font-extrabold text-foreground",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: (siteData?.umkmList && siteData.umkmList.length > 0 ? siteData.umkmList : village.umkmList ?? []).filter((u) => selectedUmkmCat === "Semua" || u.kategori === selectedUmkmCat).map((u) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
										u.image && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
											src: u.image,
											alt: u.nama,
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												children: u.kategori
											}), u.hargaInfo && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceLink, { source: u.source })
									})]
								}, u.id))
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: (siteData?.kegiatanList !== void 0 ? siteData.kegiatanList : village.kegiatanList ?? []).map((kg) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceLink, { source: kg.source })]
								}, kg.id))
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-3",
								children: village.paket.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Lihat Rute" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-3" })]
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "mt-2",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: village.galeri.map((img, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			lightbox && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
				open: !!lightbox,
