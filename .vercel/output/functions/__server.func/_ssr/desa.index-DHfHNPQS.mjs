...
import {
  T as klasifikasiInfo,
  W as villages,
  h as fasilitasMaster,
  j as provinsiList,
...
function VillageCard({ village, priority = false }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
    className:
      "card-lift group flex h-full flex-col justify-between overflow-hidden rounded-3xl border border-border bg-card shadow-card transition-all duration-300 hover:shadow-lift",
    children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                className:
                  "absolute bottom-3 left-3 inline-flex items-center gap-1.5 rounded-full bg-background/90 px-3 py-1.5 text-[11px] font-bold text-foreground backdrop-blur",
                children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                className:
                  "mt-1.5 flex items-center gap-1.5 text-xs font-semibold text-muted-foreground",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                    className: "truncate",
                    children: [village.kabupaten, ", ", village.provinsi],
                  }),
                ],
              }),
                ...
                children: [
                  village.fasilitas.slice(0, 3).map((f) =>
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      ...
                      {
                        className:
                          "rounded-full bg-surface px-2.5 py-1 text-[11px] font-semibold text-muted-foreground border border-border/60",
                        children: f,
                      },
                      f,
                    ),
                  ...
                  village.fasilitas.length > 3
                    ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                        ...
                        children: ["+", village.fasilitas.length - 3, " fasilitas"],
                      })
                    : null,
                ],
              }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "mt-4 flex items-center justify-between gap-3 border-t border-border p-6 pt-4 bg-surface/50",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className: "min-w-0",
            children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
            ...
            className:
              "inline-flex shrink-0 items-center gap-1.5 rounded-full bg-primary px-4 py-2 text-xs font-bold text-primary-foreground shadow-card transition-all duration-300 hover:bg-emerald-deep hover:shadow-lift",
            children: [
...
function DesaIndex() {
  ...
  const results = (0, import_react.useMemo)(
    () =>
      villages.filter((v) => {
        return (
          `${v.nama} ${v.kabupaten} ${v.provinsi}`.toLowerCase().includes(q.toLowerCase()) &&
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
              className:
                "inline-flex rounded-full bg-accent px-4 py-1.5 text-xs font-bold tracking-widest text-primary uppercase",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
              ...
              children:
                "Jelajahi potensi ekowisata mangrove, Rumah Batik Bintan, perkebunan warga, homestay rumah warga, dan kegiatan masyarakat Desa Ekang Anculai, Teluk Sebong, Bintan.",
            }),
          ],
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "mt-8 grid gap-3 rounded-2xl border border-border bg-card p-5 shadow-card lg:grid-cols-[1.4fr_1fr_1fr_auto]",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                  ...
                  className:
                    "w-full bg-transparent py-3.5 text-sm font-medium outline-none placeholder:text-muted-foreground",
                }),
              ],
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
                  ...
                  className:
                    "h-auto rounded-2xl border-0 bg-surface px-4 py-3.5 text-sm font-medium",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
              onClick: reset,
              className:
                "inline-flex items-center justify-center gap-2 rounded-full bg-muted px-6 py-3.5 text-sm font-bold text-foreground transition-colors hover:bg-accent hover:text-primary",
              children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          children: loading
            ? Array.from({ length: 3 }).map((_, i) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VillageCardSkeleton, {}, i),
              )
            : results.map((v) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VillageCard, { village: v }, v.slug),
              ),
        }),
        !loading && !results.length
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "mt-6 grid place-items-center rounded-2xl border border-dashed border-border bg-card p-16 text-center",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                  ...
                  children:
                    'Coba gunakan kata kunci lain seperti "mangrove", "batik", "perkebunan", atau "gastronomi".',
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                  onClick: reset,
                  className:
                    "mt-5 rounded-full bg-primary px-6 py-3 text-sm font-bold text-primary-foreground",
