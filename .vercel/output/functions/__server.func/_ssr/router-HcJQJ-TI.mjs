...
import { A as paketWisataSchema, D as officialFullDayPackage, E as loginInputSchema, H as umkmSchema, I as reservationPublicSchema, L as reservationStatusSchema, M as publicReviewSchema, N as recordPageViewSchema, O as officialTwoDayPackage, R as reviewStatusSchema, S as kegiatanSchema, U as villageInfoSchema, V as tokenOnlySchema, W as villages, _ as galeriDataset, b as homestaySchema, c as cbtExperiences8, d as destinasiSchema, g as galeri8Categories, l as changePasswordInputSchema, m as faqSchema, o as adminReviewSchema, p as extractOgImageSchema, r as WHATSAPP_NUMBER, u as deleteItemSchema, v as galeriSchema, x as imageUploadSchema, y as getVillage } from "./schemas-DIbXu2MH.mjs";
...
import { $ as HeartHandshake, B as Menu, C as Send, Dt as Camera, I as Music2, J as Layers, L as Moon, M as PhoneCall, Mt as Award, N as Palette, Nt as ArrowRight, Ot as Calendar, St as ChevronLeft, U as MapPin, W as Mail, Y as Instagram, Z as House, _ as Sparkles, _t as Clock, a as UtensilsCrossed, b as ShieldCheck, dt as Drama, g as Sprout, gt as Coffee, ht as Compass, it as Footprints, j as Phone, mt as CookingPot, nt as Gift, o as Users, p as Sun, r as WandSparkles, st as Facebook, t as X, u as Trees, ut as ExternalLink, v as ShoppingBag, vt as CircleCheck, wt as Check, xt as ChevronRight, yt as CircleAlert, z as MessageCircle } from "../_libs/lucide-react.mjs";
import { n as toast, t as Toaster } from "../_libs/sonner.mjs";
import { n as __exportAll, r as createServerFn, s as getServerFnById, t as TSS_SERVER_FUNCTION } from "./server-o1JyFher.mjs";
...
var DialogContent = import_react.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogPortal, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlay, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent$1, {
	...
	children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogClose, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "size-6 stroke-[2.5]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "sr-only",
			children: "Close"
		})]
	})]
...
function extractPayload(input) {
	const raw = input || {};
	if (raw && typeof raw === "object" && "data" in raw && raw["data"] !== void 0 && raw["data"] !== null && typeof raw["data"] === "object") return raw["data"];
	return raw;
}
var checkAdminAuthServerFn = createServerFn({ method: "POST" }).validator((data) => tokenOnlySchema.parse(extractPayload(data))).handler(createSsrRpc("25cd601fdb16e7781722c13c9a52f3f399a5ee982977e49bd7f9c03be1380bc2"));
var adminLoginServerFn = createServerFn({ method: "POST" }).validator((data) => loginInputSchema.parse(extractPayload(data))).handler(createSsrRpc("9d359cea8999f5f1547a80d5811a74164cf232ac0befc4e9ac2dda353fdb4d17"));
var changePasswordServerFn = createServerFn({ method: "POST" }).validator((data) => changePasswordInputSchema.parse(extractPayload(data))).handler(createSsrRpc("e63307d11e39b31d5e923c3dff123e83b7c8a41d5d5578acf73d2e5660812399"));
var checkDefaultPasswordServerFn = createServerFn({ method: "POST" }).validator((data) => tokenOnlySchema.parse(extractPayload(data))).handler(createSsrRpc("1c8571d11ef815895fcc86fd357d12c0c28f2831540b627db4f701e0f8ed033e"));
var adminLogoutServerFn = createServerFn({ method: "POST" }).validator((data) => tokenOnlySchema.parse(extractPayload(data))).handler(createSsrRpc("29c1517d9458b0123dac993772de06bbe266e58194c5237700be2a8e7709a28d"));
var uploadImageServerFn = createServerFn({ method: "POST" }).validator((data) => imageUploadSchema.parse(extractPayload(data))).handler(createSsrRpc("a9f0fb56447d1fff8822013e974f946d82605c26b8409287d440e51c74da37ea"));
var migrateBase64ServerFn = createServerFn({ method: "POST" }).validator((data) => tokenOnlySchema.parse(extractPayload(data))).handler(createSsrRpc("f3304e289a018751170c3241b905634a8200163297c8d80d5aecbf8fb0c34f80"));
var getSiteDataServerFn = createServerFn({ method: "GET" }).handler(createSsrRpc("066ff2d20809eace1a7df5454e466475299769619bb4c50e122c7b4795c17549"));
var recordPageViewServerFn = createServerFn({ method: "POST" }).validator((data) => recordPageViewSchema.parse(extractPayload(data))).handler(createSsrRpc("f736c0a0cc906d0ab6c97941d2459e54c6c95bea803d3c645dbaef68e817b38f"));
var getAdminDashboardDataServerFn = createServerFn({ method: "POST" }).validator((data) => tokenOnlySchema.parse(extractPayload(data))).handler(createSsrRpc("483e53b28e55f0d2a198f29fa2afdd46eebd419cffbf5245bf35f15acb5de881"));
var submitPublicReviewServerFn = createServerFn({ method: "POST" }).validator((data) => publicReviewSchema.parse(extractPayload(data))).handler(createSsrRpc("e23d26f7912843cc3803f048cd4e5edbd520779d405437c265d6828917717fa2"));
var submitReservationServerFn = createServerFn({ method: "POST" }).validator((data) => reservationPublicSchema.parse(extractPayload(data))).handler(createSsrRpc("daf5adaff011fc8d310fa55f8257f8df96e5447e2255f827f045683ac0e279d7"));
var saveVillageInfoServerFn = createServerFn({ method: "POST" }).validator((data) => villageInfoSchema.parse(extractPayload(data))).handler(createSsrRpc("2d7172bc24f5eb36e24c17a144e53327e20e2072e491b3f66434b5be8176a300"));
var saveDestinasiServerFn = createServerFn({ method: "POST" }).validator((data) => destinasiSchema.parse(extractPayload(data))).handler(createSsrRpc("c51de335367ac26553e5b9101a0b3ba95b47b7aa9a9ee985e448f0828e4c4176"));
var deleteDestinasiServerFn = createServerFn({ method: "POST" }).validator((data) => deleteItemSchema.parse(extractPayload(data))).handler(createSsrRpc("dc1cc92c7665ad45fc84d3b1bf4bc2124e946d89e1fd66febc83dbaf98356ca3"));
var extractOgImageServerFn = createServerFn({ method: "POST" }).validator((data) => extractOgImageSchema.parse(extractPayload(data))).handler(createSsrRpc("8a7022dbe1e34a63b1ef0b1db72a0054b4d0e8680744775253d3cab22d2876b1"));
var saveKegiatanServerFn = createServerFn({ method: "POST" }).validator((data) => kegiatanSchema.parse(extractPayload(data))).handler(createSsrRpc("70c47140bbdb8e4e3225c6c19ea1f83c9ba8e571c1a8912a940fc651f77a2e88"));
var deleteKegiatanServerFn = createServerFn({ method: "POST" }).validator((data) => deleteItemSchema.parse(extractPayload(data))).handler(createSsrRpc("0f2a7074a88cbedea55ca409de9764e7e85d5ced2760c7bb2f76d192a8d53ffd"));
var saveUmkmServerFn = createServerFn({ method: "POST" }).validator((data) => umkmSchema.parse(extractPayload(data))).handler(createSsrRpc("e9274f2bf7eeec05351ab696d62e9071cad1c3c828cf4709bccfd1116f2a2149"));
var deleteUmkmServerFn = createServerFn({ method: "POST" }).validator((data) => deleteItemSchema.parse(extractPayload(data))).handler(createSsrRpc("9bafb474685506142ab6a68e5347486912e3e41911c45e1eb425dcf5c2650c2d"));
var saveGaleriServerFn = createServerFn({ method: "POST" }).validator((data) => galeriSchema.parse(extractPayload(data))).handler(createSsrRpc("13845e65ebac5b8709ea3f6abba067859f3534df5a15741e30c808575e1d3ff4"));
var deleteGaleriServerFn = createServerFn({ method: "POST" }).validator((data) => deleteItemSchema.parse(extractPayload(data))).handler(createSsrRpc("1ac8aa0dd46d83da103fa86acea43e27ac7074b4f9ce08eec6ee6ee88611719b"));
var saveReviewServerFn = createServerFn({ method: "POST" }).validator((data) => adminReviewSchema.parse(extractPayload(data))).handler(createSsrRpc("b00d1bbbd203a7e21aea7dd8988b261cbdf0dbc02176742027b38610d3c94fae"));
createServerFn({ method: "POST" }).validator((data) => reviewStatusSchema.parse(extractPayload(data))).handler(createSsrRpc("622151c6d7078b8fa025c877bdbcbd03c0b6ebc88b31b33b742ea03373b39343"));
var deleteReviewServerFn = createServerFn({ method: "POST" }).validator((data) => deleteItemSchema.parse(extractPayload(data))).handler(createSsrRpc("e760faafa665349c13470887b5e37cbb7004d8fdd6d68c79ac98b9ece3f3d9d3"));
createServerFn({ method: "POST" }).validator((data) => homestaySchema.parse(extractPayload(data))).handler(createSsrRpc("395ba6a1fdd8bba1f1659621df557076fae2365f78529ba51141c973831e6449"));
createServerFn({ method: "POST" }).validator((data) => deleteItemSchema.parse(extractPayload(data))).handler(createSsrRpc("8d944807815d91a456482cb8f56496758d829a718d870a86635c5b7db8fdc97c"));
createServerFn({ method: "POST" }).validator((data) => paketWisataSchema.parse(extractPayload(data))).handler(createSsrRpc("1e1bc6970b0abe13a4807eb80a553f597e24de42ae4ae517ddea5ca426ccd075"));
createServerFn({ method: "POST" }).validator((data) => deleteItemSchema.parse(extractPayload(data))).handler(createSsrRpc("750562c31640665a2c5941c01ce34b22e4d693b016dc30ced3ebce1a1a63be7d"));
createServerFn({ method: "POST" }).validator((data) => faqSchema.parse(extractPayload(data))).handler(createSsrRpc("360eb360e69eed3a2c9bbb5859829cc757d9ff9741a43bd6482a5d4dd44ba14c"));
createServerFn({ method: "POST" }).validator((data) => deleteItemSchema.parse(extractPayload(data))).handler(createSsrRpc("1fa08bdfb5e76bcc2fb118273da19fb84fb50375ccf82f708b1f6566e3467156"));
var updateReservationStatusServerFn = createServerFn({ method: "POST" }).validator((data) => reservationStatusSchema.parse(extractPayload(data))).handler(createSsrRpc("92d386995ce1354db653f6f793f4aa1b053bc0f67ce0c5830c2b378492ce7a42"));
var deleteReservationServerFn = createServerFn({ method: "POST" }).validator((data) => deleteItemSchema.parse(extractPayload(data))).handler(createSsrRpc("b70e8fc52b84ba27a79456c03d5c7b1958a63ea4d777d89a1ea97e2ef645b2d5"));
var v0 = villages[0];
...
var cmsStore = {
	...
	recordVisit(path) {
		...
		recordPageViewServerFn({ data: { path: path || window.location.pathname || "/" } }).then((res) => {
...
function useSiteData() {
	...
	(0, import_react.useEffect)(() => {
		...
		getSiteDataServerFn().then((serverData) => {
			if (serverData) {
...
function TripPlannerModal({ open, onOpenChange }) {
	...
	(0, import_react.useEffect)(() => {
		...
		if (now > "17:00" && visitDate <= today) {
			...
			setVisitTime("08:00");
			toast.info("Jam operasional hari ini (17.00 WIB) telah selesai. Tanggal otomatis disesuaikan ke besok.");
	...
	const handleDateChange = (val) => {
		...
		if (val === today) {
			if (now > "17:00") {
				toast.info("Jam operasional hari ini telah berakhir (17.00 WIB). Tanggal otomatis dialihkan ke besok.");
				setVisitDate(getTomorrowDateString());
				setVisitTime("08:00");
	...
	const handleTimeChange = (val) => {
		...
		const today = getTodayDateString();
		const now = getCurrentTimeString();
		if (val < "08:00") toast.error("Jam operasional desa dimulai pukul 08.00 WIB. Silakan ganti jam.");
		else if (val > "17:00") toast.error("Jam operasional desa berakhir pukul 17.00 WIB. Silakan ganti jam.");
		else if (visitDate === today && val < now) toast.error(`Jam ${val} WIB sudah lewat dari jam saat ini (${now} WIB). Silakan ganti jam kedatangan.`);
	};
	const handleNextStep = () => {
		if (step === 1) {
			...
			if (visitDate < today) {
				toast.error("Tanggal kunjungan berada di masa lalu. Mohon pilih tanggal hari ini atau esok hari.");
				return;
			}
			if (visitDate === today && now > "17:00") {
				toast.error("Jam operasional desa hari ini telah berakhir (17.00 WIB). Mohon ubah tanggal kunjungan ke esok hari.");
				return;
			}
			if (!visitTime) {
			...
			if (visitTime < "08:00" || visitTime > "17:00") {
				toast.error("Jam kedatangan harus berada di dalam jam operasional desa (08.00–17.00 WIB). Silakan ganti jam yang sesuai.");
				return;
			}
			if (visitDate === today && visitTime < now) {
				toast.error(`Jam kedatangan (${visitTime} WIB) sudah lewat dari waktu saat ini (${now} WIB). Mohon ganti dengan jam kedatangan yang sesuai.`);
				return;
			}
		}
	...
	const handleWhatsAppBooking = async () => {
		...
		try {
			const kodeReservasi = (await submitReservationServerFn({ data: {
				namaPemesan,
			...
			const addonsListText = selectedAddons.map((id) => addonExperiences.find((a) => a.id === id)?.nama).filter(Boolean).join("\n - ");
...
Mohon konfirmasi ketersediaan jadwal dan rincian biaya kunjungannya. Terima kasih!`;
			...
			const message = err instanceof Error ? err.message : "Gagal menyimpan reservasi. Coba beberapa saat lagi.";
			toast.error(message);
		} finally {
			...
			children: [
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "size-3.5 text-gold" }), "Perencana Kunjungan Interaktif"]
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: () => setStep(1),
									className: cn("flex items-center gap-1.5 rounded-full px-3 py-1.5 transition-all cursor-pointer min-h-[36px]", step === 1 ? "bg-[#C58A32] text-white shadow-md font-black ring-2 ring-[#DCA348]" : step > 1 ? "bg-[#14532D] text-white" : "bg-white/10 text-white/60 hover:bg-white/20"),
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "01 Rencana" })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: cn("h-0.5 flex-1 mx-1.5 transition-all", step >= 2 ? "bg-[#C58A32]" : "bg-white/20") }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: () => setStep(2),
									className: cn("flex items-center gap-1.5 rounded-full px-3 py-1.5 transition-all cursor-pointer min-h-[36px]", step === 2 ? "bg-[#C58A32] text-white shadow-md font-black ring-2 ring-[#DCA348]" : step > 2 ? "bg-[#14532D] text-white" : "bg-white/10 text-white/60 hover:bg-white/20"),
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "02 Aktivitas" })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: cn("h-0.5 flex-1 mx-1.5 transition-all", step >= 3 ? "bg-[#C58A32]" : "bg-white/20") }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: () => setStep(3),
									className: cn("flex items-center gap-1.5 rounded-full px-3 py-1.5 transition-all cursor-pointer min-h-[36px]", step === 3 ? "bg-[#C58A32] text-white shadow-md font-black ring-2 ring-[#DCA348]" : step > 3 ? "bg-[#14532D] text-white" : "bg-white/10 text-white/60 hover:bg-white/20"),
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "03 Data Diri" })
								})
							]
						})
					]
						...
						step === 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									...
									children: durationOptions.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										type: "button",
										onClick: () => setSelectedDuration(opt.id),
										className: cn("flex items-start justify-between rounded-2xl border p-4 text-left transition-all", selectedDuration === opt.id ? "border-primary bg-primary/5 ring-2 ring-primary/20" : "border-border hover:bg-accent/50"),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, { className: "size-3.5 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Perkiraan Tanggal Kunjungan" })]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: cn("mt-2 flex items-center gap-2 rounded-2xl border bg-surface px-4 py-3 shadow-sm transition-all focus-within:ring-2", visitDate && visitDate < todayStr ? "border-destructive ring-2 ring-destructive/20" : "border-border focus-within:ring-primary/20"),
										...
										visitDate && visitDate < todayStr ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "mt-1.5 text-[11px] font-extrabold text-destructive flex items-center gap-1",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "size-3 shrink-0" }), "Tanggal di masa lalu. Mohon ganti tanggal."]
										}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "mt-1.5 text-[11px] text-muted-foreground font-medium",
											children: currentTimeStr > "17:00" ? "Hari ini sudah tutup (otomatis dialihkan ke besok)" : `Minimal hari ini (${todayStr.split("-").reverse().join("/")})`
										})
									] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
											className: "text-xs font-bold text-muted-foreground flex items-center gap-1.5",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "size-3.5 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Jam Kedatangan (08.00–17.00 WIB)" })]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: cn("mt-2 flex items-center gap-2 rounded-2xl border bg-surface px-4 py-3 shadow-sm transition-all focus-within:ring-2", visitDate === todayStr && visitTime && visitTime < currentTimeStr || visitTime && (visitTime < "08:00" || visitTime > "17:00") ? "border-destructive ring-2 ring-destructive/20" : "border-border focus-within:ring-primary/20"),
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												type: "time",
												min: visitDate === todayStr ? currentTimeStr < "08:00" ? "08:00" : currentTimeStr : "08:00",
												max: "17:00",
												value: visitTime,
										...
										visitDate === todayStr && visitTime && visitTime < currentTimeStr ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "mt-1.5 text-[11px] font-extrabold text-destructive flex items-center gap-1",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "size-3 shrink-0" }),
												"Jam ",
												visitTime,
										...
										}) : visitTime && (visitTime < "08:00" || visitTime > "17:00") ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "mt-1.5 text-[11px] font-extrabold text-destructive flex items-center gap-1",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "size-3 shrink-0" }), "Jam di luar operasional. Jam buka 08.00 – 17.00 WIB."]
										}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "mt-1.5 text-[11px] text-muted-foreground font-medium",
											children: visitDate === todayStr ? `Hari ini: Jam minimal ${currentTimeStr < "08:00" ? "08.00" : currentTimeStr} WIB` : "Jam operasional 08.00 - 17.00 WIB"
										})
									] })]
								})
							]
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: addonExperiences.map((addon) => {
										...
										return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											...
											className: cn("flex items-center justify-between rounded-2xl border p-4 text-left transition-all", isSelected ? "border-primary bg-primary/5 ring-2 ring-primary/20" : "border-border hover:bg-accent/50"),
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "flex items-center gap-3",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													className: cn("grid size-6 place-items-center rounded-full transition-colors", isSelected ? "bg-primary text-primary-foreground" : "border border-border bg-card"),
													children: isSelected && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "size-4" })
						...
						step === 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
												className: "text-xs font-bold text-muted-foreground",
												children: ["Nama Lengkap Anda ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												className: "text-xs font-bold text-muted-foreground",
												children: ["Nomor WhatsApp Aktif ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-destructive",
													children: "*"
												})]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "size-4 shrink-0 text-amber-600" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Tanpa biaya pembayaran di muka. Kode reservasi unik tersimpan otomatis di database pengelola." })]
								})
							]
						}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: visitDate.split("-").reverse().join("/") })]
										})
									]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "size-4" }), "Buka Chat WhatsApp Pengelola Lagi"]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										onClick: () => {
											onOpenChange(false);
				...
				step <= 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [step > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, { className: "size-4" }), "Kembali"]
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {}), step < 3 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						...
						children: ["Lanjutkan", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "size-4" })]
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "size-4" }), isSubmitting ? "Menyimpan Ke Database..." : "Simpan Reservasi & WhatsApp"]
					})]
				})
			]
		})
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: cn("block whitespace-nowrap text-sm sm:text-lg font-black tracking-tight", inverted ? "text-white" : "text-foreground"),
				...
				className: cn("block whitespace-nowrap text-[10px] sm:text-[11px] font-semibold", inverted ? "text-white/80" : "text-muted-foreground"),
...
function Header() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			className: cn("fixed inset-x-0 top-0 z-50 transition-all duration-300", transparent ? "bg-gradient-to-b from-black/80 via-black/40 to-transparent" : "border-b border-border/80 bg-background/95 shadow-sm backdrop-blur-xl"),
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: cn("hidden lg:block border-b text-[11px] font-semibold transition-all py-1.5", transparent ? "border-white/15 bg-black/25 text-white/90 backdrop-blur-md" : "border-border/60 bg-muted/40 text-muted-foreground"),
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "flex items-center gap-1.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sun, { className: "size-3.5 text-[#C58A32] shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Cuaca Bintan: Cerah 29°C" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "flex items-center gap-1.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "size-3.5 text-[#2F7D4A] shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Jam Operasional: 08.00 - 17.00 WIB" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "flex items-center gap-1.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "size-3.5 text-[#C58A32] shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Teluk Sebong, Bintan" })]
							})
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "size-1.5 rounded-full bg-[#2F7D4A] animate-pulse" }), "Desa Wisata Hijau & Kreatif"]
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PhoneCall, { className: "size-3" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Hotline Pengelola: +62 831-6634-1280" })]
						})]
					})]
				})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
						...
						children: navItems.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							...
							className: cn("rounded-full px-3.5 py-1.5 text-xs font-extrabold transition-all whitespace-nowrap min-h-[38px] inline-flex items-center", transparent ? "text-white/90 hover:bg-white/20 hover:text-[#F7F4EA]" : "text-foreground/80 hover:bg-[#E8F1E8] hover:text-[#064E3B] active:bg-[#064E3B] active:text-white"),
							children: item.label
						}, item.label))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTrigger, {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									className: cn("grid size-10 place-items-center rounded-full transition-colors lg:hidden", transparent ? "bg-white/20 text-white hover:bg-white/30" : "bg-muted text-foreground hover:bg-accent"),
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logo, { inverted: false }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: [
										navItems.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
											to: item.to,
											..."hash" in item ? { hash: item.hash } : {},
											onClick: () => setOpenMobileMenu(false),
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Compass, { className: "size-4" }), "Rencanakan Kunjungan"]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
											href: `https://wa.me/${WHATSAPP_NUMBER}`,
											target: "_blank",
...
function Footer() {
	...
	const handleSubscribe = (e) => {
		e.preventDefault();
		if (!emailSub) return;
		toast.success("Terima kasih! Anda berhasil mendaftar newsletter info wisata Desa Ekang Anculai.");
		setEmailSub("");
	};
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Award, { className: "size-4" }), "Desa Berprestasi Prov. Kepri 2026"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "size-4 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Desa Wisata Hijau dan Kreatif Berbasis Masyarakat" })]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							...
							children: kolomNavigasi.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								href: item.href,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							...
							className: "mt-4 space-y-2.5",
							children: kolomPotensi.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								href: item.href,
								className: "text-xs text-primary-foreground/80 transition-colors hover:text-gold",
								children: item.label
							}) }, item.label))
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "mt-0.5 size-4 shrink-0 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Jl. Jendral Sudirman, Kp. Sukoharjo, Ekang Anculai, Teluk Sebong, Bintan 29151" })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										className: "flex gap-3",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Phone, { className: "size-4 shrink-0 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
											href: `https://wa.me/${WHATSAPP_NUMBER}`,
											target: "_blank",
											rel: "noreferrer",
...
function WhatsAppFloat() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("aside", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "size-7 text-white fill-current" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "sr-only",
...
var Route$4 = createFileRoute("/admin")({
	head: () => ({ meta: [{ title: "Admin Panel | Pengelolaan Desa Wisata Ekang Anculai" }, {
		name: "robots",
...
function isSpecificArticleUrl(url) {
	...
	try {
		...
		return pathname.length > 3 && (pathname.includes("-") || pathname.includes("_") || /\d/.test(pathname) || pathname.split("/").filter(Boolean).length >= 2);
	} catch {
		return false;
	}
}
function SourceLink({ source }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [source.name ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				children: [
					...
					" ",
					source.name,
					source.publishedAt && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "ml-1 opacity-75",
						children: ["• ", source.publishedAt]
					})
				]
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {}), hasValidArticleUrl && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
				href: source.url,
				target: "_blank",
				rel: "noopener noreferrer",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Baca sumber asli" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "size-3 opacity-70" })]
			})]
		})
	});
}
...
function getVillageJsonLd(villageInfo, approvedReviews = []) {
	...
	const avgRating = approvedReviews.length > 0 ? (approvedReviews.reduce((sum, r) => sum + (r.rating || 5), 0) / approvedReviews.length).toFixed(1) : null;
	const schema = {
		"@context": "https://schema.org",
		"@type": ["TouristDestination", "LocalBusiness"],
		"@id": `${baseUrl}/#village`,
		name: villageInfo?.nama || "Desa Wisata Ekang Anculai",
		description: villageInfo?.tagline || "Desa Wisata Hijau dan Kreatif Bintan. Destinasi ekowisata berbasis masyarakat di Kecamatan Teluk Sebong, Kabupaten Bintan, Kepulauan Riau.",
		url: baseUrl,
		telephone: villageInfo?.whatsapp || "+6281268326284",
		email: villageInfo?.email || "reservation@desawisataekanganculai.id",
		address: {
			"@type": "PostalAddress",
			streetAddress: villageInfo?.alamat || "Jl. Jendral Sudirman, Kp. Sukoharjo, Desa Ekang Anculai",
	...
	if (avgRating && approvedReviews.length > 0) schema["aggregateRating"] = {
...
function PaketPengalamanWisataPage() {
	...
	const [customGroupType, setCustomGroupType] = (0, import_react.useState)("Keluarga / Family Trip");
	...
	const waFullDayMsg = encodeURIComponent("Halo Pengelola Desa Wisata Ekang Anculai, saya tertarik dengan Paket Wisata Full Day (1 Hari). Mohon informasi ketersediaan jadwal, rincian biaya, dan panduan reservasi.");
	const waTwoDayMsg = encodeURIComponent("Halo Pengelola Desa Wisata Ekang Anculai, saya tertarik dengan Paket Wisata 2 Hari 1 Malam (2D1N Live-in Homestay). Mohon informasi ketersediaan jadwal, rincian biaya, dan panduan reservasi.");
	const customWhatsAppUrl = (0, import_react.useMemo)(() => {
		const chosenModulesNames = customModulesList.filter((m) => selectedModules.includes(m.id)).map((m, idx) => `   ${idx + 1}. ${m.nama} (${m.estimasi})`).join("\n");
		const chosenFacilitiesNames = customFacilitiesList.filter((f) => selectedFacilities.includes(f.id)).map((f) => `   - ${f.label}`).join("\n");
...
Mohon informasi perkiraan anggaran biaya, rekomendasi jadwal terbaik, dan panduan reservasi. Terima kasih!`;
	...
	const toggleFacility = (id) => {
		setSelectedFacilities((prev) => prev.includes(id) ? prev.filter((item) => item !== id) : [...prev, id]);
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -top-24 left-1/2 -translate-x-1/2 size-96 rounded-full bg-primary/10 blur-3xl" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute top-1/2 right-0 size-80 rounded-full bg-gold/10 blur-3xl" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "size-3.5" }), "Community Based Tourism (CBT)"]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Award, { className: "size-3.5" }), "Desa Wisata Bintan 2026"]
										})]
									}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Jelajahi Pilihan Paket" }),
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WandSparkles, { className: "size-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Rancang Paket Kustom ✨" })]
										})]
									})
								]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sun, { className: "size-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Paket 1: Full Day (1 Hari)" })]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												type: "button",
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Moon, { className: "size-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Paket 2: 2 Hari 1 Malam (2D1N)" })]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												type: "button",
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WandSparkles, { className: "size-4 text-amber-300" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Paket 3: Rancang Kustom ✨" })]
											})
										]
									})
								]
							}),
							selectedPackageTab === "fullday" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "size-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Konsultasi / Booking via WA" })]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, { className: "size-4 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Formulir Rencana Wisata" })]
											})]
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "size-4 text-emerald-600" }), "Fasilitas & Layanan Termasuk:"]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											].map((inc, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "flex items-center gap-2",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "size-4 text-emerald-600 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: inc })]
											}, i))
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "size-5 text-primary" }), "Rundown & Jadwal Aktivitas (09.00 – 17.00 WIB)"]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "relative pl-6 sm:pl-10 border-l-2 border-primary/30 space-y-8",
										children: fullDay.rangkaian.map((item, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														...
														children: item.isi.map((pt, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
															className: "flex items-start gap-2",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-3.5 text-emerald-600 shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [item.linkRef?.url ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
															href: item.linkRef.url,
															target: "_blank",
															rel: "noopener noreferrer",
															className: "inline-flex items-center gap-1 text-[11px] font-bold text-primary hover:underline",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item.linkRef.nama }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "size-3" })]
														}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Detail Rinci" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "size-3.5" })]
														})]
													})
												]
											})]
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceLink, { source: fullDay.source })
									})
								]
							}),
							selectedPackageTab === "twoday" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "size-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Konsultasi 2D1N via WA" })]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												onClick: () => setOpenPlannerModal(true),
												className: "inline-flex items-center justify-center gap-2 rounded-full bg-surface border border-border px-6 py-3 text-xs font-bold text-foreground hover:bg-accent transition-all cursor-pointer",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, { className: "size-4 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Formulir Rencana 2D1N" })]
											})]
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "size-4 text-gold" }), "Fasilitas & Layanan Termasuk (2D1N):"]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs font-medium text-foreground",
											children: [
												...
												className: "flex items-center gap-2",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "size-4 text-gold shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: inc })]
											}, i))
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, { className: "size-5 text-gold" }), "Rangkaian Acara 2 Hari 1 Malam"]
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex items-center gap-2",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
														type: "button",
											...
											selectedDay2Tab === 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: twoDay.hari1.rangkaian.map((item, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "relative group",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
															...
															children: [
																/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																	className: "flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-border/50 pb-3",
																	children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [item.kategori && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																...
																/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
																	...
																	children: item.isi.map((pt, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																		className: "flex items-start gap-2",
																		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "size-1.5 rounded-full bg-gold shrink-0 mt-1.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: pt })]
																	}, i))
																}),
											...
											selectedDay2Tab === 2 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "space-y-6 animate-fade-in",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: twoDay.hari2.rangkaian.map((item, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "relative group",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
															className: "absolute -left-[37px] sm:-left-[53px] top-1.5 grid size-9 sm:size-10 place-items-center rounded-full bg-primary text-primary-foreground font-black text-xs sm:text-sm shadow-card ring-4 ring-card",
															children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CategoryIcon, {
															...
															children: [
																...
																/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
																	...
																	children: item.isi.map((pt, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																		className: "flex items-start gap-2",
																		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "size-1.5 rounded-full bg-primary shrink-0 mt-1.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: pt })]
																	}, i))
																})
															]
														})]
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "border-t border-border pt-4",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceLink, { source: twoDay.source })
									})
								]
							}),
							selectedPackageTab === "custom" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute top-0 right-0 size-96 bg-emerald-500/10 rounded-full blur-3xl" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-border pb-8",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WandSparkles, { className: "size-3.5" }), "Interactive Custom Tour Builder"]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
												className: "mt-3 text-2xl sm:text-4xl font-extrabold text-foreground",
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "size-4 text-emerald-600" }), "1. Pilih Durasi & Jumlah Peserta"]
														}),
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
															className: "text-sm font-black uppercase tracking-wider text-primary flex items-center gap-2",
															children: [
																/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Palette, { className: "size-4 text-emerald-600" }),
																...
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
																	/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																		...
																		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
																			...
																			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: m.kategori })]
																		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																	...
																	children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["⏱️ ", m.estimasi] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																		className: "text-muted-foreground text-[10px]",
																		children: isSelected ? "✓ Termasuk di Rencana" : "+ Klik Tambahkan"
																	})]
																})]
															}, m.id);
														})
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
														className: "text-sm font-black uppercase tracking-wider text-primary flex items-center gap-2",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "size-4 text-emerald-600" }), "3. Fasilitas Tambahan & Layanan Pendukung"]
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													...
													}), selectedModules.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														...
														children: customModulesList.filter((m) => selectedModules.includes(m.id)).map((m, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "size-4.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Kirim Rancangan via WhatsApp" })]
														}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
															onClick: () => setOpenPlannerModal(true),
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, { className: "size-4 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Buka Formulir Lengkap" })]
														})]
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: cbtExperiences.map((cbt) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Lihat Seluruh Galeri Foto" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-3.5" })]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4",
						children: galeriCategories.map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "size-3.5 text-amber-300" }), "Layanan Informasi & Reservasi Desa"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Compass, { className: "size-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Isi Formulir Rencana Kunjungan" })]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
										href: `https://wa.me/${whatsappNumber}?text=${waFullDayMsg}`,
										target: "_blank",
										rel: "noopener noreferrer",
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "size-4 text-emerald-600 fill-current" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Chat WhatsApp Pengelola" })]
									})]
								})
							]
						})
			...
			activeFullDayModal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogTitle, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: activeFullDayModal.judul }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: activeFullDayModal.deskripsi }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							}), activeFullDayModal.isi.map((pt, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-start gap-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "size-3.5 text-primary shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: pt })]
							}, i))]
						})]
					})]
				})
...
var Route = createFileRoute("/desa/$slug")({
	...
	head: ({ loaderData }) => {
		if (!loaderData) return { meta: [{ title: "Profil Desa tidak ditemukan" }, {
			name: "robots",
			content: "noindex"
		}] };
		...
		const image = v.image.startsWith("http") ? v.image : `https://desawisataekanganculai.id${v.image}`;
		return {
			meta: [
				{ title },
				{
...
//#endregion
export { deleteUmkmServerFn as A, saveVillageInfoServerFn as B, checkDefaultPasswordServerFn as C, deleteKegiatanServerFn as D, deleteGaleriServerFn as E, saveDestinasiServerFn as F, cn as G, updateReservationStatusServerFn as H, saveGaleriServerFn as I, saveKegiatanServerFn as L, getAdminDashboardDataServerFn as M, getSiteDataServerFn as N, deleteReservationServerFn as O, migrateBase64ServerFn as P, saveReviewServerFn as R, checkAdminAuthServerFn as S, deleteDestinasiServerFn as T, uploadImageServerFn as U, submitPublicReviewServerFn as V, useSiteData as W, DialogHeader as _, getBreadcrumbJsonLd as a, adminLogoutServerFn as b, getVillageJsonLd as c, logo_bintan_default as d, TripPlannerModal as f, DialogFooter as g, DialogDescription as h, JsonLdScript as i, extractOgImageServerFn as j, deleteReviewServerFn as k, SourceLink as l, DialogContent as m, Route as n, getDestinationJsonLd as o, Dialog as p, Route$1 as r, getFaqJsonLd as s, router_exports as t, isSpecificArticleUrl as u, DialogTitle as v, cmsStore as w, changePasswordServerFn as x, adminLoginServerFn as y, saveUmkmServerFn as z };
