...
import {
  B as teko_kayangan_default,
  C as kegiatan_batik_2_default,
  F as reog_kendang_kempul_default,
  P as rengginang_sajian_default,
  W as villages,
  a as YOUTUBE_OFFICIAL_URL,
  f as ekang_mangrove_dermaga_default,
  i as YOUTUBE_OFFICIAL_ID,
  k as paketList,
  n as RUMAH_BATIK_URL,
  r as WHATSAPP_NUMBER,
  s as berita,
  t as DEFAULT_VILLAGE_COORDINATES,
  w as kegiatan_batik_3_default,
  y as getVillage,
  z as statistik,
...
import {
  G as cn,
  V as submitPublicReviewServerFn,
  W as useSiteData,
  _ as DialogHeader,
  c as getVillageJsonLd,
  f as TripPlannerModal,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
        className:
          "relative min-h-[92vh] w-full overflow-hidden pt-36 pb-32 sm:pb-40 flex flex-col justify-center",
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className:
              "hero-overlay absolute inset-0 bg-black/45 bg-gradient-to-t from-black/95 via-black/65 to-black/40",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                      className:
                        "inline-flex items-center gap-1.5 rounded-full bg-[#C58A32] px-3.5 py-1.5 text-xs font-black tracking-wider text-white uppercase shadow-lg border border-[#DCA348]",
                      children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                      className:
                        "inline-flex items-center gap-1.5 rounded-full bg-[#14532D] px-3.5 py-1.5 text-xs font-extrabold text-white shadow-lg border border-[#2F7D4A]/60",
                      children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                      className:
                        "inline-flex items-center gap-1 rounded-full bg-black/75 px-3.5 py-1.5 text-xs font-extrabold text-white backdrop-blur-md border border-white/30 shadow-lg",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, {
                          className: "size-3.5 text-[#C58A32]",
                        }),
                        "Teluk Sebong, Bintan",
                      ],
                    }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
                  className:
                    "mt-4 sm:mt-5 text-left text-2xl sm:text-5xl lg:text-7xl leading-[1.1] font-black tracking-tight text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.95)]",
                  children: "Desa Wisata Hijau dan Kreatif Ekang Anculai",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                  className:
                    "mt-2 sm:mt-3 text-left text-sm sm:text-xl font-black text-[#F7F4EA] italic leading-tight max-w-2xl drop-shadow-[0_2px_8px_rgba(0,0,0,0.95)]",
                  children: '"Experience the Authentic Village Life"',
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                  className:
                    "mt-2 text-left max-w-2xl text-xs sm:text-base leading-relaxed text-white/95 font-medium drop-shadow-[0_2px_6px_rgba(0,0,0,0.95)]",
                  children: '"Where Nature, Culture, Creativity, and Village Life Grow Together"',
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "mt-5 sm:mt-6 flex flex-wrap items-center justify-start gap-2 max-w-full text-left py-1",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "mt-6 sm:mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-start gap-3 text-left w-full sm:w-auto",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                      type: "button",
                      onClick: () => setOpenPlanner(true),
                      className:
                        "inline-flex items-center justify-center gap-2 rounded-full bg-[#C58A32] hover:bg-[#A87226] px-6 sm:px-7 py-3.5 text-xs sm:text-sm font-black text-white shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95 ring-2 ring-[#DCA348] cursor-pointer min-h-[48px] w-full sm:w-auto",
                      children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                      href: "#potensi",
                      className:
                        "inline-flex items-center justify-center gap-2 rounded-full bg-[#14532D] hover:bg-[#064E3B] px-6 sm:px-7 py-3.5 text-xs sm:text-sm font-black text-white shadow-xl transition-all duration-300 hover:scale-105 active:scale-95 ring-1 ring-[#2F7D4A]/60 min-h-[48px] w-full sm:w-auto text-center",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          children: "Jelajahi Potensi",
                        }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "mt-6 sm:mt-8 flex items-center gap-3 sm:gap-4 rounded-2xl bg-black/85 p-3.5 sm:p-4 backdrop-blur-md w-full max-w-xl border border-white/30 shadow-2xl text-left",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "grid size-10 sm:size-11 shrink-0 place-items-center rounded-xl bg-[#C58A32]/25 text-[#F7F4EA] font-black text-xs sm:text-sm border border-[#C58A32]/40",
                      children: ["0", index + 1],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            className:
                              "text-[10px] font-black text-[#F7F4EA] uppercase tracking-wider",
                            children: active.tag,
                          }),
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                          className:
                            "truncate text-sm sm:text-base font-black text-white text-left",
                          children: active.nama,
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                          className:
                            "truncate text-[11px] sm:text-xs text-white/80 font-medium text-left",
                          children: active.sub,
                        }),
                      ],
                    }),
...
var icons = [Building2, Sparkles, Award, Package];
function StatsSection() {
  const visits = useSiteData()?.visitCount ?? 0;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
    className:
      "w-full relative overflow-hidden bg-[#022C22] text-white py-16 sm:py-20 border-t border-b border-emerald-900/80 shadow-2xl",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className:
          "absolute -top-24 -left-24 size-96 rounded-full bg-emerald-500/10 blur-3xl pointer-events-none",
      }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className:
          "absolute -bottom-24 -right-24 size-96 rounded-full bg-amber-500/10 blur-3xl pointer-events-none",
      }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                    className:
                      "inline-flex items-center gap-1.5 rounded-full bg-emerald-800/80 px-3.5 py-1 text-xs font-extrabold text-amber-300 uppercase tracking-widest ring-1 ring-emerald-500/40",
                    children: "Profil & Statistik Desa",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                    className:
                      "inline-flex items-center gap-1.5 rounded-full bg-emerald-500/20 px-3.5 py-1 text-xs font-extrabold text-emerald-200 uppercase tracking-widest ring-1 ring-emerald-400/40",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, {
                        className: "size-3.5 text-amber-400",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                        children: [visits.toLocaleString("id-ID"), " Kunjungan Website"],
                      }),
                    ],
                  }),
                ],
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                className:
                  "mt-2 text-xs sm:text-sm font-medium text-emerald-200/90 max-w-2xl mx-auto",
                children:
                  "Informasi statistik profil wilayah, potensi CBT, kawasan ekowisata, capaian resmi, dan statistik kunjungan pengunjung digital.",
              }),
            ],
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                Reveal,
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "group relative flex h-full flex-col justify-between overflow-hidden rounded-3xl border border-emerald-700/50 bg-gradient-to-b from-emerald-900/80 to-emerald-950/90 p-6 shadow-xl backdrop-blur-md transition-all duration-500 hover:-translate-y-1.5 hover:border-amber-400/60 hover:shadow-2xl",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-transparent via-emerald-400/40 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                className:
                                  "grid size-12 place-items-center rounded-2xl bg-emerald-500/25 text-emerald-300 ring-1 ring-emerald-400/40 shadow-inner transition-transform duration-300 group-hover:scale-110 group-hover:bg-amber-400/20 group-hover:text-amber-300",
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                className:
                                  "inline-flex items-center gap-1 rounded-full bg-emerald-800/60 px-2.5 py-1 text-[10px] font-extrabold text-emerald-200 uppercase tracking-wider ring-1 ring-emerald-600/40",
                                children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                            className:
                              "mt-6 text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-amber-400 drop-shadow-sm",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                            className:
                              "mt-2 text-base font-extrabold text-white group-hover:text-amber-200 transition-colors",
                            children: s.label,
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                            className:
                              "mt-1.5 text-xs text-emerald-200/85 font-medium leading-relaxed",
                            children: s.caption,
                          }),
                        ],
                      }),
...
function DestinationSpotlight() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
    id: "potensi",
    className:
      "w-full scroll-mt-24 bg-[#F8FAFC] dark:bg-slate-900 py-20 sm:py-24 border-b border-emerald-900/10 dark:border-slate-800",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
            ...
            description:
              "Kenali pengalaman wisata yang mempertemukan alam, kreativitas, budaya, pangan lokal, dan kehidupan masyarakat.",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                className:
                                  "hero-overlay absolute inset-0 bg-gradient-to-t from-black/85 via-black/30 to-transparent opacity-80 group-hover:opacity-60 transition-opacity",
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                className:
                                  "absolute top-3 left-3 grid size-9 place-items-center rounded-2xl bg-[#064E3B] font-black text-xs text-white shadow-lg ring-1 ring-emerald-400/40",
                                children: item.num,
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                className:
                                  "mt-2 text-xs leading-relaxed text-muted-foreground line-clamp-3 font-medium",
      ...
      selectedAttraction &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
            className:
              "max-w-3xl max-h-[90vh] flex flex-col overflow-hidden rounded-3xl p-0 border-0 bg-card shadow-2xl",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    className:
                      "hero-overlay absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-black/30",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "absolute top-4 left-4 right-4 flex items-center justify-between gap-2 z-20",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                        type: "button",
                        onClick: () => setSelectedAttraction(null),
                        className:
                          "inline-flex items-center gap-2 rounded-full bg-emerald-800/90 hover:bg-emerald-900 px-4 py-2 text-xs font-black text-white backdrop-blur-md transition-all shadow-lg ring-1 ring-white/30 active:scale-95 cursor-pointer",
                        children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            className:
                              "grid size-8 place-items-center rounded-xl bg-gold font-black text-xs text-gold-foreground shadow-md",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                            ...
                            onClick: () => setSelectedAttraction(null),
                            className:
                              "grid size-10 place-items-center rounded-full bg-black/80 hover:bg-black text-white hover:text-gold border border-white/40 backdrop-blur-md transition-all shadow-xl hover:scale-110 active:scale-95 cursor-pointer",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className:
                          "inline-block rounded-md bg-gold/25 px-2.5 py-0.5 text-[11px] font-black text-gold uppercase tracking-wider backdrop-blur-md ring-1 ring-gold/40",
                        children: selectedAttraction.kategori,
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
                        className:
                          "mt-1.5 text-2xl sm:text-3xl font-black text-white leading-tight",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
                        className:
                          "text-xs font-extrabold tracking-wider text-primary uppercase flex items-center gap-2",
                        children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
                        ...
                        children: selectedAttraction.highlights.map((hl, i) =>
                  ...
                  selectedAttraction.importantNote &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "rounded-2xl bg-amber-500/10 border border-amber-500/30 p-4 flex items-start gap-3 text-xs text-amber-900 dark:text-amber-200",
                      children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceLink, {
                    source: selectedAttraction.source,
                  }),
                ],
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "shrink-0 bg-surface px-6 py-4 sm:px-8 flex flex-wrap items-center justify-between gap-3 border-t border-border z-20",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                    type: "button",
                    onClick: () => setSelectedAttraction(null),
                    className:
                      "inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-6 py-3 text-xs font-black text-primary hover:bg-primary hover:text-primary-foreground shadow-md transition-all active:scale-95 cursor-pointer",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, {
                        className: "size-4",
                      }),
                  ...
                  selectedAttraction.externalUrl &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                      ...
                      className:
                        "inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-xs font-black text-primary-foreground shadow-card hover:bg-emerald-deep transition-all active:scale-95",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          children: selectedAttraction.externalLabel || "Baca Sumber Resmi ↗",
                        }),
...
function CbtSection() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
    id: "pengalaman",
    className:
      "w-full scroll-mt-24 bg-[#ECFDF5] dark:bg-emerald-950/60 py-20 sm:py-24 border-b border-emerald-300/60 dark:border-stone-800",
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
          ...
          description:
            "Ekang Anculai menghadirkan pengalaman wisata yang dekat dengan kehidupan masyarakat. Wisatawan tidak hanya melihat destinasi, tetapi ikut belajar, berinteraksi, berkarya, menikmati pangan lokal, dan merasakan kehidupan desa.",
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          children: cbtPrinciples.map((item, index) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              Reveal,
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "card-lift flex h-full flex-col justify-between rounded-3xl border border-[#166534]/20 bg-white dark:bg-stone-900 p-6 shadow-card transition-all duration-300 hover:border-[#22C55E]/50 hover:shadow-lift",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                              className:
                                "grid size-10 place-items-center rounded-2xl bg-[#DCFCE7] text-[#166534] dark:bg-emerald-950 dark:text-emerald-300",
                              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
                                className: "size-5",
                              }),
                            }),
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                          className:
                            "mt-2 text-xs leading-relaxed text-muted-foreground font-medium",
                          children: item.desc,
                        }),
                      ],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className:
                        "mt-6 border-t border-black/5 pt-3 text-[11px] font-bold text-[#166534] dark:text-emerald-400",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "mt-20 rounded-3xl border border-[#166534]/20 bg-white dark:bg-stone-900 p-6 sm:p-10 shadow-soft",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "mx-auto flex max-w-2xl flex-col items-center justify-center text-center border-b border-black/5 pb-6",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                  className:
                    "inline-flex items-center gap-1.5 rounded-full bg-[#DCFCE7] px-3.5 py-1 text-xs font-black text-[#064E3B] uppercase tracking-wider",
                  children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                  className:
                    "mt-3 text-xs sm:text-sm text-muted-foreground text-center leading-relaxed",
                  children:
                    "Wisata Ekang Anculai dirancang fleksibel agar pengunjung dapat bebas memilih kombinasi pengalaman yang diinginkan.",
                }),
              ],
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className: "mt-10 grid gap-5 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6",
              children: experienceSteps.map((s, idx) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "flex h-full flex-col justify-between rounded-2xl border border-black/10 bg-[#F0FDF4] dark:bg-slate-800 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-[#22C55E]/50 hover:shadow-card",
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          className: "flex flex-col flex-1",
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              className:
                                "relative aspect-[16/11] w-full bg-muted rounded-t-2xl overflow-hidden",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
                                  src: s.image,
                                  alt: s.title,
                                  ...
                                  decoding: "async",
                                  className:
                                    "size-full object-cover transition-transform duration-500 group-hover:scale-108",
                                }),
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  className:
                                    "absolute top-2.5 left-2.5 grid size-7 place-items-center rounded-xl bg-[#064E3B] text-[11px] font-black text-white shadow-md backdrop-blur-sm",
                                  children: s.step,
                                }),
                              ],
                            }),
                              ...
                              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
                                    className:
                                      "text-sm font-extrabold text-foreground group-hover:text-[#166534] dark:group-hover:text-emerald-400 transition-colors min-h-[2.75rem] flex items-center leading-snug",
                                    children: s.title,
                                  }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                    className:
                                      "mt-1.5 text-xs text-muted-foreground leading-relaxed font-medium min-h-[3.25rem]",
                                    children: s.desc,
                                  }),
                                ],
                              }),
                      ...
                      idx < experienceSteps.length - 1 &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "hidden xl:flex items-center absolute -right-3.5 top-1/4 -translate-y-1/2 z-30 pointer-events-none",
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className:
                              "size-7 rounded-full bg-[#064E3B] text-amber-300 shadow-xl ring-4 ring-white dark:ring-stone-900 border border-emerald-400 flex items-center justify-center transition-transform group-hover:scale-110",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className:
                "mt-8 rounded-2xl bg-[#DCFCE7] border border-[#22C55E]/30 p-4 text-center text-xs sm:text-sm font-extrabold text-[#064E3B]",
              children:
                '"Ekang Anculai menghadirkan pengalaman wisata yang dekat dengan kehidupan masyarakat. Wisatawan tidak hanya melihat destinasi, tetapi ikut belajar, berinteraksi, berkarya, menikmati pangan lokal, dan merasakan kehidupan desa."',
            }),
          ],
...
function VideoSection() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
    className:
      "w-full scroll-mt-24 bg-[#022C22] text-white dark:bg-stone-900 py-20 sm:py-24 border-y border-emerald-900/60 dark:border-stone-800",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
            ...
            description:
              "Saksikan gambaran Desa Ekang Anculai melalui dokumentasi video yang menampilkan suasana desa, potensi alam, kegiatan masyarakat, budaya, dan pengalaman wisata berbasis masyarakat.",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "mt-10 overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900 shadow-2xl",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                      ...
                      className:
                        "group/btn flex items-center gap-3 rounded-full bg-gold px-7 py-4 font-extrabold text-gold-foreground shadow-2xl transition-all duration-300 hover:scale-108 hover:bg-gold/90 cursor-pointer",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-zinc-800 bg-zinc-900",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                        ...
                        children:
                          "Dokumentasi Desa Ekang Anculai yang menampilkan suasana desa, potensi wisata, kegiatan masyarakat, budaya, dan kehidupan lokal.",
                      }),
                    ],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                    ...
                    rel: "noopener noreferrer",
                    className:
                      "inline-flex items-center gap-2 rounded-full bg-gold px-5 py-2.5 text-xs font-extrabold text-black transition-colors hover:bg-gold/90 shrink-0",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        children: "Lihat lebih banyak video di YouTube",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, {
                        className: "size-4",
                      }),
...
function PackagesSection() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
    id: "katalog",
    className:
      "w-full scroll-mt-24 bg-[#F7F4EA] dark:bg-stone-950 py-20 sm:py-24 border-b border-[#14532D]/10 dark:border-stone-800",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
            ...
            description:
              "Pilihan paket kunjungan dan pengalaman kustom berbasis aktivitas masyarakat, ekowisata mangrove, Rumah Batik Bintan, dan homestay rumah warga.",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: filteredPaket.map((p, idx) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "article",
                {
                  className:
                    "card-lift group flex flex-col justify-between overflow-hidden rounded-3xl border border-[#14532D]/15 bg-white dark:bg-stone-900 shadow-card transition-all duration-500 hover:-translate-y-1.5 hover:border-[#14532D]/40 hover:shadow-lift h-full",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className: "flex flex-col flex-1",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
                              ...
                              loading: "lazy",
                              className:
                                "size-full object-cover transition-transform duration-700 group-hover:scale-108",
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              className:
                                "hero-overlay absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-70 group-hover:opacity-50 transition-opacity",
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                              className:
                                "absolute top-3 left-3 inline-flex items-center gap-1 rounded-full bg-[#064E3B] px-3.5 py-1.5 font-black text-xs text-white shadow-lg ring-1 ring-white/20 uppercase tracking-wide",
                              children: getPackageBadgeLabel(p.id, idx),
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                              className:
                                "absolute top-3 right-3 inline-flex items-center gap-1.5 rounded-full bg-black/75 px-3 py-1.5 text-[11px] font-extrabold text-white backdrop-blur-md shadow-sm border border-white/30",
                              children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                                  className:
                                    "flex items-center gap-1.5 text-xs font-extrabold text-[#14532D] dark:text-emerald-400",
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, {
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
                                  className:
                                    "mt-3 text-xl font-black text-foreground line-clamp-2 min-h-[3.25rem] flex items-center leading-snug group-hover:text-[#064E3B] dark:group-hover:text-emerald-300 transition-colors",
                                  children: p.nama,
                                }),
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                  className:
                                    "mt-2 text-xs sm:text-sm text-muted-foreground leading-relaxed font-medium line-clamp-3 min-h-[3.75rem]",
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                  ...
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                      className:
                                        "inline-flex items-center gap-1 rounded-full bg-[#E8F1E8] px-2.5 py-1 text-[11px] font-bold text-[#14532D]",
                                      children: [
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, {
                                          className: "size-3.5 text-[#2F7D4A]",
                                        }),
                                        "Panduan Lokal",
                                      ],
                                    }),
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "border-t border-border p-4 sm:p-5 bg-surface/60 flex items-center justify-between gap-2.5",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                              className:
                                "text-[10px] font-extrabold text-muted-foreground uppercase tracking-wider block",
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                              ...
                              className:
                                "inline-flex items-center gap-1 rounded-full border border-[#14532D]/40 bg-[#14532D]/5 px-3 py-2 text-xs font-extrabold text-[#14532D] hover:bg-[#14532D] hover:text-white transition-all cursor-pointer min-h-[44px]",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                              ...
                              onClick: () => setOpenPlanner(true),
                              className:
                                "inline-flex items-center gap-1.5 rounded-full bg-[#C58A32] hover:bg-[#A87226] px-3.5 py-2 text-xs font-black text-white shadow-md hover:scale-105 active:scale-95 transition-all cursor-pointer ring-1 ring-[#DCA348] min-h-[44px]",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Compass, {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "relative shrink-0 aspect-[16/9] sm:aspect-[21/9] w-full overflow-hidden",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            className:
                              "rounded-full bg-gold/90 px-3 py-1 text-[11px] font-black text-gold-foreground backdrop-blur-md shadow-md",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      activeModalPaket.highlight &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          className:
                            "inline-block rounded-md bg-gold/25 px-2.5 py-0.5 text-[11px] font-black text-gold uppercase tracking-wider backdrop-blur-md ring-1 ring-gold/40 mb-1",
                          children: activeModalPaket.highlight,
                        }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
                        className:
                          "text-xl sm:text-2xl lg:text-3xl font-black text-white leading-tight",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 rounded-2xl bg-surface p-4 border border-border",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                className:
                                  "text-[10px] font-bold text-muted-foreground uppercase block",
                  ...
                  activeModalPaket.deskripsiLengkap &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                          className:
                            "text-xs sm:text-sm text-foreground leading-relaxed font-medium",
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
                                className:
                                  "text-xs font-extrabold text-primary uppercase tracking-wider",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                className:
                                  "flex items-center justify-between border-b border-gold/20 pb-3",
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                    className:
                                      "text-xs font-black text-gold uppercase tracking-wider",
                                    children: "Hari Pertama",
                                  }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h5", {
                                    className: "text-xs sm:text-sm font-extrabold text-foreground",
                                    children:
                                      activeModalPaket.subHeaderHari1 ||
                                      "Creative & Green Experience",
                                  }),
                                ],
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                className: "relative pl-5 border-l-2 border-gold/40 space-y-5",
                                children: activeModalPaket.itineraryHari1.map((item, i) =>
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                    "div",
                                    {
                                      ...
                                      children: [
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                          className:
                                            "absolute -left-[27px] top-1 size-3 rounded-full bg-gold ring-4 ring-background",
                                        }),
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                          ...
                                          children: [
                                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                              className:
                                                "rounded-md bg-gold/20 px-2 py-0.5 text-[11px] font-black text-gold",
                                              children: [item.waktu, " WIB"],
                                            }),
                                            item.kategori &&
                                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                                className:
                                                  "rounded-full bg-surface px-2.5 py-0.5 text-[10px] font-extrabold text-foreground ring-1 ring-border",
                                        ...
                                        item.note &&
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                            className:
                                              "mt-1.5 inline-flex items-center gap-1.5 rounded-lg bg-amber-500/10 border border-amber-500/30 px-3 py-1 text-[11px] font-bold text-amber-900 dark:text-amber-200",
                                            children: [
                                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Info, {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className:
                              "rounded-2xl bg-primary/5 border border-primary/30 p-5 space-y-4",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                className:
                                  "flex items-center justify-between border-b border-primary/20 pb-3",
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                    className:
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h5", {
                                    className: "text-xs sm:text-sm font-extrabold text-foreground",
                                    children:
                                      activeModalPaket.subHeaderHari2 ||
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                ...
                                children: activeModalPaket.itineraryHari2.map((item, i) =>
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                    "div",
                                    {
                                      className: "relative space-y-1.5",
                                      children: [
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                          className:
                                            "absolute -left-[27px] top-1 size-3 rounded-full bg-primary ring-4 ring-background",
                                        }),
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                          className: "flex flex-wrap items-center gap-2",
                                          children: [
                                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                              className:
                                                "rounded-md bg-primary/20 px-2 py-0.5 text-[11px] font-black text-primary",
                                              children: [item.waktu, " WIB"],
                                            }),
                                            item.kategori &&
                                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                    ...
                    : activeModalPaket.itinerary
                      ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              className: "relative pl-5 border-l-2 border-primary/40 space-y-5",
                              children: activeModalPaket.itinerary.map((item, i) =>
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                  "div",
                                  {
                                    className: "relative space-y-1.5",
                                    children: [
                                      ...
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                        ...
                                        children: [
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                            className:
                                              "rounded-md bg-primary/10 px-2.5 py-0.5 text-[11px] font-black text-primary border border-primary/20",
                                            children: [item.waktu, " WIB"],
                                          }),
                                          item.kategori &&
                                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                      ...
                      : null,
                  activeModalPaket.fasilitas &&
                    activeModalPaket.fasilitas.length > 0 &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          ...
                          children: activeModalPaket.fasilitas.map((f, i) =>
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                              "span",
                              {
                                className:
                                  "inline-flex items-center gap-1.5 rounded-full bg-card px-3.5 py-1.5 text-xs font-bold text-foreground ring-1 ring-border shadow-xs",
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceLink, {
                    source: activeModalPaket.source,
                  }),
                ],
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                    ...
                    className:
                      "inline-flex items-center gap-2 rounded-full bg-[#064E3B] hover:bg-[#166534] px-6 py-3 text-xs font-black text-white shadow-card transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer ring-2 ring-emerald-400/40",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Compass, {
...
function CultureAndMarketplace() {
  ...
  const filtered = (
    siteData?.umkmList !== void 0 ? siteData.umkmList : village?.umkmList || []
  ).filter((item) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
    id: "umkm-budaya",
    className:
      "w-full scroll-mt-24 bg-[#FEFCE8] dark:bg-amber-950/40 py-20 sm:py-24 border-b border-amber-200/60 dark:border-stone-800",
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
          ...
          description:
            "Kenali hasil kreativitas dan usaha masyarakat Desa Ekang Anculai melalui produk lokal, kerajinan, kuliner, dan karya ekonomi kreatif yang telah tersedia.",
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          children: filtered.map((item) =>
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              ...
              {
                className:
                  "card-lift group flex flex-col justify-between overflow-hidden rounded-3xl border border-border bg-card shadow-card transition-all duration-500 hover:border-primary/40 hover:shadow-lift",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className:
                              "hero-overlay absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-60 group-hover:opacity-40 transition-opacity",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            className:
                              "absolute top-3 left-3 rounded-full bg-background/90 px-3 py-1 text-[11px] font-extrabold text-foreground backdrop-blur-md shadow-sm border border-border/40",
                            children: item.kategori,
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            className:
                              "absolute top-3 right-3 rounded-full bg-emerald-700 px-2.5 py-1 text-[10px] font-black text-white backdrop-blur-md shadow-md border border-emerald-400/40",
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                            className:
                              "flex items-center gap-1 text-[11px] font-extrabold text-primary",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, {
                                className: "size-3.5 text-gold shrink-0",
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                children: item.lokasi || "Desa Ekang Anculai",
                              }),
                            ],
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
                            className:
                              "mt-2 line-clamp-1 text-lg font-black text-foreground group-hover:text-primary transition-colors",
                            children: item.nama,
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                            className:
                              "mt-2 text-xs sm:text-sm font-medium leading-relaxed text-muted-foreground line-clamp-3",
                            children: item.deskripsi,
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className: "mt-3",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          className:
                            "text-xs font-black text-primary bg-emerald-500/10 px-3 py-1.5 rounded-full ring-1 ring-primary/20",
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
                          ...
                          className:
                            "grid size-10 place-items-center rounded-full bg-emerald-600 text-white shadow-md transition-all duration-300 hover:bg-emerald-500 hover:scale-110 active:scale-95 ring-2 ring-emerald-500/30 cursor-pointer shrink-0",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
          ...
          children:
            "Informasi usaha diperbarui berdasarkan sumber resmi yang tersedia. Hubungi pengelola/pemilik untuk informasi terbaru.",
        }),
      ],
    }),
  });
...
function MapSection() {
  ...
  const getTransitIcon = (mode) => {
    switch (mode) {
      case "plane":
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plane, {
          className: "size-5 text-amber-400",
        });
      case "car":
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Car, {
          className: "size-5 text-purple-400",
        });
      default:
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Ship, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
    id: "peta",
    className:
      "w-full scroll-mt-24 bg-[#064E3B] text-white py-16 sm:py-24 border-y border-emerald-900/60 shadow-2xl relative overflow-hidden",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className:
          "pointer-events-none absolute -top-40 -right-40 size-96 rounded-full bg-emerald-500/10 blur-3xl",
      }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className:
          "pointer-events-none absolute -bottom-40 -left-40 size-96 rounded-full bg-amber-500/10 blur-3xl",
      }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
            ...
            description:
              "Peta interaktif untuk membantu menemukan lokasi wisata, fasilitas, dan titik penting di Desa Wisata Ekang Anculai.",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className: "mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4",
            children: transitList.map((tr) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "div",
                {
                  className:
                    "rounded-3xl border border-emerald-800/80 bg-white/5 backdrop-blur-md p-5 shadow-soft transition-all duration-300 hover:bg-white/10 hover:border-emerald-400/40 hover:-translate-y-0.5",
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className: "flex items-center gap-3.5",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className:
                          "grid size-12 shrink-0 place-items-center rounded-2xl bg-white/10 border border-white/10",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "mt-8 overflow-hidden rounded-3xl border border-border/80 bg-card shadow-2xl text-foreground",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "flex flex-wrap items-center justify-between gap-3 border-b border-border bg-surface px-5 py-3.5",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className: "flex items-center gap-2",
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                            ...
                            children: [coords[0].toFixed(4), "° N, ", coords[1].toFixed(4), "° E"],
                          }),
                        ],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                        ...
                        className:
                          "ml-1 inline-flex items-center gap-1 rounded-lg border border-border bg-card px-2.5 py-1 text-[11px] font-semibold text-muted-foreground transition-colors hover:text-foreground hover:border-primary/40 focus:outline-none focus:ring-2 focus:ring-primary/40",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "flex items-center rounded-2xl bg-card p-1 border border-border shadow-inner",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                        type: "button",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "relative min-h-[360px] lg:min-h-[520px] h-[380px] sm:h-[460px] lg:h-[560px] w-full bg-[#f3f4f6]",
                children:
                  activeTab === "leaflet"
                    ? mounted && village
                      ...
                      : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapSkeleton, {})
                    : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            ...
                            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                              ...
                              rel: "noopener noreferrer",
                              className:
                                "inline-flex items-center gap-1.5 rounded-xl bg-white/95 px-3.5 py-2 text-xs font-extrabold text-neutral-800 shadow-md hover:bg-white transition-all border border-neutral-200",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  children: "Buka Google Maps Penuh",
                                }),
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "flex flex-wrap items-center justify-between gap-3 border-t border-border bg-surface px-5 py-4",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className:
                          "grid size-9 shrink-0 place-items-center rounded-2xl bg-primary/10 text-primary",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                        ...
                        rel: "noopener noreferrer",
                        className:
                          "inline-flex items-center gap-2 rounded-full bg-[#14532D] px-5 py-2.5 text-xs font-extrabold text-white shadow-card hover:bg-[#064E3B] transition-all",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigation, {
                            className: "size-3.5",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            children: "Mulai Navigasi Google Maps",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, {
                            className: "size-3",
                          }),
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                        ...
                        rel: "noopener noreferrer",
                        className:
                          "inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-4 py-2.5 text-xs font-extrabold text-foreground hover:border-primary/40 transition-colors",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            children: "Navigasi Waze",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, {
                            className: "size-3",
                          }),
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                        ...
                        rel: "noopener noreferrer",
                        className:
                          "inline-flex items-center gap-1.5 rounded-full border border-emerald-500/40 bg-emerald-500/10 px-4 py-2.5 text-xs font-extrabold text-emerald-700 dark:text-emerald-300 hover:bg-emerald-500/20 transition-colors",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, {
                            className: "size-3.5",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            children: "Tanya Rute WA",
                          }),
                        ],
                      }),
                    ],
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "mt-8 rounded-3xl border border-emerald-800/80 bg-white/5 backdrop-blur-md p-6 text-white text-xs leading-relaxed flex flex-col md:flex-row items-start md:items-center justify-between gap-4",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    className:
                      "grid size-9 shrink-0 place-items-center rounded-2xl bg-[#C58A32]/20 text-[#F7F4EA] font-bold border border-[#C58A32]/30",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                ...
                rel: "noopener noreferrer",
                className:
                  "inline-flex shrink-0 items-center gap-2 rounded-full bg-[#C58A32] hover:bg-[#A87226] px-5 py-2.5 font-black text-white shadow-md transition-colors",
                children: [
...
function CardThumbnail({
  ...
  const getCategoryIcon = () => {
    ...
    if (k.includes("statistik") || k.includes("bps"))
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartColumn, {
        className: "size-7 text-blue-500",
      });
    if (k.includes("bumdes") || k.includes("ekonomi"))
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Building2, {
        className: "size-7 text-emerald-600",
      });
    if (k.includes("pangan") || k.includes("pom") || k.includes("sertifikasi"))
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, {
    ...
    if (
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeartHandshake, {
        className: "size-7 text-teal-600",
      });
    if (k.includes("reog") || k.includes("budaya") || k.includes("seni") || k.includes("pawai"))
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Drama, {
        className: "size-7 text-purple-500",
      });
    if (k.includes("batik") || k.includes("kriya"))
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Palette, {
        className: "size-7 text-amber-600",
      });
    if (k.includes("kesehatan") || k.includes("posyandu") || k.includes("germas"))
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Activity, {
        className: "size-7 text-emerald-600",
      });
    if (k.includes("gotong royong") || k.includes("kerja bakti") || k.includes("pemuda"))
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Users, {
        className: "size-7 text-emerald-600",
      });
    return type === "berita"
      ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Award, { className: "size-7 text-amber-600" })
      : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, {
          className: "size-7 text-emerald-600",
        });
  };
  const innerContent = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      showImage
        ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-60 group-hover:opacity-30 transition-opacity",
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                className:
                  "absolute bottom-3 left-3 inline-flex items-center gap-1 rounded-full bg-black/70 px-2.5 py-0.5 text-[9px] font-bold text-white backdrop-blur shadow-sm",
        ...
        : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "flex size-12 items-center justify-center rounded-2xl bg-card/90 shadow-sm border border-border/60 transition-transform duration-300 group-hover:scale-110",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
        className:
          "absolute top-3 left-3 rounded-full bg-background/90 px-2.5 py-1 text-[10px] font-bold text-foreground backdrop-blur shadow-sm ring-1 ring-border/50",
        children: kategori,
      }),
      hasValidArticle &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
          className:
            "absolute bottom-3 right-3 inline-flex items-center gap-1 rounded-full bg-black/65 px-2 py-0.5 text-[9px] font-extrabold text-white backdrop-blur shadow-sm",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Rujukan Resmi" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
  ...
  if (hasValidArticle)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
      ...
      rel: "noopener noreferrer",
      className:
        "relative block aspect-[16/10] w-full overflow-hidden bg-muted/60 cursor-pointer select-none group",
...
function EventCalendar() {
  ...
  const siteData = useSiteData();
  const village = getVillage("ekang-anculai");
  const rawKegiatanList =
    siteData?.kegiatanList !== void 0 ? siteData.kegiatanList : village?.kegiatanList || [];
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
    id: "kegiatan",
    className:
      "w-full scroll-mt-24 bg-[#F0FDF4] dark:bg-emerald-950/50 py-20 sm:py-24 border-b border-emerald-200/60 dark:border-slate-800",
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
          ...
          description:
            "Laporan kegiatan pemerintah desa, musyawarah pembangunan, penyaluran BLT, dan prestasi resmi.",
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  ...
                  children: paginatedItems.map((ev) =>
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "div",
                      {
                        className:
                          "card-lift group flex flex-col justify-between overflow-hidden rounded-3xl border border-border bg-card shadow-card hover:border-primary/40 transition-all",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardThumbnail, {
                                image: ev.image,
                                title: ev.judul,
                                ...
                                children: [
                                  ...
                                  isSpecificArticleUrl(ev.source?.url)
                                    ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
                                        ...
                                        rel: "noopener noreferrer",
                                        className:
                                          "mt-1 block line-clamp-2 text-base font-extrabold text-foreground leading-snug hover:text-primary transition-colors",
                                        children: ev.judul,
                                      })
                                    : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
                                        className:
                                          "mt-1 block line-clamp-2 text-base font-extrabold text-foreground leading-snug",
                                        children: ev.judul,
                                      }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                    className:
                                      "mt-2 line-clamp-3 text-xs text-muted-foreground leading-relaxed",
                ...
                totalSlides > 1 &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-border/60",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className: "flex items-center gap-2",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                            ...
                            className:
                              "inline-flex items-center gap-1 rounded-full border border-border bg-card px-4 py-2 text-xs font-extrabold text-foreground shadow-sm hover:bg-accent disabled:opacity-40 disabled:pointer-events-none transition-all cursor-pointer",
                            children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className: "flex items-center gap-2",
                        children: Array.from({ length: totalSlides }).map((_, idx) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "button",
                            {
                              type: "button",
        ...
        activeTab === "berita" &&
          (() => {
            if (validBeritaList.length === 0)
              return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "mt-8 rounded-2xl border border-border bg-card p-8 text-center shadow-soft",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Award, {
                    className: "mx-auto size-12 text-primary/60",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                    ...
                    children:
                      "Seluruh informasi prestasi dan kegiatan desa dapat diverifikasi langsung melalui dokumen publikasi resmi pemerintah daerah dan pengelola.",
                  }),
                ],
              });
            const pageSize = 6;
...
function ReviewsAndFaqSection() {
  ...
  const faqsList =
    siteData?.faqs !== void 0 && siteData.faqs.length > 0 ? siteData.faqs : village?.faqs || [];
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
    id: "ulasan-faq",
    className:
      "w-full scroll-mt-24 bg-[#F5F1E8] dark:bg-stone-900/90 py-20 sm:py-24 border-b border-stone-300/60 dark:border-zinc-800",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8",
        children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
                    ...
                    description:
                      "Pengalaman berkesan wisatawan mancanegara, keluarga, dan pasangan yang telah berkunjung.",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                    type: "button",
                    onClick: () => setOpenModal(true),
                    className:
                      "inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-xs font-extrabold text-primary-foreground shadow-card hover:bg-emerald-deep cursor-pointer",
                    children: [
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  className:
                                    "rounded-full bg-surface px-3 py-1 text-[11px] font-bold text-muted-foreground",
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              children: [
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                                  ...
                                  children: ["Asal ", rev.asal, " • ", rev.tanggal],
                                }),
                              ],
                            }),
                          ],
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "border-b border-border pb-6 text-center flex flex-col items-center justify-center",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
                    className:
                      "mt-1 text-2xl font-extrabold text-foreground sm:text-3xl text-center",
                    ...
                    AccordionItem,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionTrigger, {
                          className:
                            "text-left font-extrabold text-foreground text-sm sm:text-base hover:no-underline hover:text-primary",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className:
              "mt-12 overflow-hidden rounded-3xl bg-gradient-to-br from-[#064E3B] via-[#047857] to-[#166534] p-8 sm:p-10 text-white shadow-2xl relative",
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                      className:
                        "inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3 py-1 text-xs font-bold text-amber-300 backdrop-blur-md",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                      ...
                      children:
                        "Tanyakan paket wisata, kunjungan, kegiatan, dan informasi terbaru Desa Wisata Ekang Anculai.",
                    }),
                  ],
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                  ...
                  rel: "noopener noreferrer",
                  className:
                    "inline-flex shrink-0 items-center gap-2 rounded-full bg-gold px-7 py-4 text-xs font-black text-gold-foreground shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-gold/90 cursor-pointer",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageSquare, {
                      className: "size-4",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                      children: "Hubungi Pengelola via WA",
                    }),
                  ],
                }),
              ],
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                      ...
                      className:
                        "mt-1.5 w-full rounded-2xl border border-border bg-surface px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-primary/20",
                    }),
                  ],
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
                          ...
                          className:
                            "mt-1.5 w-full rounded-2xl border border-border bg-surface px-3 py-2.5 text-xs font-medium outline-none",
                          children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                  type: "submit",
                  className:
                    "w-full rounded-full bg-primary py-3 text-xs font-bold text-primary-foreground shadow-card hover:bg-emerald-deep",
