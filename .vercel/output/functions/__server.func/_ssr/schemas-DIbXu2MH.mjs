import { a as objectType, i as numberType, n as enumType, o as stringType, r as literalType, s as unknownType, t as arrayType } from "../_libs/zod.mjs";
...
var klasifikasiInfo = {
	Mandiri: {
		...
		deskripsi: "Desa wisata dengan inovasi tata kelola mandiri berbasis masyarakat, kemitraan pariwisata yang berjalan, serta penerapan standar pelestarian lingkungan.",
		kriteria: [
	...
	Maju: {
		...
		deskripsi: "Masyarakat aktif mengelola potensi lokal, kelembagaan desa berjalan baik, serta sarana & paket wisata telah ditata rapi.",
		kriteria: [
	...
	Berkembang: {
		...
		deskripsi: "Desa dengan potensi alam, pertanian, maupun budaya yang terus dikembangkan bersama masyarakat dan pengelola setempat.",
		kriteria: [
	...
	Rintisan: {
		...
		deskripsi: "Desa dengan potensi wisata yang sedang dirintis, didukung kesadaran warga dan pembinaan dari pemerintah daerah.",
		kriteria: [
...
var galeriDataset = [
	{
		...
		kategori: "Mangrove",
		image: ekangMangrove,
		caption: "Keasrian kanopi hutan bakau alami dan pohon mangrove berbuah di perairan Desa Ekang Anculai.",
	...
	},
	{
		...
		caption: "Lahan perkebunan sayuran dan tanaman pangan masyarakat Desa Ekang Anculai dengan sistem lanjaran tradisional.",
	...
	},
	{
		...
		kategori: "Budaya",
		image: ekangReog,
		caption: "Suasana latihan dan pelestarian seni tradisional Reog Ponorogo di Sanggar Seni Reog Sedulur Manunggal Fersi Kendang Kempul Desa Ekang Anculai.",
	...
	},
	{
		...
		kategori: "Gastronomi",
		image: ekangKuliner,
		caption: "Sajian kuliner rumahan masyarakat khas desa dan hidangan tradisional autentik Ekang Anculai.",
	...
	},
	{
		...
		image: ekangAnculai,
		caption: "Musyawarah Desa perencanaan pembangunan dan pengelolaan pariwisata berbasis masyarakat.",
	...
	},
	{
		...
		caption: "Wisatawan bangga memperlihatkan hasil karya batik tulis dan pewarnaan tie-dye buatan sendiri di Rumah Batik Bintan.",
	...
	},
	{
		...
		caption: "Suasana workshop membatik interaktif: wisatawan belajar mencanting dengan malam panas bersama perajin lokal desa.",
	...
	},
	{
		...
		caption: "Wisatawan mancanegara mempraktikkan proses pewarnaan kain batik menggunakan pemidangan di Rumah Batik Bintan.",
	...
	},
	{
		...
		caption: "Sajian Rengginang Comel renyah aneka warna olahan beras ketan alami karya UMKM Dapur Rub Desa Ekang Anculai.",
	...
	},
	{
		...
		caption: "Produk Rengginang Comel dengan izin legalitas usaha lengkap, NPWP, dan sertifikasi Halal resmi.",
	...
	},
	{
		...
		caption: "Kemasan rengginang mentah kering berkualitas hasil penjemuran alami siap goreng mekar di rumah.",
	...
	},
	{
		...
		caption: "Monumen air mancur Teko Kayangan yang unik di ruang terbuka hijau Desa Wisata Ekang Anculai, menjadi spot foto ikonik dan ruang kreativitas masyarakat.",
	...
	},
	{
		...
		caption: "Dermaga dan jembatan boardwalk kayu menuju perahu wisata susur sungai dan eksplorasi hutan mangrove Desa Ekang Anculai.",
	...
	},
	{
		...
		caption: "Para pemuda dan seniman desa memainkan irama musik gamelan, gong, dan kendang kempul mengiringi pementasan Reog Sedulur Manunggal.",
	...
	},
	{
		...
		caption: "Membersihkan Lapangan Volly bersama mahasiswa UMRAH KKN kelompok 45 Ekang Anculai 2026",
...
var officialFullDayPackage = {
	...
	konsep: "Pengalaman wisata berbasis masyarakat yang mengajak wisatawan mengenal kreativitas, pertanian, kuliner, budaya, dan produk lokal Desa Ekang Anculai secara langsung.",
	storytelling: "Sehari di Ekang Anculai bukan sekadar perjalanan wisata. Anda diajak mengenal kreativitas, kehidupan petani, cita rasa pangan lokal, budaya Melayu, dan produk masyarakat melalui pengalaman yang dekat dengan kehidupan desa.",
	highlights: [
		{
			icon: "batik",
	...
	rangkaian: [
		...
		},
		{
			...
			icon: "culture",
			deskripsi: "Perjalanan dilanjutkan dengan mengenal seni dan budaya Melayu yang hadir di berbagai sudut desa, seperti di Rumah Batik Bintan maupun lokasi kegiatan warga. Wisatawan dapat mengenal cerita rakyat, tradisi lokal, dan berinteraksi langsung dengan pelaku seni masyarakat.",
			isi: [
		...
		},
		{
			...
			icon: "umkm",
			deskripsi: "Menjelang akhir perjalanan, wisatawan diberikan kesempatan untuk mengenal dan berbelanja produk batik serta produk UMKM desa. Pengunjung dapat memilih produk lokal sebagai oleh-oleh sekaligus mengenal hasil kreativitas masyarakat. Kegiatan kemudian ditutup dengan foto bersama serta penyerahan suvenir dan sertifikat pengalaman apabila tersedia.",
			isi: [
	...
	cbtDescription: "Paket ini dirancang untuk menghadirkan pengalaman yang dekat dengan kehidupan masyarakat Ekang Anculai, mulai dari belajar membatik, beraktivitas di kebun, menikmati pangan lokal, mengenal budaya Melayu, hingga melihat dan membeli produk masyarakat.",
	cbtValues: [
		{
			num: "01",
...
var officialTwoDayPackage = {
	...
	deskripsi: "Pengalaman menginap dan berinteraksi lebih dekat dengan masyarakat melalui kegiatan kreatif, pertanian, kuliner, kerajinan, mangrove, budaya, dan kehidupan desa.",
	hari1: {
		...
		rangkaian: [
			{
				...
				icon: "mangrove",
				deskripsi: "Pengalaman dimulai dengan penyambutan wisatawan di Desa Ekang Anculai. Wisatawan menikmati welcome drink sebagai pembuka perjalanan sekaligus mendapatkan pengenalan awal mengenai rangkaian pengalaman wisata yang akan dijalani selama berada di desa.",
			...
			},
			{
				...
				kategori: "Creative Experience",
				icon: "batik",
				deskripsi: "Setelah penyambutan, wisatawan diajak mengenal filosofi Batik Bintan dan mencoba proses membatik secara langsung. Bersama pengrajin, pengunjung mendapatkan pengalaman belajar dan berkarya melalui praktik membatik, kemudian membawa pulang hasil karya sebagai bagian dari pengalaman perjalanan.",
				isi: [
			...
			},
			{
				...
				kategori: "Village Farming Experience",
				icon: "farm",
				deskripsi: "Pengunjung kemudian diajak mengenal kehidupan pertanian desa melalui aktivitas berkebun bersama masyarakat. Wisatawan dapat mengenal pertanian desa, mengikuti kegiatan menanam atau memanen sayuran sesuai musim, serta berinteraksi langsung dengan petani lokal.",
				isi: [
			...
			},
			{
				...
				kategori: "Gastronomy Experience",
				icon: "culinary",
				deskripsi: "Wisatawan menikmati makan siang dengan cita rasa pangan lokal melalui aneka olahan ubi dan daun ubi serta minuman herbal khas desa. Kegiatan ini menjadi bagian dari pengalaman mengenal kekayaan pangan dan cita rasa lokal Ekang Anculai.",
			...
			},
			{
				...
				icon: "craft",
				deskripsi: "Pada sore hari, wisatawan diajak mengenal keterampilan dan kreativitas masyarakat melalui workshop kerajinan desa bersama perajin lokal sebagai pengalaman berkesan dari Ekang Anculai.",
			...
			},
			{
				...
				icon: "homestay",
				deskripsi: "Setelah mengikuti berbagai aktivitas sepanjang hari, wisatawan melakukan check-in di Homestay Rumah Warga. Selain beristirahat, pengunjung mendapatkan kesempatan untuk merasakan suasana tinggal di lingkungan masyarakat dan berinteraksi dengan keluarga tuan rumah.",
			...
			},
			{
				...
				icon: "night",
				deskripsi: "Malam hari diisi dengan makan malam bersama sambil menikmati suasana kehidupan desa. Wisatawan dapat menikmati hidangan rumahan dan berbincang bersama masyarakat. Api unggun atau pertunjukan musik akustik dapat dilakukan sebagai aktivitas opsional apabila tersedia.",
		...
		rangkaian: [
			{
				...
				icon: "breakfast",
				deskripsi: "Memulai hari kedua dengan sarapan di homestay sambil menikmati suasana pagi di lingkungan masyarakat. Kegiatan ini menjadi bagian sederhana dari pengalaman merasakan kehidupan desa sebelum melanjutkan perjalanan.",
			...
			},
			{
				...
				icon: "mangrove",
				deskripsi: "Perjalanan pagi dilanjutkan dengan eksplorasi kawasan mangrove. Wisatawan diajak menyusuri mangrove sambil mengenal ekosistem pesisir, mengamati flora dan fauna, serta menikmati kesempatan untuk mengabadikan keindahan lingkungan alam sekitar.",
				isi: [
					"Susur mangrove.",
					"Edukasi ekosistem pesisir.",
					"Foto dan pengamatan flora-fauna."
				]
			},
			{
				waktu: "10.00–11.30",
				...
				icon: "walk",
				deskripsi: "Setelah menjelajahi mangrove, wisatawan diajak berjalan menyusuri lingkungan Desa Ekang Anculai untuk mengenal kehidupan masyarakat secara lebih dekat. Dalam perjalanan, pengunjung dapat melihat kebun, mengenal UMKM, serta mengunjungi berbagai titik menarik yang menjadi bagian dari kehidupan desa.",
				isi: [
					"Keliling desa.",
			...
			},
			{
				...
				kategori: "Cultural Experience",
				icon: "culture",
				deskripsi: "Pengalaman budaya berlanjut di berbagai titik desa melalui pertunjukan tari, musik tradisional Melayu, dan tradisi lokal. Wisatawan diajak mengenal cerita rakyat dan berinteraksi langsung dengan pelaku seni masyarakat.",
				isi: [
			...
			},
			{
				...
				kategori: "Gastronomy Experience",
				icon: "dining",
				deskripsi: "Setelah mengikuti pengalaman budaya, wisatawan menikmati makan siang sebelum melanjutkan kegiatan terakhir dalam rangkaian perjalanan.",
			...
			},
			{
				...
				kategori: "Local Product Experience",
				icon: "shopping",
				deskripsi: "Sebagai bagian dari akhir perjalanan, wisatawan diberikan kesempatan untuk mengenal dan membeli berbagai produk lokal masyarakat. Produk yang dapat dikenalkan meliputi Batik Bintan, Rengginang Comel, produk pangan lokal, dan oleh-oleh khas Ekang Anculai.",
				isi: [
					"Batik Bintan",
			...
			},
			{
				...
				icon: "farewell",
				deskripsi: "Rangkaian pengalaman wisata di Ekang Anculai ditutup dengan perpisahan dan kepulangan wisatawan setelah mengikuti berbagai aktivitas yang memperkenalkan kreativitas, pertanian, kuliner, kerajinan, alam, budaya, kehidupan masyarakat, dan produk lokal desa.",
...
var villages = [{
	...
	alamat: "Jl. Jendral Sudirman, Kp. Sukoharjo, Desa Ekang Anculai, Kec. Teluk Sebong, Kab. Bintan, Kepulauan Riau 29151",
	...
	landmarks: [
		{
			...
			deskripsi: "Kawasan sentra aktivitas desa wisata hijau dan kreatif berbasis masyarakat (CBT).",
			image: ekangAnculai,
			source: {
		...
		},
		{
			...
			lat: 1.08625,
			lng: 104.36345,
			deskripsi: "Pusat galeri batik khas Bintan serta ruang workshop membatik tulis dan cap bagi wisatawan.",
			image: ekangBatik,
			source: {
		...
		},
		{
			...
			lat: 1.08437,
			lng: 104.3658,
			deskripsi: "Kawasan konservasi dan ekowisata hutan mangrove pesisir dengan jalur susur sungai alami.",
			image: ekangMangrove,
			source: {
		...
		},
		{
			...
			lat: 1.0871,
			lng: 104.3615,
			deskripsi: "Monumen air mancur & ruang terbuka hijau tempat pertunjukan budaya dan kreativitas warga.",
			image: teko_kayangan_default,
			source: {
				name: "Pengelola Desa Wisata Ekang",
				url: "https://desaekanganculai.bintankab.go.id/",
		...
		},
		{
			...
			lat: 1.0856,
			lng: 104.3612,
			deskripsi: "Pusat pelayanan administrasi pemerintahan desa dan balai musyawarah masyarakat.",
			image: ekangAnculai,
			source: {
				name: "Pemerintah Desa Ekang Anculai",
				url: "https://desaekanganculai.bintankab.go.id/",
		...
		},
		{
			...
			lat: 1.0875,
			lng: 104.3628,
			deskripsi: "Masjid Baiturrahman pusat kegiatan ibadah dan keagamaan warga Kampung Sukoharjo.",
			image: ekangAnculai,
			source: {
	...
	kegiatanList: [
		{
			...
			deskripsi: "Penyaluran paket sembako dari BUMDesma Sukses Mandiri Kecamatan Teluk Sebong bagi masyarakat Desa Ekang Anculai.",
		...
		},
		{
			...
			deskripsi: "Musyawarah Rencana Pembangunan Desa (Musrenbangdesa) dalam rangka pembahasan dan pengesahan rancangan RKPDes Desa Ekang Anculai.",
		...
		},
		{
			...
			deskripsi: "Pelatihan pengelolaan dan pelaporan keuangan desa berbasis aplikasi Siskeudes untuk aparatur Desa Ekang Anculai.",
			tanggal: "18 Mei 2024",
			image: "",
			source: {
				name: "Website Resmi Desa Ekang Anculai",
		...
		},
		{
			...
			deskripsi: "Kegiatan pembangunan infrastruktur jaringan jalan semenisasi Gang Kancil untuk kenyamanan akses warga desa.",
		...
		{
			id: "kg-2026-1",
			judul: "Aksi Gotong Royong Membersihkan Lapangan Volly Bersama Mahasiswa KKN 45 Ekang Anculai Universitas Maritim Raja Ali Haji",
			kategori: "Gotong Royong & Kepemudaan",
			deskripsi: "Kerja bakti pembersihan dan penataan fasilitas lapangan volly desa bersama mahasiswa UMRAH KKN kelompok 45 Ekang Anculai.",
		...
		{
			id: "kg-2026-3",
			judul: "Pentas Seni Budaya Reog Sedulur Manunggal Fersi Kendang Kempul Ekang Anculai di Kawasan Lagoi",
			kategori: "Kesenian Tradisional",
			deskripsi: "Atraksi kesenian reog dan kuda kepang sanggar pemuda desa yang tampil memukau menghibur para wisatawan di kawasan Bintan Resorts Lagoi.",
		...
		{
			id: "kg-2026-6",
			judul: "Workshop Edukasi Membatik Canting 'Enjoy With Art' di Rumah Batik Bintan Ekang Anculai",
			kategori: "Kriya & Edukasi Warga",
			deskripsi: "Pelatihan keterampilan teknik mencanting dan pewarnaan motif batik khas Bintan bagi generasi muda dan perajin binaan di Rumah Batik Bintan.",
	...
	umkmList: [
		{
			...
			deskripsi: "Sajian kudapan tradisional rengginang renyah aneka warna dari olahan ketan berkualitas, disajikan hangat sebagai suguhan kuliner khas bagi wisatawan.",
		...
		},
		{
			...
			deskripsi: "Kain batik tulis dan cap eksklusif bermotif biota laut, daun mangrove, dan ornamen Melayu Bintan karya perajin lokal di Rumah Batik Bintan.",
		...
		},
		{
			...
			deskripsi: "Rengginang Comel renyah aneka warna siap santap dalam kemasan standing pouch premium, bersertifikat Halal resmi & berizin PIRT, oleh-oleh favorit wisatawan.",
	...
	panduanKunjungan: {
		...
		aksesibilitas: "15 menit dari Terminal Ferry Bandar Bentan Telani (BBT Lagoi) / 45 menit dari Bandara RHF Tanjungpinang via jalan aspal mulus.",
		etikaKunjungan: [
	...
	kelembagaan: {
		bumdes: "BUMDes Anugrah Ekang Anculai — Pengelola unit usaha pasar desa, air bersih, & kemitraan.",
		pokdarwis: "Pengelola Pesona Ekang — Pengelola operasional harian wahana wisata, pemandu & paket reservasi.",
		sanggar: "Sanggar Seni Reog Sedulur Manunggal Fersi Kendang Kempul — Wadah pelestarian seni Reog & Kuda Kepang.",
	...
	reviews: [
		{
			...
			komentar: "Pengalaman tinggal bersama masyarakat Ekang Anculai sungguh berkesan! Hanya 15 menit dari Lagoi Ferry Terminal, suasananya sangat tenang, autentik, dan ramah.",
		...
		},
		{
			...
			komentar: "Desa wisata yang sangat bersih dan asri. Belajar membatik di Rumah Batik Bintan sangat edukatif untuk anak-anak. Rengginang Comel dan masakan rumahan khas desanya sangat nikmat!",
		...
		},
		{
			...
			rating: 5,
			tanggal: "15 Mei 2026",
			komentar: "Ekowisata mangrove-nya tenang sekali. Pemandu lokal ramah dan cerita kehidupan desa sangat menginspirasi. Tempat pemulihan jiwa di akhir pekan!",
	...
	faqs: [
		{
			...
			jawaban: "Dari Singapura, naik ferry ke Terminal Bandar Bentan Telani (BBT) Lagoi Bintan (45 menit perjalanan ferry). Dari BBT Lagoi, Desa Ekang Anculai berjarak 15 menit berkendara. Dari Batam, naik ferry ke Pelabuhan Roro Tanjung Uban, dilanjutkan 25 menit perjalanan darat.",
			kategori: "Transportasi"
		},
		{
			pertanyaan: "Bagaimana konsep Homestay Rumah Warga di Ekang Anculai?",
			jawaban: "Program Homestay Rumah Warga dikembangkan agar wisatawan dapat menginap di rumah masyarakat yang menyediakan kamar untuk tamu, makan bersama warga, dan mengenal aktivitas desa secara langsung.",
			kategori: "Akomodasi & Fasilitas"
		},
		{
			pertanyaan: "Metode pembayaran apa saja yang diterima di desa?",
			jawaban: "Transaksi di Rumah Batik Bintan dan stand UMKM desa mendukung pembayaran non-tunai via QRIS (BCA, GoPay, OVO, ShopeePay, Dana, dll) serta pembayaran tunai Rupiah (IDR).",
			kategori: "Sistem Pembayaran"
		},
		{
			pertanyaan: "Apakah ada program edukasi lingkungan dan membatik?",
			jawaban: "Ada, wisatawan dapat mengikuti edukasi lingkungan di Ekang Mangrove Park dan praktik membatik canting di Rumah Batik Bintan bersama perajin lokal.",
			kategori: "Akomodasi & Fasilitas"
		}
	],
	deskripsi: "Desa Wisata Ekang Anculai terletak di Kecamatan Teluk Sebong, Kabupaten Bintan, Kepulauan Riau. Desa ini menyajikan perpaduan pesona ekowisata mangrove, kehangatan Homestay Rumah Warga, kerajinan Rumah Batik Bintan, pertunjukan budaya, dan kehidupan pertanian masyarakat yang autentik.",
	sejarah: "Nama Ekang Anculai berakar dari istilah dialek Tionghoa (Teochew) 'Gek' atau 'Kang' yang merujuk pada alur sungai dan pemukiman awal masyarakat di tepi sungai. Berdiri sebagai daerah pertanian strategis sejak masa kolonial, desa ini berkembang harmonis dihuni masyarakat multietnis. Wilayah desa mengalami pemekaran administratif secara resmi pada tahun 1979 dan 2007. Desa ini kini dikenal luas atas kesuksesan pengembangan ekowisata berbasis masyarakat dan meraih Peringkat III Desa/Kelurahan Berprestasi Tingkat Provinsi Kepulauan Riau Tahun 2026.",
	image: ekangAnculai,
	galeri: [
		ekangAnculai,
		ekangMangrove,
	...
	paket: [
		{
			...
			deskripsiLengkap: "Pengalaman wisata satu hari yang mengajak wisatawan mengenal kehidupan Desa Ekang Anculai melalui kreativitas, pertanian masyarakat, kuliner lokal, budaya Melayu, serta produk UMKM desa.",
			fasilitas: [
			...
			itinerary: [
				{
					...
					kategori: "Persiapan",
					deskripsi: "Konsultasikan tanggal kunjungan, perkiraan peserta, serta kombinasi aktivitas desa yang Anda inginkan bersama pengelola."
				},
				{
					waktu: "Personalisasi",
					kegiatan: "Penyusunan Program & Rencana Kunjungan",
					kategori: "Kustomisasi",
					deskripsi: "Pengelola menyusun rangkaian acara yang dipersonalisasi sesuai kebutuhan alokasi waktu dan budget Anda."
				},
				{
					waktu: "Kunjungan",
					kegiatan: "Pelaksanaan Pengalaman Wisata Khusus",
					kategori: "Kunjungan",
					deskripsi: "Menikmati pengalaman wisata autentik Desa Ekang Anculai dengan fleksibilitas tinggi dan pendampingan pemandu lokal."
				}
			],
			source: {
				name: "Pemerintah Desa Ekang Anculai & Pengelola Wisata",
...
var berita = [
	{
		...
		judul: "Ekang Anculai dan Tanjung Uban Selatan Raih Penghargaan Desa dan Kelurahan Berprestasi 2026 Tingkat Provinsi",
		ringkas: "Desa Ekang Anculai meraih peringkat III se-Kepulauan Riau dalam evaluasi Desa dan Kelurahan Berprestasi Tingkat Provinsi Kepri 2026.",
	...
	},
	{
		...
		ringkas: "Liputan Kompas.com mengenai konsep pengembangan ekowisata pedesaan dan daya tarik wisata berbasis masyarakat (CBT) Desa Wisata Ekang Anculai.",
	...
	},
	{
		...
		ringkas: "Liputan6 mempublikasikan keasrian alam, konsep tempat tinggal D'Bamboo Kamp, dan aktivitas outdoor menarik di Desa Wisata Ekang Anculai.",
	...
	},
	{
		...
		ringkas: "Ulasan KataKepri mengenai ragam daya tarik pariwisata terpadu berbasis masyarakat di Desa Wisata Ekang Anculai.",
	...
	},
	{
		...
		ringkas: "Good News From Indonesia mengulas ragam rekreasi keluarga seru mulai dari penginapan glamping, berkuda, hingga jalur wahana ATV di Ekang Anculai.",
...
var loginInputSchema = objectType({
	username: stringType({ required_error: "Username wajib diisi." }).trim().min(3, "Username minimal 3 karakter.").max(50, "Username maksimal 50 karakter."),
	password: stringType({ required_error: "Kata sandi wajib diisi." }).trim().min(6, "Kata sandi minimal 6 karakter.").max(100, "Kata sandi maksimal 100 karakter.")
});
var changePasswordInputSchema = objectType({
	token: stringType().optional(),
	oldPassword: stringType({ required_error: "Kata sandi lama wajib diisi." }).min(1, "Kata sandi lama wajib diisi.").max(100),
	newPassword: stringType({ required_error: "Kata sandi baru wajib diisi." }).min(8, "Kata sandi baru minimal 8 karakter.").max(100, "Kata sandi baru maksimal 100 karakter.")
});
...
var imageUploadSchema = objectType({
	...
	base64Data: stringType({ required_error: "Data gambar wajib diisi." }).min(50, "Data gambar tidak lengkap.").max(10485760, "Ukuran payload gambar melebihi batas 10MB.")
});
var villageInfoSchema = objectType({
	...
	info: objectType({
		...
		whatsapp: stringType().trim().regex(PHONE_REGEX, "Nomor WhatsApp wajib berupa angka yang valid (8-18 digit)."),
...
var destinasiSchema = objectType({
	...
	item: objectType({
		...
		nama: stringType({ required_error: "Nama destinasi wajib diisi." }).trim().min(2, "Nama destinasi minimal 2 karakter.").max(150, "Nama destinasi maksimal 150 karakter."),
...
var kegiatanSchema = objectType({
	...
	item: objectType({
		id: stringType().trim().max(100).optional(),
		judul: stringType({ required_error: "Judul kegiatan wajib diisi." }).trim().min(2, "Judul kegiatan minimal 2 karakter.").max(200, "Judul kegiatan maksimal 200 karakter."),
...
var extractOgImageSchema = objectType({
	token: stringType().optional(),
	url: stringType({ required_error: "URL publikasi wajib diisi." }).trim().min(1, "URL wajib diisi.")
});
var umkmSchema = objectType({
	token: stringType().optional(),
	item: objectType({
		id: stringType().trim().max(100).optional(),
		nama: stringType({ required_error: "Nama produk/UMKM wajib diisi." }).trim().min(2, "Nama produk/UMKM minimal 2 karakter.").max(150, "Nama produk/UMKM maksimal 150 karakter."),
		slug: stringType().trim().max(150).optional(),
...
var galeriSchema = objectType({
	...
	item: objectType({
		id: stringType().trim().max(100).optional(),
		judul: stringType({ required_error: "Judul foto wajib diisi." }).trim().min(2, "Judul foto minimal 2 karakter.").max(150, "Judul foto maksimal 150 karakter."),
		kategori: stringType().trim().min(1).max(100).default("Lanskap Desa"),
		image: stringType({ required_error: "Gambar foto wajib diisi." }).trim().min(1, "Gambar foto wajib diisi.").max(1e3),
...
var publicReviewSchema = objectType({
	nama: stringType({ required_error: "Nama wajib diisi." }).trim().min(2, "Nama minimal 2 karakter.").max(100, "Nama maksimal 100 karakter."),
	asal: stringType().trim().max(100).optional().default("Wisatawan"),
	tipeWisatawan: enumType([
		"Keluarga",
		"Pasangan",
		"Mancanegara",
		"Rombongan / KKN"
	]).default("Keluarga"),
	rating: numberType({ required_error: "Rating bintang wajib diisi." }).int("Rating harus bilangan bulat.").min(1, "Rating minimal 1 bintang.").max(5, "Rating maksimal 5 bintang."),
	komentar: stringType({ required_error: "Ulasan wajib diisi." }).trim().min(5, "Ulasan minimal 5 karakter.").max(1e3, "Ulasan maksimal 1000 karakter.")
});
...
var homestaySchema = objectType({
	...
	item: objectType({
		id: stringType().trim().max(100).optional(),
		nama: stringType({ required_error: "Nama homestay wajib diisi." }).trim().min(2, "Nama homestay minimal 2 karakter.").max(150, "Nama homestay maksimal 150 karakter."),
		slug: stringType().trim().max(150).optional(),
...
var paketWisataSchema = objectType({
	...
	item: objectType({
		id: stringType().trim().max(100).optional(),
		nama: stringType({ required_error: "Nama paket wisata wajib diisi." }).trim().min(2, "Nama paket wisata minimal 2 karakter.").max(150, "Nama paket wisata maksimal 150 karakter."),
		slug: stringType().trim().max(150).optional(),
		...
		lokasi_spesifik: stringType().trim().max(200).optional().default("Kawasan Wisata Ekang Anculai"),
		harga_text: stringType().trim().max(100).optional().default("Hubungi Pengelola"),
...
var faqSchema = objectType({
	...
	item: objectType({
		id: stringType().trim().max(100).optional(),
		pertanyaan: stringType({ required_error: "Pertanyaan FAQ wajib diisi." }).trim().min(3, "Pertanyaan minimal 3 karakter.").max(300, "Pertanyaan maksimal 300 karakter."),
		jawaban: stringType({ required_error: "Jawaban FAQ wajib diisi." }).trim().min(3, "Jawaban minimal 3 karakter.").max(2e3, "Jawaban maksimal 2000 karakter."),
		kategori: stringType().trim().max(50).default("Umum"),
		status: enumType(["published", "draft"]).default("published")
	})
});
var reservationPublicSchema = objectType({
	namaPemesan: stringType({ required_error: "Nama pemesan wajib diisi." }).trim().min(2, "Nama pemesan minimal 2 karakter.").max(100, "Nama pemesan maksimal 100 karakter."),
	whatsapp: stringType({ required_error: "Nomor WhatsApp wajib diisi." }).trim().regex(PHONE_REGEX, "Nomor WhatsApp wajib berupa angka yang valid (8-18 digit)."),
	email: stringType().trim().email("Format email tidak valid.").or(literalType("")).optional().default(""),
	tanggalKunjungan: stringType({ required_error: "Tanggal kunjungan wajib diisi." }).trim().regex(/^\d{4}-\d{2}-\d{2}$/, "Format tanggal kunjungan harus YYYY-MM-DD.").refine((val) => {
		const parsed = new Date(val);
		return !isNaN(parsed.getTime());
	}, "Tanggal kunjungan tidak valid kalender."),
	jamKedatangan: stringType({ required_error: "Jam kedatangan wajib diisi." }).trim().regex(/^([01]\d|2[0-3]):[0-5]\d$/, "Format jam kedatangan harus HH:mm (contoh: 09:00).").refine((val) => val >= "08:00" && val <= "17:00", "Jam kedatangan harus berada di antara jam operasional desa (08.00–17.00 WIB)."),
	jumlahDewasa: numberType({ required_error: "Jumlah peserta dewasa wajib diisi." }).int("Jumlah peserta dewasa harus berupa bilangan bulat.").min(1, "Minimal 1 peserta dewasa (angka 0 atau negatif ditolak).").max(200, "Maksimal 200 peserta dewasa per reservasi rombongan."),
	jumlahAnak: numberType().int("Jumlah anak harus berupa bilangan bulat.").min(0, "Jumlah anak tidak boleh bernilai negatif.").max(200, "Maksimal 200 peserta anak per reservasi.").default(0),
	opsiKunjungan: stringType().trim().min(2, "Opsi kunjungan wajib dipilih.").max(150, "Opsi kunjungan maksimal 150 karakter.").default("Paket Wisata Full Day"),
	selectedAddons: arrayType(stringType().trim().max(100)).max(20, "Maksimal 20 aktivitas tambahan.").optional().default([]),
...
var reservationStatusSchema = objectType({
	...
	status: enumType([
		...
		"completed",
		"cancelled"
	], { errorMap: () => ({ message: "Status reservasi harus: pending, confirmed, completed, atau cancelled." }) })
});
...
//#endregion
export { paketWisataSchema as A, teko_kayangan_default as B, kegiatan_batik_2_default as C, officialFullDayPackage as D, loginInputSchema as E, reog_kendang_kempul_default as F, umkmSchema as H, reservationPublicSchema as I, reservationStatusSchema as L, publicReviewSchema as M, recordPageViewSchema as N, officialTwoDayPackage as O, rengginang_sajian_default as P, reviewStatusSchema as R, kegiatanSchema as S, klasifikasiInfo as T, villageInfoSchema as U, tokenOnlySchema as V, villages as W, galeriDataset as _, YOUTUBE_OFFICIAL_URL as a, homestaySchema as b, cbtExperiences8 as c, destinasiSchema as d, ekang_mangrove_dermaga_default as f, galeri8Categories as g, fasilitasMaster as h, YOUTUBE_OFFICIAL_ID as i, provinsiList as j, paketList as k, changePasswordInputSchema as l, faqSchema as m, RUMAH_BATIK_URL as n, adminReviewSchema as o, extractOgImageSchema as p, WHATSAPP_NUMBER as r, berita as s, DEFAULT_VILLAGE_COORDINATES as t, deleteItemSchema as u, galeriSchema as v, kegiatan_batik_3_default as w, imageUploadSchema as x, getVillage as y, statistik as z };
