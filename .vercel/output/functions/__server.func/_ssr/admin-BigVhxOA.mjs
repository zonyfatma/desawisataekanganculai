...
import {
  A as deleteUmkmServerFn,
  B as saveVillageInfoServerFn,
  C as checkDefaultPasswordServerFn,
  D as deleteKegiatanServerFn,
  E as deleteGaleriServerFn,
  F as saveDestinasiServerFn,
  H as updateReservationStatusServerFn,
  I as saveGaleriServerFn,
  L as saveKegiatanServerFn,
  M as getAdminDashboardDataServerFn,
  N as getSiteDataServerFn,
  O as deleteReservationServerFn,
  P as migrateBase64ServerFn,
  R as saveReviewServerFn,
  S as checkAdminAuthServerFn,
  T as deleteDestinasiServerFn,
  U as uploadImageServerFn,
  W as useSiteData,
  _ as DialogHeader,
  b as adminLogoutServerFn,
  d as logo_bintan_default,
  g as DialogFooter,
  j as extractOgImageServerFn,
  k as deleteReviewServerFn,
  m as DialogContent,
  p as Dialog,
  v as DialogTitle,
  w as cmsStore,
  x as changePasswordServerFn,
  y as adminLoginServerFn,
  z as saveUmkmServerFn,
...
function PaginationControls({ currentPage, totalPages, totalItems, pageSize, onPageChange }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    className:
      "mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-border pt-4 text-xs font-semibold text-muted-foreground",
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
            ...
            className:
              "inline-flex items-center gap-1 rounded-xl border border-border bg-card px-3 py-1.5 text-xs font-bold text-foreground hover:bg-accent disabled:opacity-40 disabled:cursor-not-allowed transition-colors cursor-pointer",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, { className: "size-3.5" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Sebelumnya" }),
            ],
          }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
            ...
            className:
              "inline-flex items-center gap-1 rounded-xl border border-border bg-card px-3 py-1.5 text-xs font-bold text-foreground hover:bg-accent disabled:opacity-40 disabled:cursor-not-allowed transition-colors cursor-pointer",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Berikutnya" }),
...
function AdminDashboardPage() {
  ...
  const checkDefaultPasswordStatus = (0, import_react.useCallback)(async () => {
    try {
      if ((await checkDefaultPasswordServerFn()).isDefaultPassword)
  ...
  const [infoForm, setInfoForm] = (0, import_react.useState)(
    () =>
      villageInfo || {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
            children: "Memuat Panel Pengelola...",
          }),
        ],
      }),
    });
  ...
  const handleExtractOgImage = async () => {
    ...
    try {
      const token = getToken();
      const res = await extractOgImageServerFn({
        data: {
          token,
          url: sourceUrl,
        },
  ...
  const handleUpdateReservationStatus = async (id, status) => {
    try {
      ...
      const token = getToken();
      await updateReservationStatusServerFn({
        data: {
          token,
          id,
          status,
  ...
  const handleDeleteReservation = (id, code) => {
    setDeleteConfirm({
      ...
      onConfirm: async () => {
        ...
        try {
          const token = getToken();
          await deleteReservationServerFn({
            data: {
              token,
              id,
            },
  ...
  const handleExportJSON = () => {
    ...
    downloadAnchor.setAttribute(
      "download",
      `backup-ekang-anculai-${/* @__PURE__ */ new Date().toISOString().slice(0, 10)}.json`,
    );
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "mx-auto grid size-16 place-items-center rounded-2xl bg-primary/10 text-primary",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "rounded-2xl bg-amber-500/10 border border-amber-500/30 p-3.5 mt-5 text-center text-xs text-amber-900 dark:text-amber-200",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                className:
                  "font-extrabold block uppercase tracking-wider text-[10px] text-amber-700 dark:text-amber-300",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                    ...
                    className:
                      "w-full rounded-2xl border border-border bg-surface px-4 py-3.5 text-sm font-semibold text-foreground focus:outline-none focus:ring-2 focus:ring-primary",
                    autoFocus: true,
                  }),
                ],
              }),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                        ...
                        className:
                          "w-full rounded-2xl border border-border bg-surface pl-4 pr-12 py-3.5 text-sm font-semibold text-foreground focus:outline-none focus:ring-2 focus:ring-primary",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        type: "button",
                        onClick: () => setShowPassword((prev) => !prev),
                        className:
                          "absolute right-3.5 top-1/2 -translate-y-1/2 p-1 text-muted-foreground hover:text-foreground transition-colors cursor-pointer rounded-lg hover:bg-black/5 dark:hover:bg-white/5",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                ...
                className:
                  "w-full rounded-2xl bg-primary py-4 text-xs font-extrabold text-primary-foreground shadow-card hover:bg-primary/90 transition-all cursor-pointer disabled:opacity-50",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
              to: "/",
              className:
                "inline-flex items-center gap-1 text-xs font-extrabold text-primary hover:underline",
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                children: "← Kembali ke Website Publik Desa",
              }),
            }),
          }),
        ],
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          className:
                            "rounded-full bg-emerald-500/15 px-2.5 py-0.5 text-[10px] font-black text-emerald-700 dark:text-emerald-300 border border-emerald-500/30",
                          children: "ONLINE",
                        }),
                      ],
                    }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                  ...
                  className:
                    "inline-flex items-center gap-1.5 rounded-full border border-amber-500/40 bg-amber-500/10 px-4 py-2 text-xs font-extrabold text-amber-700 dark:text-amber-300 hover:bg-amber-500/20 transition-all cursor-pointer",
                  children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                  ...
                  target: "_blank",
                  className:
                    "inline-flex items-center gap-1.5 rounded-full border border-border bg-surface px-4 py-2 text-xs font-extrabold text-foreground hover:bg-card transition-all",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, {
                      className: "size-3.5 text-primary",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                      children: "Pratinjau Live Website",
                    }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                  ...
                  className:
                    "inline-flex items-center gap-1.5 rounded-full border border-rose-500/30 bg-rose-500/10 px-4 py-2 text-xs font-extrabold text-rose-700 dark:text-rose-300 hover:bg-rose-500/20 transition-all cursor-pointer",
                  children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                  ...
                  className:
                    "inline-flex items-center gap-1.5 rounded-full bg-surface border border-border px-4 py-2 text-xs font-extrabold text-muted-foreground hover:text-foreground cursor-pointer",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, { className: "size-3.5" }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Keluar" }),
                  ],
                }),
              ],
            }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          isDefaultPasswordWarning &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-3xl border border-rose-500/40 bg-rose-500/10 p-5 text-rose-900 dark:text-rose-200",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className: "flex items-center gap-3",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className:
                        "grid size-10 shrink-0 place-items-center rounded-full bg-rose-500/20 text-rose-600",
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                          ...
                          children:
                            "Akun pengelola masih menggunakan kata sandi bawaan pertama ('admin123'). Harap ubah kata sandi demi keamanan server.",
                        }),
                      ],
                    }),
                  ],
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                  onClick: () => setIsPasswordModalOpen(true),
                  className:
                    "inline-flex items-center gap-2 rounded-full bg-rose-600 px-5 py-2 text-xs font-extrabold text-white hover:bg-rose-700 transition-all shadow-md shrink-0 cursor-pointer",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, { className: "size-3.5" }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                      children: "Ubah Kata Sandi Sekarang",
                    }),
                  ],
                }),
              ],
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        ...
                        className:
                          "grid size-6 place-items-center rounded-lg bg-surface text-muted-foreground hover:text-rose-600 transition-colors cursor-pointer",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                    className:
                      "mt-2 text-2xl sm:text-3xl font-black text-emerald-700 dark:text-emerald-400",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "mt-6 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-border bg-card p-4 shadow-soft",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className: "flex items-center gap-2",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, {
                    className: "size-4 text-[#C58A32]",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                    ...
                    className:
                      "inline-flex items-center gap-1.5 rounded-full bg-[#14532D] px-3.5 py-1.5 text-xs font-extrabold text-white hover:bg-[#064E3B] transition-all cursor-pointer shadow-sm",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "size-3.5" }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        children: "Kegiatan / Berita",
                      }),
                    ],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                    ...
                    className:
                      "inline-flex items-center gap-1.5 rounded-full bg-[#C58A32] px-3.5 py-1.5 text-xs font-extrabold text-white hover:bg-[#A87226] transition-all cursor-pointer shadow-sm",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Camera, {
                        className: "size-3.5 text-white",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        children: "Upload Foto Galeri",
                      }),
                    ],
                  }),
                ],
          ...
          activeTab === "reservasi" &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "flex flex-col gap-4 rounded-3xl border border-border bg-card p-6 shadow-soft",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  children: "Kelola Reservasi Wisatawan",
                                }),
                              ],
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                              ...
                              children:
                                "Seluruh pemesanan wisatawan tersimpan otomatis di database dengan Kode Reservasi Unik (misal EA-2026-E992).",
                            }),
                          ],
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              ...
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, {
                                  className:
                                    "absolute left-3 top-1/2 -translate-y-1/2 size-3.5 text-muted-foreground",
                                }),
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                                  type: "text",
                                  value: searchQuery,
                                  ...
                                  className:
                                    "w-full rounded-2xl border border-border bg-surface pl-9 pr-3 py-1.5 text-xs font-semibold text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20",
                                }),
                                searchQuery &&
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                                    type: "button",
                                    ...
                                    className:
                                      "absolute right-2.5 top-1/2 -translate-y-1/2 text-xs text-muted-foreground hover:text-foreground font-bold",
                                    children: "✕",
                                  }),
                              ],
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              ...
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  className:
                                    "text-xs font-extrabold text-muted-foreground uppercase",
                                  children: "Status:",
                                }),
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
                                  ...
                                  className:
                                    "rounded-2xl border border-border bg-surface px-4 py-2 text-xs font-extrabold text-foreground outline-none focus:ring-2 focus:ring-primary/20",
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", {
                                      value: "all",
                                      children: ["Semua Status (", reservationsList.length, ")"],
                                    }),
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", {
                                      value: "pending",
                                      children: [
                                        "⏳ Menunggu (",
                                        reservationsList.filter((r) => r.status === "pending")
                                          .length,
                                        ")",
                                      ],
                                    }),
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", {
                                      ...
                                      children: [
                                        "✓ Terkonfirmasi (",
                                        reservationsList.filter((r) => r.status === "confirmed")
                                          .length,
                                        ")",
                                      ],
                                    }),
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", {
                                      ...
                                      children: [
                                        "🎉 Selesai (",
                                        reservationsList.filter((r) => r.status === "completed")
                                          .length,
                                        ")",
                                      ],
                                    }),
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                          ...
                          children: ["Semua (", reservationsList.length, ")"],
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                          type: "button",
                ...
                (() => {
                  ...
                  if (filtered.length === 0)
                    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "rounded-3xl border border-dashed border-border p-12 text-center bg-card",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, {
                          className: "mx-auto size-12 text-muted-foreground/40 mb-3",
                        }),
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                          ...
                          children:
                            "Reservasi yang dikirim oleh pengunjung melalui modul Perencana Kunjungan akan otomatis muncul di sini.",
                        }),
                      ],
                    });
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        children: paginatedReservations.map((res) => {
                          ...
                          const statusBanner = isConfirmed
                            ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                className:
                                  "mb-3 rounded-xl bg-emerald-500/15 border border-emerald-500/30 px-3 py-1.5 text-[11px] font-bold text-emerald-800 dark:text-emerald-300 flex items-center gap-1.5",
                                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  children: "✓ Reservasi disetujui & jadwal terkonfirmasi.",
                                }),
                              })
                            : isCompleted
                              ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                  className:
                                    "mb-3 rounded-xl bg-sky-500/15 border border-sky-500/30 px-3 py-1.5 text-[11px] font-bold text-sky-800 dark:text-sky-300 flex items-center gap-1.5",
                                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                    children: "🎉 Kunjungan wisata telah selesai dilaksanakan.",
                                  }),
                                })
                              : isCancelled
                                ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                    className:
                                      "mb-3 rounded-xl bg-rose-500/15 border border-rose-500/30 px-3 py-1.5 text-[11px] font-bold text-rose-800 dark:text-rose-300 flex items-center gap-1.5",
                                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                      children: "✕ Reservasi ini telah dibatalkan.",
                                    }),
                                  })
                                : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                    className:
                                      "mb-3 rounded-xl bg-amber-500/15 border border-amber-500/30 px-3 py-1.5 text-[11px] font-bold text-amber-800 dark:text-amber-300 flex items-center gap-1.5",
                                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                      children: "⏳ Menunggu verifikasi & follow-up Admin.",
                                    }),
                                  });
                              ...
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                      className:
                                        "flex items-center justify-between gap-2 border-b border-border pb-3 mb-3",
                                      children: [
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                          className:
                                            "font-mono text-sm font-black text-primary tracking-widest",
                                    ...
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                      ...
                                      children: [
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                          className:
                                            "flex justify-between py-1 border-b border-border/40",
                                          children: [
                                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                        ...
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                          ...
                                          children: [
                                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                              className:
                                                "text-[11px] font-extrabold text-muted-foreground uppercase",
                                        ...
                                        res.catatan &&
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                            className:
                                              "mt-2 text-[11px] bg-muted/50 rounded-xl p-2.5 font-medium italic text-muted-foreground",
                                            children: ['"', res.catatan, '"'],
                                          }),
                                      ],
                                    }),
                                  ],
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                  className:
                                    "mt-5 pt-3 border-t border-border flex flex-col gap-2.5",
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                                      ...
                                      className:
                                        "w-full inline-flex items-center justify-center gap-1.5 rounded-2xl bg-emerald-600 px-3 py-2.5 text-xs font-extrabold text-white hover:bg-emerald-700 transition-colors shadow-soft",
                                      children: [
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, {
                                          className: "size-3.5",
                                        }),
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                          children: "Hubungi Wisatawan via WA",
                                        }),
                                      ],
                                    }),
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                      ...
                                      children: [
                                        isPending &&
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                            ...
                                            children: [
                                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                                className:
                                                  "text-[10px] uppercase font-black text-muted-foreground",
                                                ...
                                                children: [
                                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                                    "button",
                                                    {
                                                      ...
                                                      className:
                                                        "inline-flex items-center justify-center gap-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white px-3 py-2 text-xs font-extrabold shadow-sm transition-all cursor-pointer",
                                                      children: [
                                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                                          CircleCheck,
                                                          { className: "size-3.5" },
                                                  ...
                                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                                    "button",
                                                    {
                                                      ...
                                                      className:
                                                        "inline-flex items-center justify-center gap-1.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-700 dark:text-rose-300 border border-rose-500/30 px-3 py-2 text-xs font-extrabold transition-all cursor-pointer",
                                                      children: /* @__PURE__ */ (0,
                                        ...
                                        isConfirmed &&
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                            ...
                                            children: [
                                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                                className:
                                                  "text-[10px] uppercase font-black text-emerald-700 dark:text-emerald-300",
                                                ...
                                                children: [
                                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                                    "button",
                                                    {
                                                      ...
                                                      className:
                                                        "inline-flex items-center justify-center gap-1.5 rounded-xl bg-sky-600 hover:bg-sky-700 text-white px-3 py-2 text-xs font-extrabold shadow-sm transition-all cursor-pointer",
                                                      children: [
                                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                                          Sparkles,
                                        ...
                                        isCompleted &&
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                            className:
                                              "rounded-xl bg-sky-500/10 border border-sky-500/30 p-2.5 text-center",
                                            children: [
                                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                                                className:
                                                  "text-xs font-extrabold text-sky-800 dark:text-sky-300 flex items-center justify-center gap-1.5",
                                                children: [
                                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                                    CircleCheck,
                                                  ...
                                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                                    "span",
                                                    { children: "Status Final: Kunjungan Selesai" },
                                                  ),
                                                ],
                                              }),
                                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                        ...
                                        isCancelled &&
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                            className:
                                              "rounded-xl bg-rose-500/10 border border-rose-500/30 p-2.5 text-center",
                                            children: [
                                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                                                className:
                                                  "text-xs font-extrabold text-rose-800 dark:text-rose-300 flex items-center justify-center gap-1.5",
                                                children: [
                                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                                    "span",
                                                    {
                                                      className:
                                                        "size-3.5 rounded-full bg-rose-600 text-white grid place-items-center text-[9px] font-black",
                                                      children: "✕",
                                                    },
                                                  ),
                                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                                    ...
                                                    {
                                                      children:
                                                        "Status Final: Reservasi Dibatalkan",
                                                    },
                                                  ),
                                                ],
                                              }),
                                        ...
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                          ...
                                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                            "button",
                                            {
                                              ...
                                              className:
                                                "inline-flex items-center gap-1 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 px-2.5 py-1 text-[10px] font-bold text-rose-600 transition-colors cursor-pointer",
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                          ...
                          children:
                            "Ubah nomor WhatsApp reservasi, email resmi, alamat, dan link media sosial Pengelola.",
                        }),
                      ],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                      ...
                      className:
                        "inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-xs font-extrabold text-primary-foreground shadow-card hover:bg-primary/90 transition-all cursor-pointer",
                      children: [
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                          ...
                          className:
                            "w-full rounded-2xl border border-border bg-surface px-4 py-3 text-xs sm:text-sm font-bold text-foreground",
                        }),
                      ],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                        type: "submit",
                        className:
                          "inline-flex items-center gap-2 rounded-full bg-primary px-8 py-3.5 text-xs font-extrabold text-primary-foreground shadow-card hover:bg-primary/90 transition-all cursor-pointer",
                        children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                      ...
                      onClick: () => {
                        setEditingKegiatan({
                          ...
                          source: {
                            name: "Pemerintah Desa Ekang Anculai",
                            url:
                              villageInfo?.pemdesWebsite ||
                              "https://desaekanganculai.bintankab.go.id/",
                            publishedAt: /* @__PURE__ */ new Date().toISOString().slice(0, 10),
                          },
                        });
                        setIsKegiatanModalOpen(true);
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  ...
                  children: kegiatanList.map((kg) =>
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "div",
                      {
                        className:
                          "rounded-3xl border border-border bg-card shadow-card flex flex-col justify-between overflow-hidden group",
                        children: [
                          kg.image &&
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              className:
                                "relative aspect-[16/9] w-full overflow-hidden bg-muted border-b border-border",
                              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
                                src: kg.image,
                                alt: kg.judul,
                                className:
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                                ...
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                    ...
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                        className:
                                          "rounded-full bg-primary/10 px-3 py-1 text-[10px] font-extrabold text-primary",
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
                                    className:
                                      "mt-3 text-base font-extrabold text-foreground leading-snug",
                                    children: kg.judul,
                                  }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                    className:
                                      "mt-2 text-xs text-muted-foreground leading-relaxed line-clamp-3",
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                className:
                                  "pt-3 border-t border-border flex items-center justify-between",
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                                    onClick: () => {
                                    ...
                                    className:
                                      "inline-flex items-center gap-1 text-xs font-extrabold text-primary hover:underline cursor-pointer",
                                    children: [
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                                    ...
                                    className:
                                      "inline-flex items-center gap-1 text-xs font-extrabold text-rose-600 hover:underline cursor-pointer",
                                    children: [
                                ...
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                    ...
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                        className:
                                          "rounded-full bg-gold/15 px-3 py-1 text-[10px] font-extrabold text-gold uppercase",
                                ...
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                    ...
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                        className:
                                          "rounded-full bg-emerald-500/10 px-3 py-1 text-[10px] font-extrabold text-emerald-700 dark:text-emerald-300",
                  ...
                  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        children: paginatedReviews.map((rev) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            "div",
                            {
                              className:
                                "rounded-3xl border border-border bg-card p-6 shadow-card flex flex-col justify-between",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                      ...
                                      children: [
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                          ...
                                          children: Array.from({ length: rev.rating }).map((_, i) =>
                                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                              Star,
                                    ...
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                      ...
                                      children: [rev.asal, " • ", rev.tipeWisatawan],
                                    }),
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                                      className:
                                        "mt-2 text-xs text-muted-foreground leading-relaxed italic line-clamp-4",
          ...
          activeTab === "backup" &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-card space-y-6",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                        className: "text-xs text-muted-foreground font-medium mt-1",
                        children:
                          "Kelola cadangan database JSON dan konversi otomatis file foto Base64 lama ke file fisik WebP.",
                      }),
                    ],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                className:
                                  "grid size-10 place-items-center rounded-full bg-sky-500/10 text-sky-600",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                                ...
                                className:
                                  "inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-xs font-extrabold text-primary-foreground shadow-card hover:bg-primary/90 transition-all cursor-pointer",
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Download, {
                                    className: "size-4",
                                  }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                    children: "Unduh Backup JSON",
                                  }),
                                ],
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
                                className:
                                  "inline-flex items-center gap-2 rounded-full border border-border bg-card px-5 py-2.5 text-xs font-extrabold text-foreground hover:bg-accent cursor-pointer",
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Upload, {
                                    className: "size-4 text-primary",
                                  }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                    children: "Impor Data JSON",
                                  }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                                    type: "file",
                                    accept: ".json",
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-5 space-y-4",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className: "flex items-center gap-3",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                className:
                                  "grid size-10 place-items-center rounded-full bg-emerald-500/20 text-emerald-600",
                                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, {
                                  className: "size-5",
                                }),
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                children: [
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                    className: "text-xs text-muted-foreground",
                                    children:
                                      "Konversi otomatis semua foto Base64 di database SQLite menjadi file fisik WebP di folder `/public/uploads/`.",
                                  }),
                                ],
                              }),
                            ],
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            ...
                            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                              ...
                              className:
                                "inline-flex items-center gap-2 rounded-full bg-emerald-600 px-5 py-2.5 text-xs font-extrabold text-white shadow-card hover:bg-emerald-700 transition-all cursor-pointer",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RotateCcw, {
                                  className: "size-4",
                                }),
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  children: "Jalankan Migrasi Base64 ke WebP File",
                                }),
                              ],
                            }),
                          }),
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                          className: "text-xs font-semibold text-muted-foreground",
                          children:
                            "Kelola foto dokumentasi ekowisata, batik, perkebunan, budaya, dan aktivitas masyarakat.",
                        }),
                      ],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                      ...
                      className:
                        "inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-xs font-extrabold text-primary-foreground shadow-card hover:bg-primary/90 transition-all cursor-pointer shrink-0",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "size-4" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          children: "Tambah Foto Galeri Baru",
                        }),
                      ],
                    }),
                  ],
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                      ...
                      onChange: (e) => setSearchQuery(e.target.value),
                      className:
                        "w-full rounded-full border border-border bg-card px-4 py-2.5 pl-10 text-xs font-semibold text-foreground focus:outline-none focus:ring-2 focus:ring-primary",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, {
                ...
                (() => {
                  ...
                  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-3",
                        children: paginatedGaleri.map((item) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            "div",
                            {
                              className:
                                "flex flex-col justify-between overflow-hidden rounded-3xl border border-border bg-card shadow-card group",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                  className:
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                      className:
                                        "absolute top-3 left-3 rounded-full bg-background/90 px-3 py-1 text-[11px] font-extrabold text-foreground backdrop-blur shadow-sm",
                                  ...
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                      children: [
                                        ...
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                          className:
                                            "mt-1.5 text-xs text-muted-foreground font-medium line-clamp-2",
                                          children: item.caption,
                                        }),
                                        item.sumber &&
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                            className:
                                              "mt-2 block text-[10px] font-bold text-primary",
          ...
          activeTab === "backup" &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "mt-8 rounded-3xl border border-border bg-card p-8 shadow-card max-w-2xl mx-auto text-center space-y-6",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Download, {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                      ...
                      children:
                        "Unduh file cadangan data website (JSON) untuk mengamankan seluruh informasi kegiatan, landmark, UMKM, galeri, ulasan, dan kontak yang telah diedit.",
                    }),
                  ],
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          children: "Unduh Backup Data (JSON)",
                        }),
                      ],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
                      className:
                        "inline-flex items-center gap-2 rounded-full border border-border bg-surface px-8 py-3.5 text-xs font-extrabold text-foreground hover:bg-card transition-all cursor-pointer",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Upload, {
                          className: "size-4 text-primary",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          children: "Pulihkan dari File JSON",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                          type: "file",
                          accept: ".json",
      ...
      isKegiatanModalOpen &&
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
            className:
              "max-w-lg overflow-hidden rounded-3xl p-6 sm:p-8 bg-card border-border shadow-2xl max-h-[90vh] overflow-y-auto",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
                  className: "text-xl font-extrabold text-foreground",
                  children: editingKegiatan.id.startsWith("kg-")
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                        ...
                        className:
                          "w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground",
                      }),
                    ],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
                        ...
                        className:
                          "w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-medium text-foreground",
                      }),
                    ],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "grid grid-cols-2 gap-3 p-3 rounded-2xl border border-border bg-surface/50",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                            ...
                            className:
                              "w-full rounded-xl border border-border bg-card px-3 py-2 text-xs font-semibold text-foreground",
                          }),
                        ],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
                            className:
                              "flex items-center gap-2 text-xs font-bold text-foreground cursor-pointer",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                                type: "radio",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                children: "🌐 Ambil dari Source URL (Publikasi Berita)",
                              }),
                            ],
                          }),
                        ],
                      ...
                      (editingKegiatan.image_source || "upload") === "upload"
                        ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
                                className:
                                  "flex items-center justify-center gap-2 rounded-2xl border border-dashed border-primary/40 bg-primary/5 px-4 py-2.5 text-xs font-bold text-primary hover:bg-primary/10 transition-all cursor-pointer",
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Upload, {
                                    className: "size-4",
                                  }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                    children: "Upload Foto dari HP / Laptop",
                                  }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                                    type: "file",
                                    accept: "image/*",
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                                ...
                                className:
                                  "w-full rounded-2xl border border-border bg-card px-4 py-2 text-xs font-medium text-foreground",
                              }),
                            ],
                          })
                        : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                                ...
                                children:
                                  "Sistem server akan mengambil foto utama (Open Graph image) langsung dari URL publikasi berita resmi tanpa melakukan download berlebih.",
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                ...
                                children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                                  ...
                                  className:
                                    "inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-xs font-extrabold text-primary-foreground shadow-sm hover:bg-primary/90 transition-all disabled:opacity-50 cursor-pointer",
                                  children: [
                                    isExtractingOg
                                    ...
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                      children: editingKegiatan.image
                      ...
                      editingKegiatan.image &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          className:
                            "mt-3 relative aspect-video w-full overflow-hidden rounded-2xl border border-border bg-muted",
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              className:
                                "absolute bottom-2 left-2 rounded-md bg-black/75 backdrop-blur-sm px-2.5 py-1 text-[10px] font-bold text-white shadow-sm",
                              children:
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogFooter, {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        ...
                        className:
                          "rounded-full bg-surface px-5 py-2.5 text-xs font-bold text-muted-foreground hover:text-foreground cursor-pointer",
                        children: "Batal",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        type: "submit",
                        className:
                          "rounded-full bg-primary px-6 py-2.5 text-xs font-extrabold text-primary-foreground shadow-card cursor-pointer",
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                children: "Upload Foto dari Perangkat (HP / Laptop)",
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                                type: "file",
                                accept: "image/*",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                            ...
                            className:
                              "w-full rounded-2xl border border-border bg-surface px-4 py-2 text-xs font-medium text-foreground",
                          }),
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
                  className: "text-xl font-extrabold text-foreground",
                  children: galeriList.some((g) => g.id === editingGaleri.id)
                    ? "Edit Foto Galeri"
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
                            className:
                              "flex flex-col items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-primary/40 bg-primary/5 p-4 text-center text-xs font-bold text-primary hover:bg-primary/10 hover:border-primary transition-all cursor-pointer",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                className:
                                  "grid size-10 place-items-center rounded-full bg-primary/10 text-primary",
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                children: [
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                    className:
                                      "block text-[11px] text-muted-foreground font-medium mt-0.5",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                                ...
                                className:
                                  "w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-medium text-foreground text-xs",
                              }),
                            ],
                          }),
                          editingGaleri.image &&
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              className:
                                "relative aspect-[16/9] w-full overflow-hidden rounded-2xl border border-border bg-muted",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                  ...
                                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                                    ...
                                    className:
                                      "rounded-full bg-rose-600/90 px-3 py-1 text-[11px] font-extrabold text-white backdrop-blur hover:bg-rose-700 shadow-md cursor-pointer",
                                    children: "Hapus Foto",
                                  }),
                                }),
                              ],
      ...
      isPasswordModalOpen &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
            className:
              "max-w-md overflow-hidden rounded-3xl p-6 sm:p-8 bg-card border-border shadow-2xl",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
                ...
                children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                            ...
                            className:
                              "w-full rounded-2xl border border-border bg-surface pl-4 pr-12 py-3 font-medium text-foreground outline-none focus:ring-2 focus:ring-primary/20",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                            type: "button",
                            ...
                            className:
                              "absolute right-3.5 top-1/2 -translate-y-1/2 p-1 text-muted-foreground hover:text-foreground transition-colors cursor-pointer rounded-lg hover:bg-black/5 dark:hover:bg-white/5",
                            title: showOldPassword
                              ? "Sembunyikan Kata Sandi"
                              : "Tampilkan Kata Sandi",
                            children: showOldPassword
                              ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EyeOff, {
                                  className: "size-4",
                                })
                              : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    className:
                      "rounded-2xl bg-amber-500/10 p-3 text-[11px] font-semibold text-amber-800 dark:text-amber-300",
                    children:
                      "Gunakan kombinasi huruf besar, huruf kecil, dan angka untuk kata sandi yang lebih aman.",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogFooter, {
                    className: "pt-4 border-t border-border flex justify-end gap-2",
                    children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className:
                        "grid size-10 place-items-center rounded-2xl bg-rose-500/15 border border-rose-500/30 shrink-0",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogFooter, {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                    ...
                    className:
                      "rounded-full bg-surface px-5 py-2.5 text-xs font-extrabold text-muted-foreground hover:text-foreground border border-border cursor-pointer transition-colors",
                    children: "Batal",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                    type: "button",
                    ...
                    className:
                      "inline-flex items-center gap-2 rounded-full bg-rose-600 px-6 py-2.5 text-xs font-black text-white hover:bg-rose-700 shadow-md transition-all cursor-pointer disabled:opacity-50",
                    children: isDeleting
