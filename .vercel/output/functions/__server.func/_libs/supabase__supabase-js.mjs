...
var fetchWithAuth = (
  ...
  const allowKeyAsBearer = !(
    (options === null || options === void 0 ? void 0 : options.omitApiKeyAsBearer) &&
    isNewApiKey(supabaseKey)
  );
  return async (input, init) => {
    ...
    if (!headers.has("Authorization")) {
      const bearer =
        realToken !== null && realToken !== void 0
          ? realToken
          : allowKeyAsBearer
            ? supabaseKey
            : null;
...
var SupabaseClient = class {
  ...
  async _getAccessToken() {
    ...
    return (_await$this$_getSessi = await _this2._getSessionToken()) !== null &&
