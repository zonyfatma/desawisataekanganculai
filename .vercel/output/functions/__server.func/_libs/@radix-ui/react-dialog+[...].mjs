...
var DismissableLayer = /* @__PURE__ */ import_react.forwardRef(
  /* @__PURE__ */ __name$4(function DismissableLayer2(props, forwardedRef) {
    const {
...
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  return {
    onPointerDownCapture: /* @__PURE__ */ __name$4(
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis?.document) {
  ...
  return {
    onFocusCapture: /* @__PURE__ */ __name$4(
      () => (isFocusInsideReactTreeRef.current = true),
      "onFocusCapture",
    ),
    onBlurCapture: /* @__PURE__ */ __name$4(
...
var FocusScope = /* @__PURE__ */ import_react.forwardRef(
  /* @__PURE__ */ __name$3(function FocusScope2(props, forwardedRef) {
    const {
      loop = false,
      trapped = false,
...
function getTabbableCandidates(container) {
  ...
  const walker = document.createTreeWalker(container, NodeFilter.SHOW_ELEMENT, {
    acceptNode: /* @__PURE__ */ __name$3((node) => {
...
var Portal = /* @__PURE__ */ import_react.forwardRef(
  /* @__PURE__ */ __name$2(function Portal2(props, forwardedRef) {
