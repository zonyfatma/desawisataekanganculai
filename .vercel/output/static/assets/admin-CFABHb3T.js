...
import { t as xe } from "./link-C7I64epB.js";
import { b as Se } from "./utils-Ctb90B5i.js";
import { D as f, i as Ce } from "./jadesta-DqHZHQ8d.js";
import { n as p, r as we, t as Te } from "./star-4pykxryJ.js";
import { t as Ee } from "./search-DVU4GdGK.js";
import {
  C as De,
  I as Oe,
  L as ke,
...
var h = f(`download`, [
  ...
  ze = f(`loader-circle`, [[`path`, { d: `M21 12a9 9 0 1 1-6.219-8.56`, key: `13zald` }]]),
  Be = f(`lock`, [
  ...
  y = t(e()),
  b = n();
function Ke({ currentPage: e, totalPages: t, totalItems: n, pageSize: r, onPageChange: i }) {
  if (t <= 1) return null;
  let a = (e - 1) * r + 1,
    o = Math.min(e * r, n),
    s = [];
  for (let e = 1; e <= t; e++) s.push(e);
  return (0, b.jsxs)(`div`, {
    ...
    children: [
      (0, b.jsxs)(`div`, {
        children: [
          `Menampilkan`,
          ` `,
          (0, b.jsxs)(`strong`, { className: `text-foreground`, children: [a, `–`, o] }),
          ` `,
          `dari `,
          (0, b.jsx)(`strong`, { className: `text-foreground`, children: n }),
          ` data (Halaman`,
          ` `,
          (0, b.jsx)(`strong`, { className: `text-foreground`, children: e }),
          ` dari `,
          t,
          `)`,
        ],
      ...
      (0, b.jsxs)(`div`, {
        ...
        children: [
          (0, b.jsxs)(`button`, {
            ...
            children: [
              (0, b.jsx)(Me, { className: `size-3.5` }),
              (0, b.jsx)(`span`, { children: `Sebelumnya` }),
            ],
          }),
          (0, b.jsx)(`div`, {
            ...
            children: s.map((t) =>
              (0, b.jsx)(
                `button`,
                {
                  type: `button`,
                  onClick: () => i(t),
                  className: `size-8 rounded-xl font-extrabold text-xs transition-colors cursor-pointer ${e === t ? `bg-primary text-primary-foreground shadow-soft` : `bg-surface text-foreground hover:bg-accent border border-border`}`,
                  children: t,
                },
                t,
              ),
          ...
          (0, b.jsxs)(`button`, {
            ...
            className: `inline-flex items-center gap-1 rounded-xl border border-border bg-card px-3 py-1.5 text-xs font-bold text-foreground hover:bg-accent disabled:opacity-40 disabled:cursor-not-allowed transition-colors cursor-pointer`,
            children: [
              (0, b.jsx)(`span`, { children: `Berikutnya` }),
              (0, b.jsx)(je, { className: `size-3.5` }),
            ],
          }),
        ],
      }),
...
function qe() {
  let e = fe(),
    ...
    [Ze, Qe] = (0, y.useState)(``),
    [$e, et] = (0, y.useState)(``),
    [tt, nt] = (0, y.useState)(!1),
    [C, w] = (0, y.useState)(`reservasi`),
    [T, rt] = (0, y.useState)([]),
    [E, D] = (0, y.useState)(`all`),
    [O, it] = (0, y.useState)(``),
    [at, ot] = (0, y.useState)(1),
    [st, ct] = (0, y.useState)(1),
    [lt, ut] = (0, y.useState)(1),
    [dt, ft] = (0, y.useState)(!1),
    [pt, k] = (0, y.useState)(!1),
    [mt, ht] = (0, y.useState)(``),
    [gt, _t] = (0, y.useState)(``),
    [vt, yt] = (0, y.useState)(!1),
    [bt, xt] = (0, y.useState)(!1),
    [St, Ct] = (0, y.useState)(!1);
  (0, y.useEffect)(() => {
    (ot(1), ct(1), ut(1));
  }, [O, E]);
  let wt = (0, y.useCallback)(async () => {
      try {
        (await ge()).isDefaultPassword ? ft(!0) : ft(!1);
      } catch {}
    }, []),
    A = async () => {
      try {
    ...
    j = (0, y.useCallback)(async () => {
      try {
        let [e, t] = await Promise.all([ce({ data: {} }), se()]);
        (e && e.reservations && rt(e.reservations), t && d.setSiteData(t), wt());
      } catch {}
    }, [wt]),
    Tt = async (e) => {
      e.preventDefault();
      try {
        (await ne({ data: { oldPassword: mt, newPassword: gt } }),
          m.success(`Kata sandi admin berhasil diperbarui!`),
          k(!1),
          ft(!1),
          ht(``),
          _t(``));
      } catch (e) {
        m.error(x(e, `Gagal mengubah kata sandi.`));
      }
    },
    [M, N] = (0, y.useState)(
      () =>
    ...
    [Et, I] = (0, y.useState)(!1),
    [Dt, Ot] = (0, y.useState)(!1),
    [kt, L] = (0, y.useState)(null),
    [R, z] = (0, y.useState)(null),
    [At, B] = (0, y.useState)(!1),
    [V, H] = (0, y.useState)(null),
    [jt, U] = (0, y.useState)(!1),
    [W, G] = (0, y.useState)(null),
    [Mt, K] = (0, y.useState)(!1),
    [q, J] = (0, y.useState)(null),
    [Nt, Y] = (0, y.useState)(!1),
    [X, Z] = (0, y.useState)({ isOpen: !1, title: ``, description: ``, onConfirm: async () => {} }),
    [Pt, Q] = (0, y.useState)(!1),
    [Ft, It] = (0, y.useState)(!1);
  if (
    ((0, y.useEffect)(() => {
      (It(!0),
        pe()
          .then((e) => {
            e.isAuthenticated ? (S(!0), j()) : S(!1);
          })
          .catch(() => {
            S(!1);
          }));
    ...
    return (0, b.jsx)(`div`, {
      ...
      children: (0, b.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, b.jsx)(`span`, { children: `Memuat Panel Pengelola...` }),
        ],
      }),
    });
  let Lt = async (e) => {
      (e.preventDefault(), et(``), nt(!0));
      let t = new FormData(e.currentTarget),
        n = String(t.get(`username`) || Ye).trim(),
        r = String(t.get(`password`) || Ze).trim();
      try {
        let e = await he({ data: { username: n, password: r } });
        if (e.success && e.user)
          (S(!0), m.success(`Login terautentikasi! Selamat datang ${e.user.username}.`), j());
        else {
          let t = e.message || `Username atau kata sandi tidak valid.`;
          (et(t), m.error(t));
        }
      } catch (e) {
        let t = x(e, `Gagal masuk. Terjadi kesalahan pada server.`);
        (typeof t == `string` &&
          (t.includes(`<!doctype html`) ||
            t.includes(`<html`) ||
            t.trim().startsWith(`<`) ||
            t.includes(`500`)) &&
          (t = `Gagal terhubung ke server otentikasi. Silakan coba beberapa saat lagi.`),
          et(t),
          m.error(t));
      } finally {
        nt(!1);
    ...
    Rt = async () => {
      try {
        ...
        (S(!1), m.info(`Anda telah keluar dari Panel Admin.`));
      }
    },
    $ = () => ``,
    zt = async (e) => {
      ...
      try {
        let e = $();
        (await r({ data: { token: e, info: M } }),
          m.success(`Informasi & Kontak Desa berhasil disimpan ke database!`),
          await A());
      } catch (e) {
        m.error(x(e, `Gagal menyimpan informasi desa.`));
      }
    },
    Bt = async () => {
      let e = P?.source?.url;
      if (!e || !e.trim()) {
        (m.error(`Silakan masukkan URL publikasi terlebih dahulu.`),
          L({ type: `error`, message: `URL publikasi wajib diisi terlebih dahulu.` }));
        return;
      }
      (Ot(!0), L(null), m.info(`Mengakses server & mengekstrak foto dari publikasi...`));
      try {
        let t = $(),
          n = await de({ data: { token: t, url: e } });
        if (n.success && n.imageUrl)
          (F((e) => (e ? { ...e, image: n.imageUrl, image_source: `source_url` } : null)),
            L({ type: `success`, message: `✓ Foto utama publikasi berhasil ditemukan!` }),
            m.success(`Foto utama publikasi berhasil diambil!`));
        else {
          let e = n.error || `Foto utama tidak ditemukan pada halaman tersebut.`;
          (L({ type: `error`, message: e }), m.error(e));
        }
      } catch (e) {
        let t = x(e, `Gagal mengambil foto dari URL publikasi.`);
        (L({ type: `error`, message: t }), m.error(t));
      } finally {
        Ot(!1);
      }
    },
    Vt = async (e) => {
      if ((e.preventDefault(), P))
        try {
          let e = $();
          (await re({ data: { token: e, item: P } }),
            I(!1),
            F(null),
            m.success(`Kegiatan desa berhasil disimpan ke database!`),
            await A());
        } catch (e) {
          m.error(x(e, `Gagal menyimpan kegiatan desa.`));
        }
    },
    Ht = (e, t) => {
      Z({
        isOpen: !0,
        title: t ? `Hapus Kegiatan "${t}"?` : `Hapus Kegiatan Ini?`,
        description: `Data kegiatan desa ini akan dihapus secara permanen dari database.`,
        onConfirm: async () => {
          Q(!0);
          try {
            let t = $();
            (await _e({ data: { token: t, id: e } }),
              m.success(`Kegiatan desa telah dihapus dari database.`),
              await A());
          } catch (e) {
            m.error(x(e, `Gagal menghapus kegiatan.`));
          } finally {
            (Q(!1), Z((e) => ({ ...e, isOpen: !1 })));
          }
        },
    ...
    Ut = async (e) => {
      if ((e.preventDefault(), R))
        try {
          let e = $();
          (await ve({ data: { token: e, item: R } }),
            B(!1),
            z(null),
            m.success(`Daya Tarik / Landmark berhasil disimpan ke database!`),
            await A());
        } catch (e) {
          m.error(x(e, `Gagal menyimpan landmark.`));
        }
    },
    Wt = (e, t) => {
      Z({
        isOpen: !0,
        title: t ? `Hapus Landmark "${t}"?` : `Hapus Landmark Ini?`,
        description: `Data landmark/destinasi ini akan dihapus secara permanen dari database.`,
        onConfirm: async () => {
          Q(!0);
          try {
            let t = $();
            (await ie({ data: { token: t, id: e } }),
              m.success(`Landmark telah dihapus dari database.`),
              await A());
          } catch (e) {
            m.error(x(e, `Gagal menghapus landmark.`));
          } finally {
            (Q(!1), Z((e) => ({ ...e, isOpen: !1 })));
          }
        },
    ...
    Gt = async (e) => {
      if ((e.preventDefault(), V))
        try {
          let e = $();
          (await ee({ data: { token: e, item: V } }),
            U(!1),
            H(null),
            m.success(`Produk UMKM berhasil disimpan ke database!`),
            await A());
        } catch (e) {
          m.error(x(e, `Gagal menyimpan produk UMKM.`));
        }
    },
    Kt = (e, t) => {
      Z({
        isOpen: !0,
        title: t ? `Hapus Produk UMKM "${t}"?` : `Hapus Produk UMKM Ini?`,
        description: `Data produk UMKM ini akan dihapus secara permanen dari database.`,
        onConfirm: async () => {
          Q(!0);
          try {
            let t = $();
            (await me({ data: { token: t, id: e } }),
              m.success(`Produk UMKM telah dihapus dari database.`),
              await A());
          } catch (e) {
            m.error(x(e, `Gagal menghapus UMKM.`));
          } finally {
            (Q(!1), Z((e) => ({ ...e, isOpen: !1 })));
          }
        },
    ...
    qt = async (e) => {
      if ((e.preventDefault(), W))
        try {
          let e = $();
          (await ye({ data: { token: e, item: W } }),
            K(!1),
            G(null),
            m.success(`Ulasan wisatawan berhasil disimpan ke database!`),
            await A());
        } catch (e) {
          m.error(x(e, `Gagal menyimpan ulasan.`));
        }
    },
    Jt = (e, t) => {
      Z({
        isOpen: !0,
        title: t ? `Hapus Ulasan dari "${t}"?` : `Hapus Ulasan Ini?`,
        description: `Ulasan wisatawan ini akan dihapus secara permanen dari database.`,
        onConfirm: async () => {
          Q(!0);
          try {
            let t = $();
            (await oe({ data: { token: t, id: e } }),
              m.success(`Ulasan telah dihapus dari database.`),
              await A());
          } catch (e) {
            m.error(x(e, `Gagal menghapus ulasan.`));
          } finally {
            (Q(!1), Z((e) => ({ ...e, isOpen: !1 })));
          }
        },
    ...
    Yt = async (e) => {
      if ((e.preventDefault(), q))
        try {
          let e = $();
          (await be({ data: { token: e, item: q } }),
            Y(!1),
            J(null),
            m.success(`Foto galeri berhasil disimpan ke database!`),
            await A());
        } catch (e) {
          m.error(x(e, `Gagal menyimpan foto galeri.`));
        }
    },
    Xt = (e, t) => {
      Z({
        isOpen: !0,
        title: t ? `Hapus Foto "${t}"?` : `Hapus Foto Galeri Ini?`,
        description: `Foto galeri ini akan dihapus secara permanen dari database.`,
        onConfirm: async () => {
          Q(!0);
          try {
            let t = $();
            (await ue({ data: { token: t, id: e } }),
              m.success(`Foto galeri telah dihapus dari database.`),
              await A());
          } catch (e) {
            m.error(x(e, `Gagal menghapus galeri.`));
          } finally {
            (Q(!1), Z((e) => ({ ...e, isOpen: !1 })));
          }
        },
    ...
    Zt = async (e, t) => {
      try {
        rt((n) => n.map((n) => (n.id === e ? { ...n, status: t } : n)));
        let n = $();
        (await a({ data: { token: n, id: e, status: t } }),
          m.success(
            `Status reservasi berhasil diubah: ${{ confirmed: `TERKONFIRMASI (Disetujui)`, completed: `SELESAI (Kunjungan Tuntas)`, cancelled: `DIBATALKAN`, pending: `MENUNGGU KONFIRMASI` }[t] || t.toUpperCase()}`,
          ),
          j());
      } catch (e) {
        (m.error(x(e, `Gagal memperbarui status reservasi.`)), j());
      }
    },
    Qt = (e, t) => {
      Z({
        isOpen: !0,
        title: t ? `Hapus Reservasi "${t}"?` : `Hapus Data Reservasi Ini?`,
        description: `Data reservasi pemesanan ini akan dihapus secara permanen dari database.`,
        onConfirm: async () => {
          Q(!0);
          try {
            let t = $();
            (await ae({ data: { token: t, id: e } }),
              m.success(`Data reservasi telah dihapus dari database.`),
              j());
          } catch (e) {
            m.error(x(e, `Gagal menghapus data reservasi.`));
          } finally {
            (Q(!1), Z((e) => ({ ...e, isOpen: !1 })));
          }
        },
    ...
    $t = () => {
      Z({
        ...
        onConfirm: async () => {
          Q(!0);
          try {
            (d.setSiteData({ ...d.getSnapshot() }),
              m.success(`Data berhasil di-reset ke setelan awal.`));
          } finally {
            (Q(!1), Z((e) => ({ ...e, isOpen: !1 })));
          }
        },
    ...
    en = () => {
      (F({
        ...
        source: {
          ...
          url: t?.pemdesWebsite || `https://desaekanganculai.bintankab.go.id/`,
    ...
    an = async (e, t, n) => {
      if (!e) return;
      if (e.size > 5242880) {
        m.error(`Ukuran file foto terlalu besar (maksimal 5MB).`);
        return;
      }
      if (![`image/jpeg`, `image/png`, `image/webp`, `image/jpg`].includes(e.type.toLowerCase())) {
        m.error(`Format file tidak diizinkan! Gunakan format JPG, PNG, atau WebP.`);
        return;
      }
      let r = m.loading(`Mengunggah & mengompresi foto ke WebP...`),
        a = new FileReader();
      ((a.onload = async (e) => {
        ...
        if (a)
          try {
            let e = $(),
              o = await i({ data: { token: e, category: t, base64Data: a } });
            o?.url
              ? (n(o.url), m.success(`Foto berhasil diunggah & dioptimasi ke WebP!`, { id: r }))
              : m.error(`Gagal mengunggah foto.`, { id: r });
          } catch (e) {
            m.error(x(e, `Gagal mengunggah foto ke server.`), { id: r });
          }
      }),
        a.readAsDataURL(e));
    },
    ...
    ln = (e) => {
      ...
      t &&
        an(t, `umkm`, (e) => {
          H((t) => (t ? { ...t, image: e } : null));
        });
    },
    un = () => {
      let t = `data:text/json;charset=utf-8,` + encodeURIComponent(JSON.stringify(e, null, 2)),
      ...
      (n.setAttribute(`href`, t),
        ...
        n.click(),
        n.remove(),
        m.success(`File cadangan JSON berhasil diunduh!`));
    },
    dn = (e) => {
      let t = e.target.files?.[0];
      if (!t) return;
      ...
      ((n.onload = (e) => {
        try {
          ...
          t.villageInfo && t.kegiatanList
            ? (d.updateData(() => t),
              m.success(`Data website berhasil dipulihkan dari file cadangan!`))
            : m.error(`Format file JSON tidak valid.`);
        } catch {
          m.error(`Gagal membaca file JSON.`);
        }
      }),
        n.readAsText(t));
    };
                ...
                (0, b.jsxs)(`div`, {
                  ...
                  children: [
                    (0, b.jsxs)(`button`, {
                      ...
                      children: [
                        (0, b.jsx)(Be, { className: `size-3.5` }),
                        (0, b.jsx)(`span`, { children: `Ubah Kata Sandi` }),
                      ],
                    }),
                    (0, b.jsxs)(xe, {
                      to: `/`,
                      ...
                      children: [
                        (0, b.jsx)(we, { className: `size-3.5 text-primary` }),
                        (0, b.jsx)(`span`, { children: `Pratinjau Live Website` }),
                        (0, b.jsx)(Se, { className: `size-3 text-muted-foreground` }),
                      ],
                    }),
                    (0, b.jsxs)(`button`, {
                      onClick: $t,
                      ...
                      children: [
                        (0, b.jsx)(He, { className: `size-3.5` }),
                        (0, b.jsx)(`span`, { children: `Reset Default` }),
                      ],
                    }),
                    (0, b.jsxs)(`button`, {
                      onClick: Rt,
            ...
            children: [
                ...
                (0, b.jsxs)(`div`, {
                  ...
                  children: [
                    (0, b.jsxs)(`div`, {
                      ...
                      children: [
                        (0, b.jsx)(`div`, {
                          ...
                          children: (0, b.jsx)(Le, { className: `size-6` }),
                        }),
                        (0, b.jsxs)(`div`, {
                          children: [
                            (0, b.jsx)(`h3`, {
                    ...
                    (0, b.jsxs)(`button`, {
                      ...
                      children: [
                        (0, b.jsx)(Be, { className: `size-3.5` }),
                        (0, b.jsx)(`span`, { children: `Ubah Kata Sandi Sekarang` }),
                      ],
                    }),
                  ],
                }),
                      ...
                      (0, b.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, b.jsx)(`button`, {
                            onClick: () => {
                              (d.resetVisitCount(),
                                m.success(`Hitungan kunjungan berhasil di-reset ke 0.`));
                            },
                    ...
                    children: [
                      (0, b.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, b.jsx)(Oe, { className: `size-5 text-sky-600` }),
                        ],
                      }),
                      (0, b.jsx)(`p`, {
                    ...
                    children: [
                      (0, b.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, b.jsx)(ke, { className: `size-5 text-primary` }),
                        ],
                      }),
                      (0, b.jsx)(`p`, {
                        className: `mt-2 text-2xl sm:text-3xl font-black text-foreground`,
                    ...
                    children: [
                      (0, b.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, b.jsx)(De, { className: `size-5 text-gold` }),
                        ],
                      }),
                      (0, b.jsx)(`p`, {
                        className: `mt-2 text-2xl sm:text-3xl font-black text-foreground`,
                    ...
                    children: [
                      (0, b.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, b.jsx)(Ie, { className: `size-5 text-amber-600` }),
                        ],
                      }),
                      (0, b.jsx)(`p`, {
                        className: `mt-2 text-2xl sm:text-3xl font-black text-foreground`,
                    ...
                    children: [
                      (0, b.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, b.jsx)(Te, { className: `size-5 text-amber-500 fill-amber-500` }),
                        ],
                      }),
                      (0, b.jsx)(`p`, {
                        className: `mt-2 text-2xl sm:text-3xl font-black text-foreground`,
              ...
              (0, b.jsxs)(`div`, {
                ...
                children: [
                  (0, b.jsxs)(`div`, {
                    className: `flex items-center gap-2`,
                    children: [
                      (0, b.jsx)(Pe, { className: `size-4 text-[#C58A32]` }),
                      (0, b.jsx)(`span`, {
                  ...
                  (0, b.jsxs)(`div`, {
                    ...
                    children: [
                      (0, b.jsxs)(`button`, {
                        ...
                        children: [
                          (0, b.jsx)(p, { className: `size-3.5` }),
                          (0, b.jsx)(`span`, { children: `Kegiatan / Berita` }),
                        ],
                      }),
                      (0, b.jsxs)(`button`, {
                        type: `button`,
                        ...
                        children: [
                          (0, b.jsx)(p, { className: `size-3.5` }),
                          (0, b.jsx)(`span`, { children: `Daya Tarik / Landmark` }),
                        ],
                      }),
                      (0, b.jsxs)(`button`, {
                        type: `button`,
                        ...
                        children: [
                          (0, b.jsx)(p, { className: `size-3.5` }),
                          (0, b.jsx)(`span`, { children: `Produk UMKM` }),
                        ],
                      }),
                      (0, b.jsxs)(`button`, {
                        type: `button`,
                        ...
                        children: [
                          (0, b.jsx)(Oe, { className: `size-3.5 text-white` }),
                          (0, b.jsx)(`span`, { children: `Upload Foto Galeri` }),
                        ],
                      }),
                    ],
                  }),
              ...
              (0, b.jsx)(`div`, {
                ...
                children: (0, b.jsx)(`nav`, {
                  ...
                  children: [
                    { id: `reservasi`, label: `Reservasi (${T.length})`, icon: Ne },
                    { id: `info`, label: `Informasi & Kontak`, icon: We },
                    { id: `kegiatan`, label: `Berita & Kegiatan (${n.length})`, icon: ke },
                    { id: `landmark`, label: `Landmark & Daya Tarik (${f.length})`, icon: De },
                    { id: `umkm`, label: `Produk UMKM (${je.length})`, icon: Ie },
                    { id: `galeri`, label: `Galeri Foto (${qe.length})`, icon: Oe },
                    { id: `reviews`, label: `Ulasan (${Me.length})`, icon: Te },
                    { id: `backup`, label: `Cadangan & Backup`, icon: h },
                  ].map((e) => {
                    let t = e.icon,
                      n = C === e.id;
                    return (0, b.jsxs)(
                      ...
                      {
                        onClick: () => w(e.id),
                        className: `inline-flex items-center gap-2 border-b-2 px-4 py-3 text-xs sm:text-sm font-extrabold transition-all cursor-pointer ${n ? `border-primary text-primary bg-primary/5 rounded-t-xl` : `border-transparent text-muted-foreground hover:text-foreground hover:border-border`}`,
                        children: [
                          (0, b.jsx)(t, { className: `size-4` }),
              ...
              C === `reservasi` &&
                (0, b.jsxs)(`div`, {
                  ...
                  children: [
                            ...
                            (0, b.jsxs)(`div`, {
                              children: [
                                (0, b.jsxs)(`h3`, {
                                  ...
                                  children: [
                                    (0, b.jsx)(Ne, { className: `size-5 text-primary` }),
                                    (0, b.jsx)(`span`, { children: `Kelola Reservasi Wisatawan` }),
                                  ],
                                }),
                                (0, b.jsx)(`p`, {
                                  ...
                                  children: [
                                    ...
                                    (0, b.jsxs)(`select`, {
                                      ...
                                      children: [
                                        (0, b.jsxs)(`option`, {
                                          value: `all`,
                                          children: [`Semua Status (`, T.length, `)`],
                                        }),
                                        (0, b.jsxs)(`option`, {
                                          value: `pending`,
                                          children: [
                                            `⏳ Menunggu (`,
                                            T.filter((e) => e.status === `pending`).length,
                                            `)`,
                                          ],
                                        }),
                                        (0, b.jsxs)(`option`, {
                                          ...
                                          children: [
                                            `✓ Terkonfirmasi (`,
                                            T.filter((e) => e.status === `confirmed`).length,
                                            `)`,
                                          ],
                                        }),
                                        (0, b.jsxs)(`option`, {
                                        ...
                                        (0, b.jsxs)(`option`, {
                                          ...
                                          children: [
                                            `✕ Dibatalkan (`,
                                            T.filter((e) => e.status === `cancelled`).length,
                                            `)`,
                                          ],
                                        }),
                                      ],
                        ...
                        (0, b.jsxs)(`div`, {
                          ...
                          children: [
                            (0, b.jsxs)(`button`, {
                              type: `button`,
                              onClick: () => D(`all`),
                              className: `rounded-full px-3.5 py-1.5 text-xs font-extrabold transition-all cursor-pointer ${E === `all` ? `bg-primary text-primary-foreground shadow-sm` : `bg-surface border border-border text-muted-foreground hover:text-foreground`}`,
                              children: [`Semua (`, T.length, `)`],
                            }),
                            (0, b.jsxs)(`button`, {
                              type: `button`,
                              onClick: () => D(`pending`),
                              className: `rounded-full px-3.5 py-1.5 text-xs font-extrabold transition-all cursor-pointer ${E === `pending` ? `bg-amber-500 text-amber-950 shadow-sm` : `bg-amber-500/10 border border-amber-500/30 text-amber-800 dark:text-amber-300 hover:bg-amber-500/20`}`,
                              children: [
                                `⏳ Menunggu (`,
                                T.filter((e) => e.status === `pending`).length,
                                `)`,
                            ...
                            (0, b.jsxs)(`button`, {
                              type: `button`,
                              onClick: () => D(`confirmed`),
                              className: `rounded-full px-3.5 py-1.5 text-xs font-extrabold transition-all cursor-pointer ${E === `confirmed` ? `bg-emerald-600 text-white shadow-sm` : `bg-emerald-500/10 border border-emerald-500/30 text-emerald-800 dark:text-emerald-300 hover:bg-emerald-500/20`}`,
                              children: [
                                `✓ Terkonfirmasi (`,
                                T.filter((e) => e.status === `confirmed`).length,
                                `)`,
                            ...
                            (0, b.jsxs)(`button`, {
                              type: `button`,
                              onClick: () => D(`completed`),
                              className: `rounded-full px-3.5 py-1.5 text-xs font-extrabold transition-all cursor-pointer ${E === `completed` ? `bg-sky-600 text-white shadow-sm` : `bg-sky-500/10 border border-sky-500/30 text-sky-800 dark:text-sky-300 hover:bg-sky-500/20`}`,
                              children: [
                                `🎉 Selesai (`,
                                T.filter((e) => e.status === `completed`).length,
                                `)`,
                            ...
                            (0, b.jsxs)(`button`, {
                              type: `button`,
                              onClick: () => D(`cancelled`),
                              className: `rounded-full px-3.5 py-1.5 text-xs font-extrabold transition-all cursor-pointer ${E === `cancelled` ? `bg-rose-600 text-white shadow-sm` : `bg-rose-500/10 border border-rose-500/30 text-rose-800 dark:text-rose-300 hover:bg-rose-500/20`}`,
                              children: [
                                `✕ Dibatalkan (`,
                                T.filter((e) => e.status === `cancelled`).length,
                                `)`,
                    ...
                    (() => {
                      let e = T.filter((e) => {
                        if (E !== `all` && e.status !== E) return !1;
                        if (O) {
                          let t = O.toLowerCase();
                          return (
                            (e.kode_reservasi || ``).toLowerCase().includes(t) ||
                            (e.nama_pemesan || ``).toLowerCase().includes(t) ||
                      ...
                      return (0, b.jsxs)(`div`, {
                        ...
                        children: [
                          (0, b.jsx)(`div`, {
                            ...
                            children: i.map((e) => {
                              let t = e.status === `confirmed`,
                                n = e.status === `completed`,
                                r = e.status === `cancelled`,
                                i = !e.status || e.status === `pending`,
                                a = t
                                ...
                                ee = encodeURIComponent(
                                  `Halo ${e.nama_pemesan}, mengonfirmasi mengenai reservasi Anda dengan Kode *${e.kode_reservasi}* di Desa Wisata Ekang Anculai pada tanggal ${e.tanggal_kunjungan} (Jam ${e.jam_kedatangan} WIB). Status reservasi saat ini: *${e.status?.toUpperCase() || `PENDING`}*. Apakah ada yang perlu disesuaikan? Terima kasih.`,
                                );
                              return (0, b.jsxs)(
                                `div`,
                                {
                                  className: `flex flex-col justify-between rounded-3xl border p-5 shadow-soft hover:shadow-card transition-all ${a}`,
                                  children: [
                                    (0, b.jsxs)(`div`, {
                                      children: [
                                        (0, b.jsxs)(`div`, {
                                          ...
                                          children: [
                                            (0, b.jsx)(`span`, {
                                              ...
                                              children: e.kode_reservasi,
                                            }),
                                            (0, b.jsx)(`span`, {
                                              className: `rounded-full px-3 py-0.5 text-[10px] uppercase shadow-sm ${o}`,
                                              children: s,
                                            }),
                                          ],
                                        }),
                                    ...
                                    (0, b.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, b.jsxs)(`a`, {
                                          href: `https://wa.me/${e.whatsapp.replace(/[^0-9]/g, ``)}?text=${ee}`,
                                          target: `_blank`,
                                                ...
                                                children: [
                                                  (0, b.jsxs)(`p`, {
                                                    ...
                                                    children: [
                                                      ...
                                                      (0, b.jsx)(`span`, {
                                                        children: `Status Final: Reservasi Dibatalkan`,
                                                      }),
                                                    ],
                                                  }),
                                                  (0, b.jsx)(`p`, {
                                            ...
                                            (0, b.jsx)(`div`, {
                                              ...
                                              children: (0, b.jsxs)(`button`, {
                                                ...
                                                children: [
                                                  ...
                                                  (0, b.jsx)(`span`, { children: `Hapus Data` }),
                                                ],
                                              }),
                                            }),
                                          ],
                    ...
                    (0, b.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, b.jsxs)(`button`, {
                          ...
                          children: [
                            (0, b.jsx)(Ue, { className: `size-4` }),
                            (0, b.jsx)(`span`, { children: `Simpan Pengaturan` }),
                          ],
                        }),
                      ],
                    }),
                      ...
                      children: [
                        (0, b.jsxs)(`div`, {
                          children: [
                            ...
                            (0, b.jsx)(`input`, {
                              type: `text`,
                              value: M.nama,
                              onChange: (e) => N({ ...M, nama: e.target.value }),
                        ...
                        (0, b.jsxs)(`div`, {
                          children: [
                            ...
                            (0, b.jsx)(`input`, {
                              type: `text`,
                              value: M.tagline,
                              onChange: (e) => N({ ...M, tagline: e.target.value }),
                              className: `w-full rounded-2xl border border-border bg-surface px-4 py-3 text-xs sm:text-sm font-bold text-foreground`,
                            }),
                          ],
                        }),
                        (0, b.jsxs)(`div`, {
                          children: [
                            ...
                            (0, b.jsx)(`input`, {
                              type: `text`,
                              value: M.whatsapp,
                              onChange: (e) => N({ ...M, whatsapp: e.target.value }),
                        ...
                        (0, b.jsxs)(`div`, {
                          children: [
                            ...
                            (0, b.jsx)(`input`, {
                              type: `email`,
                              value: M.email,
                              onChange: (e) => N({ ...M, email: e.target.value }),
                              className: `w-full rounded-2xl border border-border bg-surface px-4 py-3 text-xs sm:text-sm font-bold text-foreground`,
                            }),
                          ],
                        }),
                        (0, b.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            (0, b.jsx)(`input`, {
                              type: `text`,
                              value: M.alamat,
                              onChange: (e) => N({ ...M, alamat: e.target.value }),
                              className: `w-full rounded-2xl border border-border bg-surface px-4 py-3 text-xs sm:text-sm font-bold text-foreground`,
                            }),
                          ],
                        }),
                        (0, b.jsxs)(`div`, {
                          children: [
                            ...
                            (0, b.jsx)(`input`, {
                              type: `text`,
                              value: M.jamOperasional,
                              onChange: (e) => N({ ...M, jamOperasional: e.target.value }),
                              className: `w-full rounded-2xl border border-border bg-surface px-4 py-3 text-xs sm:text-sm font-bold text-foreground`,
                            }),
                          ],
                        }),
                        (0, b.jsxs)(`div`, {
                          children: [
                            ...
                            (0, b.jsx)(`input`, {
                              type: `text`,
                              value: M.waktuTerbaik,
                              onChange: (e) => N({ ...M, waktuTerbaik: e.target.value }),
                              className: `w-full rounded-2xl border border-border bg-surface px-4 py-3 text-xs sm:text-sm font-bold text-foreground`,
                            }),
                          ],
                        }),
                        (0, b.jsxs)(`div`, {
                          children: [
                            ...
                            (0, b.jsx)(`input`, {
                              type: `text`,
                              value: M.instagram,
                              onChange: (e) => N({ ...M, instagram: e.target.value }),
                              className: `w-full rounded-2xl border border-border bg-surface px-4 py-3 text-xs sm:text-sm font-bold text-foreground`,
                            }),
                          ],
                        }),
                        (0, b.jsxs)(`div`, {
                          children: [
                            ...
                            (0, b.jsx)(`input`, {
                              type: `text`,
                              value: M.pemdesWebsite,
                              onChange: (e) => N({ ...M, pemdesWebsite: e.target.value }),
                              className: `w-full rounded-2xl border border-border bg-surface px-4 py-3 text-xs sm:text-sm font-bold text-foreground`,
                            }),
                          ],
                        }),
                        (0, b.jsx)(`div`, {
                          ...
                          children: (0, b.jsxs)(`button`, {
                            ...
                            children: [
                              (0, b.jsx)(Ue, { className: `size-4` }),
                              (0, b.jsx)(`span`, { children: `Simpan Perubahan` }),
                            ],
                          }),
                        }),
                      ],
                      ...
                      children: [
                        ...
                        (0, b.jsxs)(`button`, {
                          onClick: () => {
                            (F({
                              ...
                              source: {
                                name: `Pemerintah Desa Ekang Anculai`,
                                url:
                                  t?.pemdesWebsite || `https://desaekanganculai.bintankab.go.id/`,
                                publishedAt: new Date().toISOString().slice(0, 10),
                              },
                            }),
                              I(!0));
                          ...
                          children: [
                            ...
                            (0, b.jsx)(`span`, { children: `Tambah Kegiatan Baru` }),
                          ],
                        }),
                      ],
                    }),
                                  ...
                                  (0, b.jsxs)(`div`, {
                                    ...
                                    children: [
                                      (0, b.jsxs)(`button`, {
                                        ...
                                        children: [
                                          (0, b.jsx)(g, { className: `size-3.5` }),
                                          (0, b.jsx)(`span`, { children: `Edit` }),
                                        ],
                                      }),
                                      (0, b.jsxs)(`button`, {
                                        onClick: () => Ht(e.id),
                                        ...
                                        children: [
                                          (0, b.jsx)(_, { className: `size-3.5` }),
                                          (0, b.jsx)(`span`, { children: `Hapus` }),
                                        ],
                                      }),
                                    ],
                                  }),
                    ...
                    (0, b.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, b.jsxs)(`button`, {
                          ...
                          children: [
                            (0, b.jsx)(p, { className: `size-4` }),
                            (0, b.jsx)(`span`, { children: `Tambah Landmark Baru` }),
                          ],
                        }),
                      ],
                    }),
                                      ...
                                      (0, b.jsxs)(`div`, {
                                        ...
                                        children: [
                                          ...
                                          (0, b.jsxs)(`span`, {
                                            className: `text-[11px] font-bold text-muted-foreground`,
                                            children: [
                                              (e.lat ?? 1.0868).toFixed(4),
                                              `, `,
                                              (e.lng ?? 104.3621).toFixed(4),
                                            ],
                                          }),
                                        ],
                                      }),
                    ...
                    (0, b.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, b.jsxs)(`button`, {
                          ...
                          children: [
                            (0, b.jsx)(p, { className: `size-4` }),
                            (0, b.jsx)(`span`, { children: `Tambah Produk UMKM` }),
                          ],
                        }),
                      ],
                    }),
                  ...
                  children: [
                    (0, b.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, b.jsxs)(`button`, {
                          ...
                          children: [
                            (0, b.jsx)(p, { className: `size-4` }),
                            (0, b.jsx)(`span`, { children: `Tambah Ulasan Baru` }),
                          ],
                        }),
                      ],
                    }),
                    (() => {
                      let e = Me.filter((e) => {
                          ...
                          let t = O.toLowerCase();
                          return (
                            (e.nama || ``).toLowerCase().includes(t) ||
                            (e.komentar || ``).toLowerCase().includes(t) ||
                            (e.asal || ``).toLowerCase().includes(t)
                          );
                        }),
                        t = e.length,
                        n = Math.ceil(t / 12) || 1,
                                    ...
                                    (0, b.jsxs)(`div`, {
                                      children: [
                                        ...
                                        (0, b.jsxs)(`span`, {
                                          ...
                                          children: [e.asal, ` • `, e.tipeWisatawan],
                                        }),
                                        (0, b.jsxs)(`p`, {
                              ...
                              (0, b.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, b.jsx)(`div`, {
                                    ...
                                    children: (0, b.jsx)(h, { className: `size-5` }),
                                  }),
                                  (0, b.jsxs)(`div`, {
                                    children: [
                                      (0, b.jsx)(`h3`, {
                              ...
                              (0, b.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, b.jsxs)(`button`, {
                                    ...
                                    children: [
                                      (0, b.jsx)(h, { className: `size-4` }),
                                      (0, b.jsx)(`span`, { children: `Unduh Backup JSON` }),
                                    ],
                                  }),
                                  (0, b.jsxs)(`label`, {
                                    ...
                                    children: [
                                      (0, b.jsx)(v, { className: `size-4 text-primary` }),
                                      (0, b.jsx)(`span`, { children: `Impor Data JSON` }),
                                      (0, b.jsx)(`input`, {
                                        type: `file`,
                                        accept: `.json`,
                                        onChange: dn,
                              ...
                              (0, b.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, b.jsx)(`div`, {
                                    ...
                                    children: (0, b.jsx)(Le, { className: `size-5` }),
                                  }),
                                  (0, b.jsxs)(`div`, {
                                    children: [
                                      (0, b.jsx)(`h3`, {
                                  ...
                                  onClick: async () => {
                                    try {
                                      let e = $(),
                                        ...
                                        n = await te({ data: { token: e } });
                                      (m.success(
                                        `Berhasil memigrasi ${n.count} foto Base64 ke file fisik WebP!`,
                                        { id: t },
                                      ),
                                        j());
                                    } catch (e) {
                                      m.error(x(e, `Gagal memigrasi foto.`));
                                    }
                                  },
              ...
              C === `galeri` &&
                (0, b.jsxs)(`div`, {
                  ...
                  children: [
                    (0, b.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, b.jsxs)(`button`, {
                          ...
                          children: [
                            (0, b.jsx)(p, { className: `size-4` }),
                            (0, b.jsx)(`span`, { children: `Tambah Foto Galeri Baru` }),
                          ],
                        }),
                      ],
                    }),
                    ...
                    (() => {
                      let e = qe.filter((e) =>
                          (e.judul + e.kategori + e.caption + (e.sumber || ``))
                            .toLowerCase()
              ...
              C === `backup` &&
                (0, b.jsxs)(`div`, {
                  ...
                  children: [
                    (0, b.jsxs)(`div`, {
                      children: [
                        (0, b.jsx)(h, { className: `mx-auto size-12 text-primary` }),
                        (0, b.jsx)(`h2`, {
                    ...
                    (0, b.jsxs)(`div`, {
                      ...
                      children: [
                        (0, b.jsxs)(`button`, {
                          ...
                          children: [
                            (0, b.jsx)(h, { className: `size-4` }),
                            (0, b.jsx)(`span`, { children: `Unduh Backup Data (JSON)` }),
                          ],
                        }),
                        (0, b.jsxs)(`label`, {
                          ...
                          children: [
                            (0, b.jsx)(v, { className: `size-4 text-primary` }),
                            (0, b.jsx)(`span`, { children: `Pulihkan dari File JSON` }),
                            (0, b.jsx)(`input`, {
                              type: `file`,
                              accept: `.json`,
                              onChange: dn,
                      ...
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`input`, {
                            ...
                            required: !0,
                            value: P.judul || ``,
                            onChange: (e) => F({ ...P, judul: e.target.value }),
                          ...
                          (0, b.jsxs)(`div`, {
                            children: [
                              ...
                              (0, b.jsx)(`input`, {
                                ...
                                required: !0,
                                value: P.kategori || ``,
                                onChange: (e) => F({ ...P, kategori: e.target.value }),
                                className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                              }),
                            ],
                          }),
                          (0, b.jsxs)(`div`, {
                            children: [
                              ...
                              (0, b.jsx)(`input`, {
                                ...
                                required: !0,
                                value: P.tanggal || ``,
                                onChange: (e) => F({ ...P, tanggal: e.target.value }),
                                className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                              }),
                            ],
                          }),
                      ...
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`textarea`, {
                            ...
                            required: !0,
                            value: P.deskripsi || ``,
                            onChange: (e) => F({ ...P, deskripsi: e.target.value }),
                            ...
                            children: [
                              ...
                              (0, b.jsx)(`input`, {
                                ...
                                onChange: (e) =>
                                  F({
                                    ...P,
                                    source: { name: e.target.value, url: P.source?.url || `` },
                                  }),
                              ...
                              (0, b.jsxs)(`label`, {
                                ...
                                children: [
                                  (0, b.jsx)(`input`, {
                                    ...
                                    value: `upload`,
                                    checked: (P.image_source || `upload`) === `upload`,
                                    onChange: () => F({ ...P, image_source: `upload` }),
                                    className: `size-4 text-primary`,
                                  }),
                                  (0, b.jsx)(`span`, { children: `📷 Upload Foto Manual` }),
                                ],
                              }),
                              (0, b.jsxs)(`label`, {
                                className: `flex items-center gap-2 text-xs font-bold text-foreground cursor-pointer`,
                                children: [
                                  (0, b.jsx)(`input`, {
                                    ...
                                    name: `image_source_mode`,
                                    value: `source_url`,
                                    checked: P.image_source === `source_url`,
                                    onChange: () => F({ ...P, image_source: `source_url` }),
                                    className: `size-4 text-primary`,
                                  }),
                                  (0, b.jsx)(`span`, {
                            ...
                            ? (0, b.jsxs)(`div`, {
                                ...
                                children: [
                                  ...
                                  (0, b.jsx)(`input`, {
                                    type: `text`,
                                    value: P.image || ``,
                                    onChange: (e) => F({ ...P, image: e.target.value }),
                                ...
                                children: [
                                  ...
                                  (0, b.jsx)(`div`, {
                                    ...
                                    children: (0, b.jsxs)(`button`, {
                                      ...
                                      children: [
                                        Dt
                                          ? (0, b.jsx)(ze, { className: `size-4 animate-spin` })
                                          : (0, b.jsx)(Ve, { className: `size-4` }),
                                        (0, b.jsx)(`span`, {
                                          children: P.image
                                  ...
                                  kt &&
                                    (0, b.jsx)(`div`, {
                                      className: `p-3 rounded-xl text-xs font-bold leading-relaxed ${kt.type === `success` ? `bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 border border-emerald-500/20` : `bg-destructive/10 text-destructive border border-destructive/20`}`,
                                      children: kt.message,
                                    }),
                                ],
                              }),
                            ...
                            (0, b.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, b.jsx)(`div`, {
                                  ...
                                  children:
                                    (P.image_source || `upload`) === `source_url`
                      ...
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`input`, {
                            ...
                            required: !0,
                            value: R.nama || ``,
                            onChange: (e) => z({ ...R, nama: e.target.value }),
                            className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                          }),
                        ],
                      }),
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`input`, {
                            ...
                            required: !0,
                            value: R.kategori || ``,
                            onChange: (e) => z({ ...R, kategori: e.target.value }),
                            className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                          }),
                        ],
                      }),
                          ...
                          (0, b.jsxs)(`div`, {
                            children: [
                              ...
                              (0, b.jsx)(`input`, {
                                ...
                                value: R.lat ?? 1.1278,
                                onChange: (e) =>
                                  z({ ...R, lat: parseFloat(e.target.value) || 1.1278 }),
                                className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                              }),
                            ],
                          }),
                          (0, b.jsxs)(`div`, {
                            children: [
                              ...
                              (0, b.jsx)(`input`, {
                                type: `number`,
                                step: `any`,
                                value: R.lng ?? 104.3621,
                                onChange: (e) =>
                                  z({ ...R, lng: parseFloat(e.target.value) || 104.3621 }),
                                className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                              }),
                            ],
                          }),
                          ...
                          (0, b.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, b.jsx)(`input`, {
                                type: `text`,
                                value: R.image || ``,
                                onChange: (e) => z({ ...R, image: e.target.value }),
                      ...
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`textarea`, {
                            ...
                            required: !0,
                            value: R.deskripsi || ``,
                            onChange: (e) => z({ ...R, deskripsi: e.target.value }),
                            className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-medium text-foreground`,
                          }),
                        ],
                      }),
                      ...
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`input`, {
                            ...
                            required: !0,
                            value: V.nama || ``,
                            onChange: (e) => H({ ...V, nama: e.target.value }),
                            className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                          }),
                        ],
                      }),
                        ...
                        children: [
                          (0, b.jsxs)(`div`, {
                            children: [
                              ...
                              (0, b.jsxs)(`select`, {
                                value: V.kategori || `Kuliner & Olahan Pangan`,
                                onChange: (e) => H({ ...V, kategori: e.target.value }),
                                className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                                children: [
                                  (0, b.jsx)(`option`, {
                          ...
                          (0, b.jsxs)(`div`, {
                            children: [
                              ...
                              (0, b.jsx)(`input`, {
                                ...
                                required: !0,
                                value: V.hargaInfo || ``,
                                onChange: (e) => H({ ...V, hargaInfo: e.target.value }),
                                className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                              }),
                            ],
                          }),
                          (0, b.jsxs)(`div`, {
                            children: [
                              ...
                              (0, b.jsx)(`input`, {
                                type: `text`,
                                value: V.lokasi || ``,
                                onChange: (e) => H({ ...V, lokasi: e.target.value }),
                                className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                              }),
                            ],
                          }),
                          ...
                          (0, b.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, b.jsx)(`input`, {
                                type: `text`,
                                value: V.image || ``,
                                onChange: (e) => H({ ...V, image: e.target.value }),
                                placeholder: `Atau masukan URL gambar Web...`,
                                className: `w-full rounded-2xl border border-border bg-surface px-4 py-2 text-xs font-medium text-foreground`,
                              }),
                              V.image &&
                      ...
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`textarea`, {
                            ...
                            required: !0,
                            value: V.deskripsi || ``,
                            onChange: (e) => H({ ...V, deskripsi: e.target.value }),
                            className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-medium text-foreground`,
                          }),
                        ],
                      }),
                    ...
                    children: [
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`input`, {
                            ...
                            required: !0,
                            value: W.nama || ``,
                            onChange: (e) => G({ ...W, nama: e.target.value }),
                            className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                          }),
                        ],
                      }),
                        ...
                        children: [
                          (0, b.jsxs)(`div`, {
                            children: [
                              ...
                              (0, b.jsx)(`input`, {
                                ...
                                required: !0,
                                value: W.asal || ``,
                                onChange: (e) => G({ ...W, asal: e.target.value }),
                                className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                              }),
                            ],
                          }),
                          (0, b.jsxs)(`div`, {
                            children: [
                              ...
                              (0, b.jsxs)(`select`, {
                                value: W.rating || 5,
                                onChange: (e) => G({ ...W, rating: parseInt(e.target.value) || 5 }),
                                className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                                children: [
                                  (0, b.jsx)(`option`, {
                                    value: 5,
                                  ...
                                  (0, b.jsx)(`option`, { value: 2, children: `⭐⭐ (2 Bintang)` }),
                                  (0, b.jsx)(`option`, { value: 1, children: `⭐ (1 Bintang)` }),
                                ],
                              }),
                            ],
                          }),
                      ...
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`input`, {
                            type: `text`,
                            value: W.tipeWisatawan || `Keluarga`,
                            onChange: (e) => G({ ...W, tipeWisatawan: e.target.value }),
                      ...
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`textarea`, {
                            ...
                            required: !0,
                            value: W.komentar || ``,
                            onChange: (e) => G({ ...W, komentar: e.target.value }),
                            className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-medium text-foreground`,
                          }),
                        ],
                      }),
                      ...
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`input`, {
                            ...
                            required: !0,
                            value: q.judul || ``,
                            onChange: (e) => J({ ...q, judul: e.target.value }),
                        ...
                        children: [
                          (0, b.jsxs)(`div`, {
                            children: [
                              ...
                              (0, b.jsxs)(`select`, {
                                value: q.kategori || `Alam`,
                                onChange: (e) => J({ ...q, kategori: e.target.value }),
                                className: `w-full rounded-2xl border border-border bg-surface px-4 py-2.5 font-semibold text-foreground`,
                                children: [
                                  (0, b.jsx)(`option`, { value: `Alam`, children: `Alam` }),
                                  (0, b.jsx)(`option`, { value: `Mangrove`, children: `Mangrove` }),
                                  (0, b.jsx)(`option`, {
                                    value: `Perkebunan`,
                                    children: `Perkebunan`,
                                  }),
                                  (0, b.jsx)(`option`, { value: `Budaya`, children: `Budaya` }),
                                  (0, b.jsx)(`option`, { value: `Batik`, children: `Batik` }),
                                  (0, b.jsx)(`option`, { value: `Kuliner`, children: `Kuliner` }),
                                  (0, b.jsx)(`option`, {
                          ...
                          (0, b.jsxs)(`div`, {
                            children: [
                              ...
                              (0, b.jsx)(`input`, {
                                type: `text`,
                                value: q.sumber || ``,
                                onChange: (e) => J({ ...q, sumber: e.target.value }),
                              ...
                              (0, b.jsxs)(`label`, {
                                ...
                                children: [
                                  (0, b.jsx)(`div`, {
                                    ...
                                    children: (0, b.jsx)(v, { className: `size-5` }),
                                  }),
                                  (0, b.jsxs)(`div`, {
                                    children: [
                                      (0, b.jsx)(`span`, {
                              ...
                              (0, b.jsxs)(`div`, {
                                children: [
                                  ...
                                  (0, b.jsx)(`input`, {
                                    ...
                                    required: !0,
                                    value: q.image || ``,
                                    onChange: (e) => J({ ...q, image: e.target.value }),
                      ...
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`textarea`, {
                            ...
                            required: !0,
                            value: q.caption || ``,
                            onChange: (e) => J({ ...q, caption: e.target.value }),
                      ...
                      (0, b.jsxs)(`div`, {
                        children: [
                          ...
                          (0, b.jsx)(`input`, {
                            type: `text`,
                            value: q.alt || ``,
                            onChange: (e) => J({ ...q, alt: e.target.value }),
                ...
                children: [
                  (0, b.jsx)(o, {
                    children: (0, b.jsxs)(s, {
                      ...
                      children: [
                        (0, b.jsx)(Be, { className: `size-5 text-primary` }),
                          ...
                          (0, b.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, b.jsx)(`button`, {
                                ...
                                title: bt ? `Sembunyikan Kata Sandi` : `Tampilkan Kata Sandi`,
                                children: bt
                                  ? (0, b.jsx)(Re, { className: `size-4` })
                                  : (0, b.jsx)(we, { className: `size-4` }),
                              }),
                            ],
                          }),
                        ],
                          ...
                          (0, b.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, b.jsx)(`button`, {
                                ...
                                onClick: () => Ct((e) => !e),
                                className: `absolute right-3.5 top-1/2 -translate-y-1/2 p-1 text-muted-foreground hover:text-foreground transition-colors cursor-pointer rounded-lg hover:bg-black/5 dark:hover:bg-white/5`,
                                title: St ? `Sembunyikan Kata Sandi` : `Tampilkan Kata Sandi`,
                                children: St
                                  ? (0, b.jsx)(Re, { className: `size-4` })
                                  : (0, b.jsx)(we, { className: `size-4` }),
                              }),
                    ...
                    children: (0, b.jsxs)(`div`, {
                      ...
                      children: [
                        (0, b.jsx)(`div`, {
                          ...
                          children: (0, b.jsx)(Ge, { className: `size-5 text-rose-600` }),
                        }),
                        (0, b.jsx)(s, {
                          className: `text-lg font-black text-foreground`,
                          children: X.title,
                      ...
                      (0, b.jsx)(`button`, {
                        ...
                        children: Pt
                          ? (0, b.jsxs)(b.Fragment, {
                              children: [
                                (0, b.jsx)(ze, { className: `size-4 animate-spin` }),
                                (0, b.jsx)(`span`, { children: `Menghapus...` }),
                              ],
                            })
                          : (0, b.jsxs)(b.Fragment, {
                              children: [
                                (0, b.jsx)(_, { className: `size-4` }),
                                (0, b.jsx)(`span`, { children: `Ya, Hapus Data` }),
                              ],
                            }),
                      }),
                    ],
            ...
            (0, b.jsxs)(`form`, {
              ...
              children: [
                    ...
                    (0, b.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, b.jsx)(`button`, {
                          ...
                          onClick: () => yt((e) => !e),
                          className: `absolute right-3.5 top-1/2 -translate-y-1/2 p-1 text-muted-foreground hover:text-foreground transition-colors cursor-pointer rounded-lg hover:bg-black/5 dark:hover:bg-white/5`,
                          title: vt ? `Sembunyikan Kata Sandi` : `Tampilkan Kata Sandi`,
                          children: vt
                            ? (0, b.jsx)(Re, { className: `size-4` })
                            : (0, b.jsx)(we, { className: `size-4` }),
                        }),
                ...
                (0, b.jsx)(`button`, {
                  ...
                  children: tt ? `Memproses Otentikasi...` : `Masuk ke Panel Pengelola`,
                }),
              ],
            }),
            (0, b.jsx)(`div`, {
              ...
              children: (0, b.jsx)(xe, {
                ...
                children: (0, b.jsx)(`span`, { children: `← Kembali ke Website Publik Desa` }),
              }),
            }),
          ],
        }),
