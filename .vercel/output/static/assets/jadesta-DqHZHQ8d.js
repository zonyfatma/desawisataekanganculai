import { i as e, l as t } from "./jsx-runtime-D1ym7qjA.js";
var n = t(e()),
  r = (...e) =>
    e
  ...
  f = `/assets/ekang-mangrove-dermaga-DXReJdE4.jpg`,
  p = `/assets/reog-kendang-kempul-BZGq85o6.jpg`,
  m = `/assets/rengginang-sajian-fz87gqiT.jpg`,
  h = `/assets/rengginang-kemasan-3-TqEw9x0R.jpg`,
  g = `/assets/rengginang-kemasan-label--H5bYFYt.jpg`,
  _ = `/assets/rengginang-kemasan-mentah-DonzhfHS.jpg`,
  v = `/assets/kegiatan-batik-1-C9qFFiFn.jpg`,
  y = `/assets/kegiatan-batik-2-w4bz9jCL.jpg`,
  b = `/assets/kegiatan-batik-3-2v2rOTsT.jpg`,
  x = `/assets/teko-kayangan-BnNeu7Ja.jpg`,
  S = `/assets/ekang-gotong-royong-kkn-T4EIBh4a.jpg`,
  C = x,
  w = x,
  T = x,
  E = f,
  ...
  j = [`Kepulauan Riau`],
  M = `6283166341280`,
  N = `https://www.bintankab.go.id/`,
  P = `XnT6XnlvEoA`,
  F = `https://www.youtube.com/watch?v=${P}`,
  I = [
    {
      id: `gal-1`,
    ...
    rangkaian: [
      {
        ...
        linkRef: { nama: `Rumah Batik Bintan – Ikon Kreatif`, url: N },
      },
      {
        num: `02`,
        waktu: `11.00–12.30`,
    ...
    hari1: {
      ...
      rangkaian: [
        ...
        },
        {
          ...
          isi: [
            `Praktik kerajinan bersama perajin lokal.`,
            `Membuat suvenir kenang-kenangan desa.`,
          ],
        },
        {
          waktu: `16.00–17.00`,
  ...
  V = [1.0867858876382646, 104.36211358733912],
  H = `Jl. Jendral Sudirman, Kp. Sukoharjo, Desa Ekang Anculai, Kec. Teluk Sebong, Kab. Bintan, Kepulauan Riau 29151`,
  U = [
    {
      slug: `ekang-anculai`,
      ...
      paket: [
        ...
        },
        {
          ...
          subHeaderHari1: R.hari1.subHeader,
          subHeaderHari2: R.hari2.subHeader,
          itineraryHari1: R.hari1.rangkaian.map((e) => ({
            waktu: e.waktu,
            kegiatan: e.judul,
          ...
          itineraryHari2: R.hari2.rangkaian.map((e) => ({
            waktu: e.waktu,
            kegiatan: e.judul,
            ...(e.kategori ? { kategori: e.kategori } : {}),
            deskripsi: e.deskripsi,
