...
import { D as i } from "./jadesta-DqHZHQ8d.js";
function a(e) {
  if (
...
function s(e) {
  if (typeof e == `object` && e && e.isSerializedRedirect) return a(e);
}
var c = i(`external-link`, [
  ...
  p = !!(typeof window < `u` && window.document && window.document.createElement);
function m(e, t, { checkForDefaultPrevented: n = !0 } = {}) {
  return f(function (r) {
    if ((e?.(r), n === !1 || !r || !r.defaultPrevented)) return t?.(r);
  }, `handleEvent`);
}
f(m, `composeEventHandlers`);
function h(e) {
  if (!p) throw Error(`Cannot access window outside of the DOM`);
  return e?.ownerDocument?.defaultView ?? window;
}
f(h, `getOwnerWindow`);
function g(e) {
  if (!p) throw Error(`Cannot access document outside of the DOM`);
  return e?.ownerDocument ?? document;
}
f(g, `getOwnerDocument`);
function _(e, t = !1) {
  let { activeElement: n } = g(e);
  if (!n?.nodeName) return null;
  if (v(n) && n.contentDocument) return _(n.contentDocument.body, t);
  if (t) {
    let e = n.getAttribute(`aria-activedescendant`);
    if (e) {
      let t = g(n).getElementById(e);
      if (t) return t;
    }
  }
  return n;
}
f(_, `getActiveElement`);
function v(e) {
...
function ee(e, t) {
  let n = l.createContext(t);
  n.displayName = e + `Context`;
  let r = E((e) => {
    let { children: t, ...r } = e,
      i = l.useMemo(() => r, Object.values(r));
...
function D(e, t = []) {
  ...
  function r(t, r) {
    ...
    let o = E((t) => {
      let { scope: n, children: r, ...o } = t,
        s = n?.[e]?.[a] || i,
        c = l.useMemo(() => o, Object.values(o));
      return (0, u.jsx)(s.Provider, { value: c, children: r });
    }, `Provider`);
  ...
  let i = E(() => {
    ...
    return E(function (n) {
      let r = n?.[e] || t;
      return l.useMemo(() => ({ [`__scope${e}`]: { ...n, [e]: r } }), [n, r]);
    }, `useScope`);
  }, `createScope`);
  return ((i.scopeName = e), [r, te(i, ...t)]);
}
E(D, `createContextScope`);
function te(...e) {
  let t = e[0];
...
E(te, `composeContextScopes`);
var O = globalThis?.document ? l.useLayoutEffect : () => {},
  k = Object.defineProperty,
  A = (e, t) => k(e, `name`, { value: t, configurable: !0 }),
  j = l.useId || (() => void 0),
  ne = 0;
function re(e) {
  let [t, n] = l.useState(j());
  return (
    O(() => {
      e || n((e) => e ?? String(ne++));
    }, [e]),
...
var M = Object.defineProperty,
  ie = (e, t) => M(e, `name`, { value: t, configurable: !0 }),
  ae = l.useEffectEvent,
  oe = l.useInsertionEffect;
function se(e) {
  if (typeof ae == `function`) return ae(e);
  let t = l.useRef(() => {
...
ie(se, `useEffectEvent`);
var N = Object.defineProperty,
  P = (e, t) => N(e, `name`, { value: t, configurable: !0 }),
  ce = l.useInsertionEffect || O;
function le({ prop: e, defaultProp: t, onChange: n = P(() => {}, `onChange`), caller: r }) {
  let [i, a, o] = F({ defaultProp: t, onChange: n }),
    s = e !== void 0;
  return [
    s ? e : i,
    l.useCallback(
...
P(F, `useUncontrolledState`);
function ue(e) {
  return typeof e == `function`;
}
P(ue, `isFunction`);
var de = Symbol(`RADIX:SYNC_STATE`);
function fe(e, t, n, r) {
  let { prop: i, defaultProp: a, onChange: o, caller: s } = t,
    ...
    d = [{ ...n, state: a }];
  r && d.push(r);
  let [f, p] = l.useReducer(
      (t, n) => {
        if (n.type === de) return { ...t, state: n.state };
        let r = e(t, n);
        return (c && !Object.is(r.state, t.state) && u(r.state), r);
      },
      ...d,
    ),
    m = f.state,
    h = l.useRef(m);
  l.useEffect(() => {
    h.current !== m && ((h.current = m), c || u(m));
  }, [m, h, c]);
  let g = l.useMemo(() => (i === void 0 ? f : { ...f, state: i }), [f, i]);
  return (
    l.useEffect(() => {
      c && !Object.is(i, f.state) && p({ type: de, state: i });
    }, [i, f.state, c]),
    [g, p]
  );
}
P(fe, `useControllableStateReducer`);
var pe = Object.defineProperty,
  I = (e, t) => pe(e, `name`, { value: t, configurable: !0 });
function me(e) {
  let t = l.forwardRef((t, n) => {
    let { children: r, ...i } = t,
      a = null,
      o = !1,
      s = [];
    (Se(r) && typeof Ee == `function` && (r = Ee(r._payload)),
      l.Children.forEach(r, (e) => {
        if (be(e)) {
          o = !0;
          let t = e,
      ...
      a
        ? (a = l.cloneElement(a, void 0, s))
        : !o && l.Children.count(r) === 1 && l.isValidElement(r) && (a = r));
    let c = a ? ye(a) : void 0,
      u = w(n, c);
    if (!a) {
    ...
    let d = ve(i, a.props ?? {});
    return (a.type !== l.Fragment && (d.ref = n ? u : c), l.cloneElement(a, d));
  });
...
function ge(e) {
  let t = I((e) => (`child` in e ? e.children(e.child) : e.children), `Slottable`);
  return ((t.displayName = `${e}.Slottable`), (t.__radixId = he), t);
}
I(ge, `createSlottable`);
var _e = I((e, t) => {
  if (`child` in e.props) {
    let t = e.props.child;
...
var we = I(
  ...
  Oe = (e, t) => De(e, `name`, { value: t, configurable: !0 }),
  ke = [
    `a`,
    `button`,
    `div`,
...
Oe(Ae, `dispatchDiscreteCustomEvent`);
var je = Object.defineProperty,
  Me = (e, t) => je(e, `name`, { value: t, configurable: !0 });
function L(e) {
  let t = l.useRef(e);
  return (
    l.useEffect(() => {
...
var Ne = Object.defineProperty,
  R = (e, t) => Ne(e, `name`, { value: t, configurable: !0 }),
  ...
  ze = l.forwardRef(
    R(function (e, t) {
      let {
        ...
        [b] = [...f.layersWithOutsidePointerEventsDisabled].slice(-1),
        x = b ? y.indexOf(b) : -1,
        S = p ? y.indexOf(p) : -1,
        C = f.layersWithOutsidePointerEventsDisabled.size > 0,
        T = S >= x,
        E = l.useRef(!1),
        ee = He(
          (e) => {
      ...
      return (
        l.useEffect(() => {
          if (te)
            return (
              g.addEventListener(`keydown`, O, { capture: !0 }),
              () => g.removeEventListener(`keydown`, O, { capture: !0 })
            );
        }, [g, te, O]),
        l.useEffect(() => {
          if (p)
            return (
              n &&
                (f.layersWithOutsidePointerEventsDisabled.size === 0 &&
                  ((Le = g.body.style.pointerEvents), (g.body.style.pointerEvents = `none`)),
              ...
              () => {
                n &&
                  ...
                  f.layersWithOutsidePointerEventsDisabled.size === 0 &&
                    (g.body.style.pointerEvents = Le));
              }
            );
        }, [p, g, n, f]),
        l.useEffect(
          () => () => {
            p && (f.layers.delete(p), f.layersWithOutsidePointerEventsDisabled.delete(p), We());
          },
          [p, f],
        ),
        l.useEffect(() => {
          let e = R(() => _({}), `handleUpdate`);
          return (document.addEventListener(Pe, e), () => document.removeEventListener(Pe, e));
        }, []),
        (0, u.jsx)(ke.div, {
          ...d,
          ref: v,
          style: { pointerEvents: C ? (T ? `auto` : `none`) : void 0, ...e.style },
          onFocusCapture: m(e.onFocusCapture, D.onFocusCapture),
          onBlurCapture: m(e.onBlurCapture, D.onBlurCapture),
          onPointerDownCapture: m(e.onPointerDownCapture, ee.onPointerDownCapture),
        })
      );
    }, `DismissableLayer`),
  );
...
R(Be, `useDismissableLayerSurface`);
var Ve = R(() => !0, `IS_TRUE`);
function He(e, t) {
  let {
      ...
      shouldHandlePointerDownOutside: o = Ve,
    } = t,
    s = L(e),
    c = l.useRef(!1),
    u = l.useRef(!1),
  ...
  return (
    l.useEffect(() => {
      ...
      R(e, `resetOutsideInteraction`);
      function t() {
        return Array.from(d.current.values()).some(Boolean);
      }
      R(t, `isOutsideInteractionIntercepted`);
      function l(e) {
        if (!u.current) return;
        let t = e.target;
        ((t instanceof Node && [...a].some((e) => e.contains(t))) || d.current.set(e.type, !0),
          e.type === `click` &&
            window.setTimeout(() => {
              u.current && f.current();
            }, 0));
      }
      R(l, `handleInteractionCapture`);
      function p(e) {
        u.current && d.current.set(e.type, !1);
      }
      R(p, `handleInteractionBubble`);
      let m = R((a) => {
          if (a.target && !c.current) {
            let l = function () {
              n.removeEventListener(`click`, f.current);
              let r = t();
              (e(), r || Ge(Fe, s, p, { discrete: !0 }));
            };
            if ((R(l, `handleAndDispatchPointerDownOutsideEvent`), !o(a.target))) {
      ...
      for (let e of h) (n.addEventListener(e, l, !0), n.addEventListener(e, p));
      ...
      return () => {
        (window.clearTimeout(g),
          ...
          n.removeEventListener(`click`, f.current));
        for (let e of h) (n.removeEventListener(e, l, !0), n.removeEventListener(e, p));
      };
    }, [n, s, r, i, a, o]),
    { onPointerDownCapture: R(() => (c.current = !0), `onPointerDownCapture`) }
  );
}
R(He, `usePointerDownOutside`);
function Ue(e, t = globalThis?.document) {
  ...
  return (
    l.useEffect(() => {
      let e = R((e) => {
        e.target && !r.current && Ge(Ie, n, { originalEvent: e }, { discrete: !1 });
      }, `handleFocus`);
      return (t.addEventListener(`focusin`, e), () => t.removeEventListener(`focusin`, e));
    }, [t, n]),
    {
      onFocusCapture: R(() => (r.current = !0), `onFocusCapture`),
      onBlurCapture: R(() => (r.current = !1), `onBlurCapture`),
    }
  );
}
R(Ue, `useFocusOutside`);
function We() {
...
R(Ge, `handleAndDispatchCustomEvent`);
var Ke = Object.defineProperty,
  z = (e, t) => Ke(e, `name`, { value: t, configurable: !0 }),
  qe = `focusScope.autoFocusOnMount`,
      ...
      (l.useEffect(() => {
        if (r) {
          let e = function (e) {
              ...
              let t = e.target;
              s.contains(t) ? (p.current = t) : B(p.current, { select: !0 });
            },
            t = function (e) {
              if (h.paused || !s) return;
              let t = e.relatedTarget;
              t !== null && (s.contains(t) || B(p.current, { select: !0 }));
            },
            n = function (e) {
              if (document.activeElement === document.body)
                for (let t of e) t.removedNodes.length > 0 && B(s);
            };
          (z(e, `handleFocusIn`),
            z(t, `handleFocusOut`),
            z(n, `handleMutations`),
        ...
        l.useEffect(() => {
          if (s) {
            ...
            if (!s.contains(e)) {
              ...
              (s.addEventListener(qe, d),
                s.dispatchEvent(t),
                t.defaultPrevented ||
                  (Ze(ot($e(s)), { select: !0 }), document.activeElement === e && B(s)));
            }
            return () => {
              (s.removeEventListener(qe, d),
                setTimeout(() => {
                  let t = new CustomEvent(Je, Ye);
                  (s.addEventListener(Je, f),
                    s.dispatchEvent(t),
                    t.defaultPrevented || B(e ?? document.body, { select: !0 }),
                    s.removeEventListener(Je, f),
                    rt.remove(h));
                }, 0));
            };
          }
          ...
          if (t && i) {
            ...
            r && a
              ? !e.shiftKey && i === a
                ...
                : e.shiftKey && i === r && (e.preventDefault(), n && B(a, { select: !0 }))
              : i === t && e.preventDefault();
          }
        },
        [n, r, h.paused],
      );
      return (0, u.jsx)(ke.div, { tabIndex: -1, ...o, ref: m, onKeyDown: g });
    }, `FocusScope`),
  );
...
z($e, `getTabbableCandidates`);
function et(e, t) {
  let n = typeof t.checkVisibility == `function` && t.checkVisibility({ checkVisibilityCSS: !0 });
  for (let r of e)
    if (!(n ? !r.checkVisibility({ checkVisibilityCSS: !0 }) : tt(r, { upTo: t }))) return r;
}
z(et, `findVisible`);
...
var st = Object.defineProperty,
  ct = l.forwardRef(
    ((e, t) => st(e, `name`, { value: t, configurable: !0 }))(function (e, t) {
      ...
      return o ? y.createPortal((0, u.jsx)(ke.div, { ...r, ref: t }), o) : null;
    }, `Portal`),
  ),
  lt = Object.defineProperty,
  V = (e, t) => lt(e, `name`, { value: t, configurable: !0 });
function ut(e, t) {
  return l.useReducer((e, n) => t[e][n] ?? e, e);
}
V(ut, `useStateMachine`);
var dt = V((e) => {
  let { present: t, children: n } = e,
    r = ft(t),
    i = typeof n == `function` ? n({ present: r.isPresent }) : l.Children.only(n),
    a = mt(r.ref, ht(i));
  return typeof n == `function` || r.isPresent ? l.cloneElement(i, { ref: a }) : null;
}, `Presence`);
function ft(e) {
  let [t, n] = l.useState(),
    r = l.useRef(null),
  ...
  return (
    l.useEffect(() => {
      s === `mounted`
        ? ((a.current = o.current ?? H(r.current)), (o.current = void 0))
        : (a.current = `none`);
    }, [s]),
    O(() => {
      let t = r.current,
    ...
    O(() => {
      if (t) {
        let e,
          ...
          o = V((a) => {
            let o = H(r.current).includes(CSS.escape(a.animationName));
      ...
      if (r)
        return () => {
          for (let e = 0; e < i.length; e++) {
            let t = i[e];
            typeof t == `function` ? t() : pt(n[e], null);
          }
        };
    }, [])
  );
}
V(mt, `useStableComposedRefs`);
function H(e) {
  return e?.animationName || `none`;
}
V(H, `getAnimationName`);
function ht(e) {
  let t = Object.getOwnPropertyDescriptor(e.props, `ref`)?.get,
    n = t && `isReactWarning` in t && t.isReactWarning;
  return n
...
var gt = Object.defineProperty,
  _t = (e, t) => gt(e, `name`, { value: t, configurable: !0 }),
  vt = 0,
  yt = null;
function bt(e) {
...
function xt() {
  l.useEffect(() => {
    ...
    return (
      ...
      vt++,
      () => {
        (vt === 1 && (yt?.start.remove(), yt?.end.remove(), (yt = null)),
          (vt = Math.max(0, vt - 1)));
      }
    );
  }, []);
}
_t(xt, `useFocusGuards`);
function St() {
...
var Tt = `right-scroll-bar-position`,
  Et = `width-before-scroll-bar`,
  Dt = `with-scroll-bars-hidden`,
  Ot = `--removed-body-scroll-bar-size`;
function kt(e, t) {
...
var jt = typeof window < `u` ? l.useLayoutEffect : l.useEffect,
  Mt = new WeakMap();
function Nt(e, t) {
  var n = At(t || null, function (t) {
...
var zt = It(),
  ...
  Vt = l.forwardRef(function (e, t) {
    var n = l.useRef(null),
      r = l.useState({ onScrollCapture: Bt, onWheelCapture: Bt, onTouchMoveCapture: Bt }),
      i = r[0],
      a = r[1],
      o = e.forwardProps,
      s = e.children,
    ...
    return l.createElement(
      ...
      o
        ? l.cloneElement(l.Children.only(s), U(U({}, w), { ref: C }))
        : l.createElement(y, U({}, w, { className: c, ref: C }), s),
    );
  });
((Vt.defaultProps = { enabled: !0, removeScrollBar: !0, inert: !1 }),
  (Vt.classNames = { fullWidth: Et, zeroRight: Tt }));
var Ht,
  Ut = function () {
    if (Ht) return Ht;
...
var qt = function () {
  ...
  Qt = function (e) {
    ...
    return [Zt(n), Zt(r), Zt(i)];
  },
  $t = function (e) {
    if ((e === void 0 && (e = `margin`), typeof window > `u`)) return Xt;
    var t = Qt(e),
...
`
  ...
  an = function () {
    l.useEffect(function () {
      return (
        document.body.setAttribute(tn, (rn() + 1).toString()),
        function () {
          var e = rn() - 1;
  ...
  on = function (e) {
    ...
    return l.createElement(en, { styles: nn(a, !t, i, n ? `` : `!important`) });
  },
  sn = !1;
if (typeof window < `u`)
  try {
...
var ln = sn ? { passive: !1 } : !1,
  ...
  dn = function (e, t) {
    ...
    return n[t] !== `hidden` && !(n.overflowY === n.overflowX && !un(e) && n[t] === `visible`);
  },
  fn = function (e) {
  ...
  mn = function (e, t) {
    var n = t.ownerDocument,
      r = t;
    do {
      if ((typeof ShadowRoot < `u` && r instanceof ShadowRoot && (r = r.host), _n(e, r))) {
        var i = vn(e, r);
        if (i[1] > i[2]) return !0;
      }
      r = r.parentNode;
  ...
  bn = function (e, t, n, r, i) {
    var a = yn(e, window.getComputedStyle(t).direction),
      o = a * r,
      s = n.target,
      c = t.contains(s),
      l = !1,
...
function On(e) {
    ...
    l.useEffect(
      function () {
        if (e.inert) {
          ...
          var t = wt([e.lockRef.current], (e.shards || []).map(Cn), !0).filter(Boolean);
          return (
  ...
  var s = l.useCallback(function (e, t) {
    ...
    u = l.useCallback(function (e, n, r, i) {
      var a = { name: e, delta: n, target: r, should: i, shadowParent: kn(r) };
      (t.current.push(a),
        setTimeout(function () {
    ...
    d = l.useCallback(function (e) {
      ((n.current = xn(e)), (r.current = void 0));
    }, []),
    f = l.useCallback(function (t) {
      u(t.type, Sn(t), t.target, s(t, e.lockRef.current));
    }, []),
    p = l.useCallback(function (t) {
      u(t.type, xn(t), t.target, s(t, e.lockRef.current));
    }, []);
  l.useEffect(function () {
    return (
      Dn.push(a),
      e.setCallbacks({ onScrollCapture: f, onWheelCapture: f, onTouchMoveCapture: p }),
      document.addEventListener(`wheel`, c, ln),
      document.addEventListener(`touchmove`, c, ln),
      document.addEventListener(`touchstart`, d, ln),
      function () {
        ((Dn = Dn.filter(function (e) {
          return e !== a;
        })),
          document.removeEventListener(`wheel`, c, ln),
          document.removeEventListener(`touchmove`, c, ln),
          document.removeEventListener(`touchstart`, d, ln));
      }
    );
  }, []);
  ...
  return l.createElement(
    l.Fragment,
    null,
    h ? l.createElement(a, { styles: Tn(i) }) : null,
    m ? l.createElement(on, { noRelative: e.noRelative, gapMode: e.gapMode }) : null,
  );
}
function kn(e) {
...
var An = Rt(zt, On),
  jn = l.forwardRef(function (e, t) {
    return l.createElement(Vt, U({}, e, { ref: t, sideCar: An }));
  });
    ...
    return (
      ...
      function () {
        (o.forEach(function (e) {
          ...
          (Nn.set(e, t),
            a.set(e, i),
            t || (Pn.has(e) || e.removeAttribute(r), Pn.delete(e)),
            i || e.removeAttribute(n));
        }),
          In--,
          In || ((Nn = new WeakMap()), (Nn = new WeakMap()), (Pn = new WeakMap()), (Fn = {})));
      }
    );
  },
  Bn = function (e, t, n) {
...
function Vn(e) {
  ...
  if (typeof e == `string` || typeof e == `number`) r += e;
    ...
    if (Array.isArray(e)) {
      var i = e.length;
      for (t = 0; t < i; t++) e[t] && (n = Vn(e[t])) && (r && (r += ` `), (r += n));
...
var Un = (e, t) => {
  ...
  Wn = (e, t) => ({ classGroupId: e, validator: t }),
  Gn = (e = new Map(), t = null, n) => ({ nextPart: e, validators: t, classGroupId: n }),
  Kn = `-`,
  qn = [],
  Jn = `arbitrary..`,
  Yn = (e) => {
    ...
    return {
      getClassGroupId: (e) => {
        ...
        let n = e.split(Kn);
        return Xn(n, +(n[0] === `` && n.length > 1), t);
      },
      getConflictingClassGroupIds: (e, t) => {
        if (t) {
          let t = r[e],
            i = n[e];
          return t ? (i ? Un(i, t) : t) : i || qn;
        }
        return n[e] || qn;
      },
    };
  ...
  Xn = (e, t, n) => {
    ...
    let a = n.validators;
    if (a === null) return;
    let o = t === 0 ? e.join(Kn) : e.slice(t).join(Kn),
      s = a.length;
    for (let e = 0; e < s; e++) {
      let t = a[e];
  ...
  rr = (e, t, n, r) => {
    ...
    (t.validators === null && (t.validators = []), t.validators.push(Wn(n, e)));
  },
  ir = (e, t, n, r) => {
  ...
  ar = (e, t) => {
    ...
    for (let e = 0; e < i; e++) {
      let t = r[e],
        i = n.nextPart.get(t);
      (i || ((i = Gn()), n.nextPart.set(t, i)), (n = i));
    }
    return n;
  },
  or = (e) => `isThemeGetter` in e && e.isThemeGetter === !0,
  sr = (e) => {
  ...
  fr = (e) => {
    let { prefix: t, experimentalParseClassName: n } = e,
      r = (e) => {
        ...
        s.endsWith(cr)
          ? ((c = s.slice(0, -1)), (l = !0))
          : s.startsWith(cr) && ((c = s.slice(1)), (l = !0));
    ...
    if (t) {
      let e = t + lr,
        n = r;
      r = (t) => (t.startsWith(e) ? n(t.slice(e.length)) : dr(ur, !1, t, void 0, !0));
    }
    if (n) {
      let e = r;
  ...
  mr = (e) => ({
    ...
    parseClassName: fr(e),
    sortModifiers: pr(e),
    postfixLookupClassGroupIds: hr(e),
    ...Yn(e),
  }),
  hr = (e) => {
  ...
  vr = (...e) => {
    let t = 0,
      ...
      r,
      i = ``;
    for (; t < e.length;) (n = e[t++]) && (r = yr(n)) && (i && (i += ` `), (i += r));
    return i;
  },
  yr = (e) => {
    ...
    let t,
      n = ``;
    for (let r = 0; r < e.length; r++) e[r] && (t = yr(e[r])) && (n && (n += ` `), (n += t));
    return n;
  },
  br = (e, ...t) => {
    let n,
  ...
  Dr = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/,
  ...
  Ar = (e) => e.endsWith(`%`) && K(e.slice(0, -1)),
  J = (e) => Tr.test(e),
  jr = () => !0,
  Mr = (e) => Er.test(e) && !Dr.test(e),
  Nr = () => !1,
  Pr = (e) => Or.test(e),
  Fr = (e) => kr.test(e),
  Ir = (e) => !Y(e) && !Z(e),
  ...
  Qr = (e) => e === `position` || e === `percentage`,
  $r = (e) => e === `image` || e === `url`,
  ei = (e) => e === `length` || e === `size` || e === `bg-size`,
  ti = (e) => e === `length`,
  ni = (e) => e === `number`,
  ri = (e) => e === `family-name`,
  ii = (e) => e === `number` || e === `weight`,
  ai = (e) => e === `shadow`,
  oi = br(() => {
    let e = W(`color`),
      t = W(`font`),
      ...
      ne = () => [G, `screen`, `full`, `dvw`, `lvw`, `svw`, `min`, `max`, `fit`, ...w()],
      re = () => [G, `screen`, `full`, `lh`, `dvh`, `lvh`, `svh`, `min`, `max`, `fit`, ...w()],
      M = () => [e, Z, Y],
      ie = () => [...b(), qr, Hr, { position: [Z, Y] }],
      ae = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
      oe = () => [`auto`, `cover`, `contain`, Jr, Rr, { size: [Z, Y] }],
      se = () => [Ar, Gr, X],
      N = () => [``, `none`, `full`, l, Z, Y],
      P = () => [``, K, Gr, X],
    ...
    return {
      ...
      classGroups: {
        ...
        "max-w": [{ "max-w": [s, `screen`, `none`, `prose`, { screen: [o] }, ...j()] }],
        h: [{ h: [`screen`, `lh`, ...j()] }],
        "min-h": [{ "min-h": [`screen`, `lh`, `none`, ...j()] }],
        "max-h": [{ "max-h": [`screen`, `lh`, ...j()] }],
        "font-size": [{ text: [`base`, n, Gr, X] }],
        "font-smoothing": [`antialiased`, `subpixel-antialiased`],
        "font-style": [`italic`, `not-italic`],
        "font-weight": [{ font: [r, Zr, Br] }],
        "font-stretch": [
          {
            "font-stretch": [
              `ultra-condensed`,
        ...
        "line-clamp": [{ "line-clamp": [K, `none`, Z, zr] }],
        leading: [{ leading: [a, ...w()] }],
        ...
        "outline-w": [{ outline: [``, K, Gr, X] }],
        "outline-color": [{ outline: M() }],
        shadow: [{ shadow: [``, `none`, u, Xr, Wr] }],
