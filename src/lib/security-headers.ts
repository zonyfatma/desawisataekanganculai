...
export function applySecurityHeaders(response: Response): Response {
  ...
  const cspDirectives = [
    ...
    "img-src 'self' data: blob: https://images.unsplash.com https://*.tile.openstreetmap.org https://*.google.com https://*.googleapis.com https://*.gstatic.com https://server.arcgisonline.com https://*.basemaps.cartocdn.com https://unpkg.com https://*.supabase.co https://*.supabase.in https://*.supabase.com https://desaekanganculai.bintankab.go.id https://www.bintankab.go.id https://bintankab.go.id https://*.bintankab.go.id",
    "connect-src 'self' https://*.tile.openstreetmap.org https://*.google.com https://*.googleapis.com https://server.arcgisonline.com https://*.basemaps.cartocdn.com https://api.whatsapp.com https://*.supabase.co https://*.supabase.in https://*.supabase.com wss://*.supabase.co wss://*.supabase.in wss://*.supabase.com",
